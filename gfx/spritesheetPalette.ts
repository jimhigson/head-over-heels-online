...
export const spritesheetPalette = {
  ...
  shadow: new Color("#31413B"),
  midGrey: new Color("#7C6E6C"),
  lightGrey: new Color("#C0AFA9"),
  white: new Color("#FFFFFF"),
  pastelBlue: new Color("#64B1FF"),
  metallicBlue: new Color("#1366D0"),
  pink: new Color("#EE7EE6"),
  moss: new Color("#AD9E00"),
  redShadow: new Color("#8E533C"),
  midRed: new Color("#E25D43"),
  lightBeige: new Color("#FF9C74"),
  highlightBeige: new Color("#FFD097"),
  alpha: new Color("#BBB7E5"),
  replaceLight: new Color("#0D99A1"),
  replaceDark: new Color("#115F60"),
} as const;
