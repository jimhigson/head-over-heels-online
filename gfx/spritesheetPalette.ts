...
export const spritesheetPalette = {
  ...
  lightBlack: new Color("#38453A"),
  shadow: new Color("#325149"),
  midGrey: new Color("#7F7773"),
  lightGrey: new Color("#BBB1AB"),
  white: new Color("#FBFEFB"),
  metallicBlue: new Color("#366BAE"),
  pink: new Color("#D68ED1"),
  moss: new Color("#9E9600"),
  redShadow: new Color("#805E50"),
  midRed: new Color("#CA7463"),
  lightBeige: new Color("#DAA78F"),
  highlightBeige: new Color("#EBC690"),
  alpha: new Color("#FBD042"),
  replaceLight: new Color("#08A086"),
  replaceDark: new Color("#187558"),
} as const;
