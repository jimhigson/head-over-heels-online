const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WebGPURenderer-Boxw7Tn3.js","assets/App-BBrWbl9m.js","assets/index-mU8cQTSn.js","assets/index-DBECm5KY.css","assets/colorToUniform-KTpA7KSL.js","assets/SharedSystems-DM3RB-eX.js","assets/Graphics-C4H-TloP.js","assets/changeCharacterRoom-CwAAHOld.js","assets/WebGLRenderer-x2Pg2OTq.js"])))=>i.map(i=>d[i]);
import{bb as ji,bc as fr,bd as qi,as as Ji,aw as Ce,ax as G,ak as pr,at as we,a3 as S,a8 as Ut,a6 as Wi,a9 as b,a as it,v as zt,aM as y,ac as gn,aE as fe,a4 as Ke,a5 as Zi,V as Yi,be as Qi,bf as Ki,bg as es,aj as ts,bh as j,bi as no,P as k,bj as ns,bk as ae,bl as O,bm as Fn,s as $e,R as w,o as H,e as P,bn as os,bo as rs,bp as is,h as D,A as Ue,bq as ss,br as Rn,bs as mr,bt as as,bu as ls,bv as cs,bw as _t,M as J,bx as Mn,by as T,bz as ue,bA as Nt,Y as dt,bB as At,bC as us,bD as ds,bE as hs,bF as oo,bG as fs,bH as ps,bI as bn,i as le,bJ as st,Z as Ne,bK as Ht,bL as ms,l as U,bM as Gt,bN as pe,bO as ht,bP as Dn,k as W,bQ as Te,bR as E,bS as zn,w as gr,bT as Ln,bU as Ee,bV as En,bW as He,bX as tt,bY as $n,bZ as gs,b_ as bs,b6 as de,b$ as vs,c0 as ys,N as at,c1 as Ft,f as br,c2 as ke,c3 as Un,c4 as xs,c5 as vr,c6 as yr,c7 as xr,c8 as Vt,c9 as ro,ca as ws,y as Ge,cb as Ve,cc as Xt,x as Ie,cd as vn,ce as Ss,d as Cs,cf as Ts,cg as ks,F as Xe,ch as Is,ci as Ps,cj as Os,ck as yn,cl as Bs,cm as _s,cn as bt,g as Nn,co as As,cp as Fs,cq as Rs,n as Pe,cr as wr,I as Sr,cs as io,ct as Cr,j as me,cu as Hn,t as Tr,b as kr,r as Ms,b7 as je,cv as Kt,cw as vt,cx as Ds,cy as zs,cz as Je,cA as so,cB as Ls,cC as Es,cD as $s,cE as Us,cF as Ns,cG as Hs,cH as Gs,cI as Vs,cJ as Xs,cK as js,cL as ao,Q as lo,u as Ir,cM as Pr,ba as Or,K as Br,L as qs,H as co,cN as Js,cO as Ws,cP as Zs,cQ as Ys,cR as Qs,cS as Ks,cT as ea,cU as x,cV as xn,cW as ft,cX as en,O as uo,cY as ta,cZ as na,c_ as oa,a$ as ra,aC as Me,c$ as ia,d0 as sa,d1 as aa,d2 as la,d3 as ca,d4 as ua,d5 as da,d6 as ha,d7 as fa,d8 as ho,d9 as pa,S as fo,da as ma}from"./App-BBrWbl9m.js";import{f as wn,c as Gn,m as jt,a as Vn,b as _r,r as ga,o as ba}from"./changeCharacterRoom-CwAAHOld.js";import{S as va,G as q}from"./Graphics-C4H-TloP.js";import{g as Ar,_ as po}from"./index-mU8cQTSn.js";var yt={},mo;function ya(){if(mo)return yt;mo=1;var t=ji(),e=t.mark(i),n=fr(),o=n.wrapWithIterableIterator,r=n.ensureIterable;function i(){var l,a,c,u,d,h,f=arguments;return t.wrap(function(v){for(;;)switch(v.prev=v.next){case 0:for(l=f.length,a=new Array(l),c=0;c<l;c++)a[c]=f[c];u=0,d=a;case 2:if(!(u<d.length)){v.next=8;break}return h=d[u],v.delegateYield(r(h),"t0",5);case 5:u++,v.next=2;break;case 8:case"end":return v.stop()}},e)}yt.__concat=i;var s=o(i);return yt.concat=s,yt}var xt={},go;function xa(){if(go)return xt;go=1;var t=fr(),e=t.iterableCurry,n=qi(),o=n.__firstOr,r=Symbol("none");function i(l){return o(l,r)===r}xt.__isEmpty=i;var s=e(i,{reduces:!0});return xt.isEmpty=s,xt}var tn,bo;function wa(){return bo||(bo=1,tn=ya().concat),tn}var Sa=wa();const vo=Ar(Sa);var nn,yo;function Ca(){return yo||(yo=1,nn=xa().isEmpty),nn}var Ta=Ca();const ka=Ar(Ta),Fr=class Sn extends Ji{constructor(e){e={...Sn.defaultOptions,...e},super(e),this.enabled=!0,this._state=va.for2d(),this.blendMode=e.blendMode,this.padding=e.padding,typeof e.antialias=="boolean"?this.antialias=e.antialias?"on":"off":this.antialias=e.antialias,this.resolution=e.resolution,this.blendRequired=e.blendRequired,this.clipToViewport=e.clipToViewport,this.addResource("uTexture",0,1)}apply(e,n,o,r){e.applyFilter(this,n,o,r)}get blendMode(){return this._state.blendMode}set blendMode(e){this._state.blendMode=e}static from(e){const{gpu:n,gl:o,...r}=e;let i,s;return n&&(i=Ce.from(n)),o&&(s=G.from(o)),new Sn({gpuProgram:i,glProgram:s,...r})}};Fr.defaultOptions={blendMode:"normal",resolution:1,padding:0,antialias:"off",blendRequired:!1,clipToViewport:!0};let Q=Fr;var Ia=`
...
fn mainFragment(
  @location(0) uv: vec2<f32>
   ...
   return out;
}`;class B extends Q{constructor(e){const n=e.gpu,o=xo({source:Oa,...n}),r=Ce.from({vertex:{source:o,entryPoint:"mainVertex"},fragment:{source:o,entryPoint:"mainFragment"}}),i=e.gl,s=xo({source:Ia,...i}),l=G.from({vertex:Pa,fragment:s}),a=new pr({uBlend:{value:1,type:"f32"}});super({gpuProgram:r,glProgram:l,blendRequired:!0,resources:{blendUniforms:a,uBackTexture:we.EMPTY}})}}function xo(t){const{source:e,functions:n,main:o}=t;return e.replace("{FUNCTIONS}",n).replace("{MAIN}",o)}const Xn=`
	...
	`;class Rr extends B{constructor(){super({gl:{functions:`
            ...
            `}})}}qr.extension={name:"negation",type:S.BlendMode};class Jr extends B{constructor(){super({gl:{functions:`
                ...
                `}})}}Jr.extension={name:"overlay",type:S.BlendMode};class Wr extends B{constructor(){super({gl:{functions:`
            ...
            `,main:`
                ...
                `}})}}Wr.extension={name:"pin-light",type:S.BlendMode};class Zr extends B{constructor(){super({gl:{functions:`
                ${Xn}
            ...
            `}})}}Zr.extension={name:"saturation",type:S.BlendMode};class Yr extends B{constructor(){super({gl:{functions:`
                ...
                `}})}}Yr.extension={name:"soft-light",type:S.BlendMode};class Qr extends B{constructor(){super({gl:{functions:`
                ...
                `}})}}Qr.extension={name:"subtract",type:S.BlendMode};class Kr extends B{constructor(){super({gl:{functions:`
                float colorBurn(float base, float blend)
                {
                    return max((1.0-((1.0-base)/blend)),0.0);
                }
...
`;class qa extends Q{constructor(){const e=G.from({vertex:pt,fragment:ja,name:"halfbrite-filter"});super({glProgram:e,resources:{}})}}const di=({basic:t,dimmed:e})=>({replaceLight:t,replaceDark:e}),hi=t=>di(Jn[t.color.hue][t.color.shade].main),fi=t=>new be({lightBeige:g.lightGrey,redShadow:g.shadow,pink:g.lightGrey,moss:g.lightGrey,midRed:g.midGrey,highlightBeige:g.lightGrey,...t&&hi(t)}),Ja=new be({midGrey:g.midRed,lightGrey:g.lightBeige,white:g.highlightBeige,metallicBlue:g.redShadow,pink:g.midRed,moss:g.midRed,replaceDark:g.midRed,replaceLight:g.lightBeige}),Wa=t=>new be({replaceLight:t,replaceDark:Se(t)}),kn=(t,e,n)=>n?new be(di(Jn[t.color.hue][t.color.shade].edges[e])):new $(Wn(t.color).edges[e].original),ge=t=>new be(hi(t)),Co=new qa,Z=ns,Za=new be(Ga),To={x:.5,y:1},ko=t=>typeof t!="string"&&Object.hasOwn(t,"animationId"),In=t=>{if(typeof t=="string")return In({textureId:t});{const{anchor:e,flipX:n,pivot:o,x:r,y:i,filter:s,times:l,label:a}=t;let c;if(ko(t)?c=Ya(t):c=new fe(ae().textures[t.textureId]),t.hasOwnProperty("times")){const u={x:1,y:1,z:1,...l},d=new b({label:a??"timesXyz"});for(let{x:h}=u;h>=1;h--)for(let{y:f}=u;f>=1;f--)for(let m=1;m<=u.z;m++){const v={...t,textureId:t.textureId??t.textureIdCallback?.(h-1,f-1,m-1),label:`(${h},${f},${m})`};delete v.times;const I=In(v),A=O({x:h-1,y:f-1,z:m-1});I.x+=A.x,I.y+=+A.y,d.addChild(I)}return d}if(e===void 0&&o===void 0)if(ko(t))c.anchor=To;else{const u=ae().data.frames[t.textureId].frame;u.pivot!==void 0?c.pivot=u.pivot:c.anchor=To}else e!==void 0&&(c.anchor=e),o!==void 0&&(c.pivot=o);return r!==void 0&&(c.x=r),i!==void 0&&(c.y=i),s!==void 0&&(c.filters=s),a!==void 0&&(c.label=a),c.eventMode="static",n===!0&&(c.scale.x=-1),c}},p=In;function Ya({animationId:t,reverse:e,playOnce:n,paused:o,randomiseStartFrame:r}){const i=ae().animations[t],l=(o?[i[0]]:i).map(c=>({texture:c,time:Fn}));e&&l.reverse();const a=new lt(l);return a.animationSpeed=$e.animations[t].animationSpeed,a.gotoAndPlay(r?Math.floor(Math.random()*l.length):0),n!==void 0&&(a.loop=!1,a.onComplete=()=>{a.stop(),n==="and-destroy"&&(a.visible=!1)}),a}const Qa=`#version 300 es
