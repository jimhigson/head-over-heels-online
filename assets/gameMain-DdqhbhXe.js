const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WebGPURenderer-DtqEuLbT.js","assets/App-BgQ3zLNf.js","assets/index-DD117_bv.js","assets/index-EoDvU6wL.css","assets/colorToUniform-KTpA7KSL.js","assets/SharedSystems-CGXWAAD_.js","assets/Graphics-D8-7_Yyb.js","assets/swopCharacters-Dmg3iC7d.js","assets/WebGLRenderer-BYW7Ajh_.js"])))=>i.map(i=>d[i]);
import{x as jr,a6 as se,a7 as X,m as _n,y as de,E as v,e as Je,c as Yr,C as b,d as He,v as bt,am as m,D as vt,ae as Xe,T as we,U as Jr,aF as Zr,A as Kr,aG as Qr,aH as ie,aI as In,a2 as eo,aJ as to,X as k,aK as Ee,aL as Te,aM as no,aN as ro,K as _,Q as O,aO as Oe,O as Pt,aP as me,aQ as Bt,$ as oe,aR as Ge,aS as oo,aT as io,L as z,J as Ft,aU as _e,W as Pn,aV as Bn,N as xt,aW as Ht,a3 as Ie,aX as so,aY as ao,aZ as lo,a_ as At,a$ as co,_ as W,a0 as I,b0 as qe,b1 as uo,Y as Fn,b2 as fo,b3 as ho,b4 as po,b5 as st,b6 as mo,b7 as go,b8 as bo,b9 as Se,Z as vo,ba as xo,bb as An,ab as fe,I as yo,bc as wo}from"./App-BgQ3zLNf.js";import{l as yt,h as We,g as L,j as Xt,k as Gt,m as Be,n as To,s as ke,p as ee,i as D,q as wt,t as So,r as Fe,u as Co,v as ko,w as j,x as Oo,y as _o,z as ge,A as at,B as Tt,C as qt,D as lt,c as zt,E as Y,F as zn,G as Dn,H as Io,I as Ze,a as H,J as Dt,K as Ln,L as Wt,M as Mn,N as Po,O as St,P as Bo,Q as Rn,f as Fo,R as Un,S as Ao,T as Lt,U as zo,V as Do,W as Lo,X as Mo,Y as jt,Z as En,_ as Ro,d as $n,o as Nn,$ as Uo,e as Ke,a0 as y,a1 as V,a2 as Qe,a3 as je,a4 as Vn,a5 as Eo}from"./swopCharacters-Dmg3iC7d.js";import{S as $o,G as q}from"./Graphics-D8-7_Yyb.js";import{_ as Yt,g as No}from"./index-DD117_bv.js";const Hn=class Ct extends jr{constructor(e){e={...Ct.defaultOptions,...e},super(e),this.enabled=!0,this._state=$o.for2d(),this.blendMode=e.blendMode,this.padding=e.padding,typeof e.antialias=="boolean"?this.antialias=e.antialias?"on":"off":this.antialias=e.antialias,this.resolution=e.resolution,this.blendRequired=e.blendRequired,this.clipToViewport=e.clipToViewport,this.addResource("uTexture",0,1)}apply(e,n,r,o){e.applyFilter(this,n,r,o)}get blendMode(){return this._state.blendMode}set blendMode(e){this._state.blendMode=e}static from(e){const{gpu:n,gl:r,...o}=e;let i,s;return n&&(i=se.from(n)),r&&(s=X.from(r)),new Ct({gpuProgram:i,glProgram:s,...o})}};Hn.defaultOptions={blendMode:"normal",resolution:1,padding:0,antialias:"off",blendRequired:!1,clipToViewport:!0};let J=Hn;var Vo=`
...
fn mainFragment(
  @location(0) uv: vec2<f32>
   ...
   return out;
}`;class w extends J{constructor(e){const n=e.gpu,r=Jt({source:Xo,...n}),o=se.from({vertex:{source:r,entryPoint:"mainVertex"},fragment:{source:r,entryPoint:"mainFragment"}}),i=e.gl,s=Jt({source:Vo,...i}),a=X.from({vertex:Ho,fragment:s}),l=new _n({uBlend:{value:1,type:"f32"}});super({gpuProgram:o,glProgram:a,blendRequired:!0,resources:{blendUniforms:l,uBackTexture:de.EMPTY}})}}function Jt(t){const{source:e,functions:n,main:r}=t;return e.replace("{FUNCTIONS}",n).replace("{MAIN}",r)}const Mt=`
	...
	`;class Xn extends w{constructor(){super({gl:{functions:`
                ...
                `}})}}Xn.extension={name:"color",type:v.BlendMode};class Gn extends w{constructor(){super({gl:{functions:`
            ...
            `}})}}Gn.extension={name:"color-burn",type:v.BlendMode};class qn extends w{constructor(){super({gl:{functions:`
                ...
                `}})}}qn.extension={name:"color-dodge",type:v.BlendMode};class Wn extends w{constructor(){super({gl:{functions:`
                ...
                `}})}}Wn.extension={name:"darken",type:v.BlendMode};class jn extends w{constructor(){super({gl:{functions:`
            ...
            `}})}}jn.extension={name:"difference",type:v.BlendMode};class Yn extends w{constructor(){super({gl:{functions:`
            ...
            `}})}}Yn.extension={name:"divide",type:v.BlendMode};class Jn extends w{constructor(){super({gl:{functions:`
            ...
            `}})}}Jn.extension={name:"exclusion",type:v.BlendMode};class Zn extends w{constructor(){super({gl:{functions:`
            ...
            `},gpu:{functions:`
                ...
                `}})}}Zn.extension={name:"hard-light",type:v.BlendMode};class Kn extends w{constructor(){super({gl:{functions:`
            ...
            `}})}}Kn.extension={name:"hard-mix",type:v.BlendMode};class Qn extends w{constructor(){super({gl:{functions:`
            ...
            `}})}}Qn.extension={name:"lighten",type:v.BlendMode};class er extends w{constructor(){super({gl:{functions:`
                ...
                `}})}}er.extension={name:"linear-burn",type:v.BlendMode};class tr extends w{constructor(){super({gl:{functions:`
            ...
            `}})}}tr.extension={name:"linear-dodge",type:v.BlendMode};class nr extends w{constructor(){super({gl:{functions:`
                float linearBurn(float base, float blend) {
                    return max(0.0, base + blend - 1.0);
                }
            ...
            `}})}}nr.extension={name:"linear-light",type:v.BlendMode};class rr extends w{constructor(){super({gl:{functions:`
                ${Mt}
            ...
            `}})}}rr.extension={name:"luminosity",type:v.BlendMode};class or extends w{constructor(){super({gl:{functions:`
            ...
            `}})}}or.extension={name:"negation",type:v.BlendMode};class ir extends w{constructor(){super({gl:{functions:`
                ...
                `}})}}ir.extension={name:"overlay",type:v.BlendMode};class sr extends w{constructor(){super({gl:{functions:`
            ...
            `,main:`
                ...
                `}})}}sr.extension={name:"pin-light",type:v.BlendMode};class ar extends w{constructor(){super({gl:{functions:`
                ${Mt}
            ...
            `}})}}ar.extension={name:"saturation",type:v.BlendMode};class lr extends w{constructor(){super({gl:{functions:`
                ...
                `}})}}lr.extension={name:"soft-light",type:v.BlendMode};class cr extends w{constructor(){super({gl:{functions:`
                ...
                `}})}}cr.extension={name:"subtract",type:v.BlendMode};class ur extends w{constructor(){super({gl:{functions:`
                float colorBurn(float base, float blend)
                {
                    return max((1.0-((1.0-base)/blend)),0.0);
                }
...
fn interlaceLines(co: vec3<f32>, coord: vec2<f32>) -> vec3<f32>
{
  ...
  return color;
}`,Js=Object.defineProperty,Zs=(t,e,n)=>e in t?Js(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n,Ve=(t,e,n)=>(Zs(t,typeof e!="symbol"?e+"":e,n),n);const Ur=class Er extends J{constructor(e){e={...Er.DEFAULT_OPTIONS,...e};const n=se.from({vertex:{source:ot,entryPoint:"mainVertex"},fragment:{source:Ys,entryPoint:"mainFragment"}}),r=X.from({vertex:rt,fragment:js,name:"crt-filter"});super({gpuProgram:n,glProgram:r,resources:{crtUniforms:{uLine:{value:new Float32Array(4),type:"vec4<f32>"},uNoise:{value:new Float32Array(2),type:"vec2<f32>"},uVignette:{value:new Float32Array(3),type:"vec3<f32>"},uSeed:{value:e.seed,type:"f32"},uTime:{value:e.time,type:"f32"},uDimensions:{value:new Float32Array(2),type:"vec2<f32>"}}}}),Ve(this,"uniforms"),Ve(this,"seed"),Ve(this,"time"),this.uniforms=this.resources.crtUniforms.uniforms,Object.assign(this,e)}apply(e,n,r,o){this.uniforms.uDimensions[0]=n.frame.width,this.uniforms.uDimensions[1]=n.frame.height,this.uniforms.uSeed=this.seed,this.uniforms.uTime=this.time,e.applyFilter(this,n,r,o)}get curvature(){return this.uniforms.uLine[0]}set curvature(e){this.uniforms.uLine[0]=e}get lineWidth(){return this.uniforms.uLine[1]}set lineWidth(e){this.uniforms.uLine[1]=e}get lineContrast(){return this.uniforms.uLine[2]}set lineContrast(e){this.uniforms.uLine[2]=e}get verticalLine(){return this.uniforms.uLine[3]>.5}set verticalLine(e){this.uniforms.uLine[3]=e?1:0}get noise(){return this.uniforms.uNoise[0]}set noise(e){this.uniforms.uNoise[0]=e}get noiseSize(){return this.uniforms.uNoise[1]}set noiseSize(e){this.uniforms.uNoise[1]=e}get vignetting(){return this.uniforms.uVignette[0]}set vignetting(e){this.uniforms.uVignette[0]=e}get vignettingAlpha(){return this.uniforms.uVignette[1]}set vignettingAlpha(e){this.uniforms.uVignette[1]=e}get vignettingBlur(){return this.uniforms.uVignette[2]}set vignettingBlur(e){this.uniforms.uVignette[2]=e}};Ve(Ur,"DEFAULT_OPTIONS",{curvature:1,lineWidth:1,lineContrast:.25,verticalLine:!1,noise:0,noiseSize:1,vignetting:.3,vignettingAlpha:1,vignettingBlur:.3,time:0,seed:0});let Ks=Ur;var Qs=`
in vec2 vTextureCoord;
out vec4 finalColor;
...
`,aa=`struct AdvancedBloomUniforms {
  uBloomScale: f32,
  uBrightness: f32,
};
...
`,ua=Object.defineProperty,da=(t,e,n)=>e in t?ua(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n,Vr=(t,e,n)=>(da(t,typeof e!="symbol"?e+"":e,n),n);const Hr=class Xr extends J{constructor(e){e={...Xr.DEFAULT_OPTIONS,...e};const n=se.from({vertex:{source:ot,entryPoint:"mainVertex"},fragment:{source:ca,entryPoint:"mainFragment"}}),r=X.from({vertex:rt,fragment:la,name:"extract-brightness-filter"});super({gpuProgram:n,glProgram:r,resources:{extractBrightnessUniforms:{uThreshold:{value:e.threshold,type:"f32"}}}}),Vr(this,"uniforms"),this.uniforms=this.resources.extractBrightnessUniforms.uniforms}get threshold(){return this.uniforms.uThreshold}set threshold(e){this.uniforms.uThreshold=e}};Vr(Hr,"DEFAULT_OPTIONS",{threshold:.5});let fa=Hr;var ha=Object.defineProperty,pa=(t,e,n)=>e in t?ha(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n,ue=(t,e,n)=>(pa(t,typeof e!="symbol"?e+"":e,n),n);const Gr=class qr extends J{constructor(e){e={...qr.DEFAULT_OPTIONS,...e};const n=se.from({vertex:{source:ot,entryPoint:"mainVertex"},fragment:{source:aa,entryPoint:"mainFragment"}}),r=X.from({vertex:rt,fragment:sa,name:"advanced-bloom-filter"});super({gpuProgram:n,glProgram:r,resources:{advancedBloomUniforms:{uBloomScale:{value:e.bloomScale,type:"f32"},uBrightness:{value:e.brightness,type:"f32"}},uMapTexture:de.WHITE}}),ue(this,"uniforms"),ue(this,"bloomScale",1),ue(this,"brightness",1),ue(this,"_extractFilter"),ue(this,"_blurFilter"),this.uniforms=this.resources.advancedBloomUniforms.uniforms,this._extractFilter=new fa({threshold:e.threshold}),this._blurFilter=new ia({strength:e.kernels??e.blur,quality:e.kernels?void 0:e.quality}),Object.assign(this,e)}apply(e,n,r,o){const i=fe.getSameSizeTexture(n);this._extractFilter.apply(e,n,i,!0);const s=fe.getSameSizeTexture(n);this._blurFilter.apply(e,i,s,!0),this.uniforms.uBloomScale=this.bloomScale,this.uniforms.uBrightness=this.brightness,this.resources.uMapTexture=s.source,e.applyFilter(this,n,r,o),fe.returnTexture(s),fe.returnTexture(i)}get threshold(){return this._extractFilter.threshold}set threshold(e){this._extractFilter.threshold=e}get kernels(){return this._blurFilter.kernels}set kernels(e){this._blurFilter.kernels=e}get blur(){return this._blurFilter.strength}set blur(e){this._blurFilter.strength=e}get quality(){return this._blurFilter.quality}set quality(e){this._blurFilter.quality=e}get pixelSize(){return this._blurFilter.pixelSize}set pixelSize(e){typeof e=="number"&&(e={x:e,y:e}),Array.isArray(e)&&(e={x:e[0],y:e[1]}),this._blurFilter.pixelSize=e}get pixelSizeX(){return this._blurFilter.pixelSizeX}set pixelSizeX(e){this._blurFilter.pixelSizeX=e}get pixelSizeY(){return this._blurFilter.pixelSizeY}set pixelSizeY(e){this._blurFilter.pixelSizeY=e}};ue(Gr,"DEFAULT_OPTIONS",{threshold:.5,bloomScale:1,brightness:1,blur:8,quality:4,pixelSize:{x:1,y:1}});let ma=Gr;const kn=({crtFilter:t},e)=>[t?new Ks({lineContrast:e?.3:0,vignetting:e?.4:.2}):void 0,t?new ma({threshold:.7,brightness:.9,bloomScale:.6,blur:10}):void 0].filter(n=>n!==void 0);class ga{#e;#r;#o;#n;#a=new b({label:"MainLoop/world"});#i;#s;constructor(e,n){this.#i=e,this.#s=n;const{upscale:{gameEngineUpscale:r}}=k.getState();e.stage.addChild(this.#a),e.stage.scale=r,this.#n=new Cn(n,ke(n),!1),this.#a.addChild(this.#n.container),this.#o=new xi,e.stage.addChild(this.#o.container),this.#c()}#c(){const{userSettings:{displaySettings:e}}=k.getState();this.#e=kn(e,!0),this.#r=kn(e,!1)}tick=({deltaMS:e})=>{const n=k.getState(),r=An(n),{userSettings:{displaySettings:o},upscale:i}=k.getState();this.#o.tick({gameState:this.#s,screenSize:i.gameEngineScreenSize,colourise:!r&&o.colourise});const s=ke(this.#s);if((this.#n.roomState!==s||this.#n.upscale!==i||this.#n.displaySettings!==o||this.#n.paused!==r)&&(this.#n.destroy(),this.#n=new Cn(this.#s,s,r),this.#a.addChild(this.#n.container),this.#s.events.emit("roomChange",s.id),this.#i.stage.scale=i.gameEngineUpscale,this.#c()),r)this.#i.stage.filters=this.#e,this.#n.everRendered||this.#n.tick({progression:this.#s.progression,movedItems:yo,deltaMS:e,displaySettings:o,onHold:!0});else{this.#i.stage.filters=this.#r;const a=gs(this.#s,e);this.#n.tick({progression:this.#s.progression,movedItems:a,deltaMS:e,displaySettings:o,onHold:!1})}};start(){return this.#i.ticker.add(this.tick),this}stop(){this.#i.stage.removeChild(this.#a),this.#n.destroy(),this.#o.destroy(),this.#i.ticker.remove(this.tick)}}Je.add(Xn,Gn,qn,Wn,jn,Yn,Jn,Zn,Kn,Qn,er,nr,tr,rr,or,ir,sr,ar,lr,cr,ur);wo.defaultOptions.scaleMode="nearest";const On=async(t,e)=>{const n=new vr;await n.init({background:"#000000",sharedTicker:!0});const r=ai({campaign:t,inputStateTracker:e}),o=new ga(n,r).start();return{campaign:t,events:r.events,renderIn(i){i.appendChild(n.canvas)},resizeTo(i){console.log("explicitly setting app renderer size to",i),n.renderer?.resize(i.x,i.y)},changeRoom(i){zt({playableItem:Ke(r),gameState:r,toRoomId:i,changeType:"level-select"})},get currentRoom(){return ke(r)},get gameState(){return r},stop(){console.warn("tearing down game"),n.canvas.parentNode?.removeChild(n.canvas),o.stop(),n.destroy()}}},wa=Object.freeze(Object.defineProperty({__proto__:null,default:On,gameMain:On},Symbol.toStringTag,{value:"Module"}));export{pr as A,dr as C,J as F,Ko as R,Wo as S,mr as V,wa as g,qo as u};
