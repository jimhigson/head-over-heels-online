const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WebGPURenderer-Cdy7zJJ-.js","assets/App-q5AovpMT.js","assets/index-YiDOyavH.js","assets/index-D16TpEw8.css","assets/colorToUniform-KTpA7KSL.js","assets/SharedSystems-BLDADMqJ.js","assets/Graphics-DgkBD4Id.js","assets/swopCharacters-QL0so0Ix.js","assets/WebGLRenderer-D5W6c0JA.js"])))=>i.map(i=>d[i]);
import{aT as Ii,J as jo,H as Oi,aj as ve,ak as $,q as Vo,I as pe,E as C,f as Dt,e as _i,C as b,d as Ye,v as Bt,az as v,D as rn,ar as De,T as Xe,U as Bi,V as Pi,aU as Fi,aV as Ai,aW as Di,n as Mi,aX as ut,Y as le,aY as zi,aZ as Q,K as z,a2 as Xo,a_ as ce,a7 as k,a$ as Ho,ad as Go,a4 as x,a9 as te,W as _,b0 as Li,b1 as Ri,b2 as Ei,$ as D,b3 as Me,b4 as Ui,b5 as Cn,b6 as qo,b7 as $i,b8 as St,X as U,b9 as Ni,a6 as oe,ba as ji,bb as Vi,bc as Xi,bd as Hi,ae as Wo,a0 as Mt,be as Rn,bf as Gi,bg as rt,bh as Jo,bi as ye,bj as zt,a8 as se,p as it,af as xe,_ as sn,bk as qi,bl as Wi,bm as Ji,bn as Yi,bo as Sn,L as Yo,bp as He,a1 as Zi,bq as Ki,br as Tn,bs as Qi,bt as es,bu as Zo,bv as ts,bw as ns,bx as os,by as rs,bz as S,aa as Pt,bA as Tt,bB as is,bC as ss,bD as as,a as Ze,bE as ls,bF as Ge,bG as w,bH as an,ac as ln,bI as jt,Z as En,bJ as cs,bK as us,bL as ds,bM as Ko,ap as _e,bN as fs,ah as hs,bO as ps,bP as ms,bQ as gs,bR as bs,ag as Un,bS as vs}from"./App-q5AovpMT.js";import{r as ys,l as cn,h as Ft,g as $n,j as Nn,k as we,m as kn,n as xs,p as ws,q as un,t as Ke,u as kt,c as In,v as R,i as q,w as Qo,x as er,y as tr,z as me,A as Lt,B as On,C as ze,D as Cs,E as Ss,F as Ts,G as dn,H as ks,I as dt,J as Is,K as Os,L as _s,a as Ce,M as nr,N as or,O as jn,P as ue,Q as rr,R as ir,f as Bs,S as sr,T as Ps,b as Le,U as Vt,V as ft,W as Fs,X as Re,Y as Vn,Z as As,_ as _n,$ as Ds,a0 as st,a1 as Ms,a2 as zs,a3 as Ls,a4 as Rs,a5 as Xn,a6 as ar,e as lr,o as cr,a7 as Es,a8 as Hn,a9 as Us,s as Qe,aa as $s,ab as Xt,ac as Ns,ad as js,ae as Vs,af as Gn,ag as Rt,ah as Xs}from"./swopCharacters-QL0so0Ix.js";import{S as Hs,G}from"./Graphics-DgkBD4Id.js";import{g as ur,_ as qn}from"./index-YiDOyavH.js";var ht={},Wn;function Gs(){if(Wn)return ht;Wn=1;var t=Ii(),e=t.mark(i),n=jo(),o=n.wrapWithIterableIterator,r=n.ensureIterable;function i(){var a,l,c,u,d,f,h=arguments;return t.wrap(function(y){for(;;)switch(y.prev=y.next){case 0:for(a=h.length,l=new Array(a),c=0;c<a;c++)l[c]=h[c];u=0,d=l;case 2:if(!(u<d.length)){y.next=8;break}return f=d[u],y.delegateYield(r(f),"t0",5);case 5:u++,y.next=2;break;case 8:case"end":return y.stop()}},e)}ht.__concat=i;var s=o(i);return ht.concat=s,ht}var pt={},Jn;function qs(){if(Jn)return pt;Jn=1;var t=jo(),e=t.iterableCurry,n=ys(),o=n.__firstOr,r=Symbol("none");function i(a){return o(a,r)===r}pt.__isEmpty=i;var s=e(i,{reduces:!0});return pt.isEmpty=s,pt}var Ht,Yn;function Ws(){return Yn||(Yn=1,Ht=Gs().concat),Ht}var Js=Ws();const fn=ur(Js);var Gt,Zn;function Ys(){return Zn||(Zn=1,Gt=qs().isEmpty),Gt}var Zs=Ys();const dr=ur(Zs),fr=class hn extends Oi{constructor(e){e={...hn.defaultOptions,...e},super(e),this.enabled=!0,this._state=Hs.for2d(),this.blendMode=e.blendMode,this.padding=e.padding,typeof e.antialias=="boolean"?this.antialias=e.antialias?"on":"off":this.antialias=e.antialias,this.resolution=e.resolution,this.blendRequired=e.blendRequired,this.clipToViewport=e.clipToViewport,this.addResource("uTexture",0,1)}apply(e,n,o,r){e.applyFilter(this,n,o,r)}get blendMode(){return this._state.blendMode}set blendMode(e){this._state.blendMode=e}static from(e){const{gpu:n,gl:o,...r}=e;let i,s;return n&&(i=ve.from(n)),o&&(s=$.from(o)),new hn({gpuProgram:i,glProgram:s,...r})}};fr.defaultOptions={blendMode:"normal",resolution:1,padding:0,antialias:"off",blendRequired:!1,clipToViewport:!0};let J=fr;var Ks=`
...
fn mainFragment(
  @location(0) uv: vec2<f32>
   ...
   return out;
}`;class I extends J{constructor(e){const n=e.gpu,o=Kn({source:ea,...n}),r=ve.from({vertex:{source:o,entryPoint:"mainVertex"},fragment:{source:o,entryPoint:"mainFragment"}}),i=e.gl,s=Kn({source:Ks,...i}),a=$.from({vertex:Qs,fragment:s}),l=new Vo({uBlend:{value:1,type:"f32"}});super({gpuProgram:r,glProgram:a,blendRequired:!0,resources:{blendUniforms:l,uBackTexture:pe.EMPTY}})}}function Kn(t){const{source:e,functions:n,main:o}=t;return e.replace("{FUNCTIONS}",n).replace("{MAIN}",o)}const Bn=`
