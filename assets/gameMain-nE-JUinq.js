const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WebGPURenderer-BT_dmrQR.js","assets/App-DOJH68yG.js","assets/index-BqESwFzz.js","assets/index-CxpCqL_d.css","assets/colorToUniform-KTpA7KSL.js","assets/SharedSystems-WPl79GkI.js","assets/Graphics-C8nfOUqR.js","assets/swopCharacters-BgNAUCUZ.js","assets/WebGLRenderer-CBxmEUJz.js"])))=>i.map(i=>d[i]);
import{A as Vo,a7 as de,a8 as E,n as sr,F as le,E as y,f as vt,e as jo,C as g,d as Ne,v as ft,an as x,D as Nt,af as Ce,T as Le,U as Ho,V as Xo,aH as Go,aI as qo,aJ as Wo,m as Yo,aK as Jo,H as Zo,aL as Qo,aM as Y,aN as Ko,aO as oe,aP as ar,a2 as lr,Y as C,a0 as k,L as I,aQ as ei,aR as ti,W as B,aS as ke,aT as ni,aU as cr,aV as xt,aW as ri,aX as at,N as U,aY as oi,_ as z,aZ as ii,a_ as si,a3 as ur,X as yt,a$ as ai,b0 as Xe,b1 as dr,b2 as fe,b3 as wt,p as Ge,Z as qe,a4 as Oe,Q as Vt,b4 as dn,$ as te,b5 as li,b6 as ci,b7 as ui,b8 as di,I as fr,b9 as Me,ba as fi,bb as en,bc as hi,bd as pi,O as hr,be as mi,bf as bi,bg as gi,bh as ht,bi as lt,bj as vi,bk as xi,bl as yi,a as Ve,bm as pt,bn as wi,bo as Re,bp as Ci,bq as pr,br as mr,bs as Ti,ad as ve,bt as It,bu as _t,a5 as fn,bv as Si}from"./App-DOJH68yG.js";import{l as jt,h as mt,j as hn,g as L,p as T,k as he,m as tn,n as ki,q as Oi,r as Ht,t as bt,u as ct,c as nn,v as H,i as X,w as br,x as gr,y as ce,z as Ct,A as Ii,B as _i,C as Pi,D as Bi,E as Xt,F as Ai,G as Je,H as Fi,I as Di,J as zi,a as pe,K as vr,L as xr,M as pn,N as yr,f as Li,O as wr,P as Cr,Q as Mi,b as Q,s as ue,R as Pt,S as Ze,T as Ri,U as Ui,V as _e,W as mn,X as Ei,Y as rn,Z as $i,_ as Ni,$ as Vi,a0 as ji,a1 as Hi,a2 as bn,a3 as Tr,e as Sr,o as kr,a4 as Xi,a5 as gn,a6 as Bt,a7 as w,a8 as Gi,a9 as qi,aa as Wi,ab as vn,ac as Tt,ad as Yi}from"./swopCharacters-BgNAUCUZ.js";import{S as Ji,G as j}from"./Graphics-C8nfOUqR.js";import{_ as xn,g as Zi}from"./index-BqESwFzz.js";const Or=class Gt extends Vo{constructor(e){e={...Gt.defaultOptions,...e},super(e),this.enabled=!0,this._state=Ji.for2d(),this.blendMode=e.blendMode,this.padding=e.padding,typeof e.antialias=="boolean"?this.antialias=e.antialias?"on":"off":this.antialias=e.antialias,this.resolution=e.resolution,this.blendRequired=e.blendRequired,this.clipToViewport=e.clipToViewport,this.addResource("uTexture",0,1)}apply(e,n,r,o){e.applyFilter(this,n,r,o)}get blendMode(){return this._state.blendMode}set blendMode(e){this._state.blendMode=e}static from(e){const{gpu:n,gl:r,...o}=e;let i,s;return n&&(i=de.from(n)),r&&(s=E.from(r)),new Gt({gpuProgram:i,glProgram:s,...o})}};Or.defaultOptions={blendMode:"normal",resolution:1,padding:0,antialias:"off",blendRequired:!1,clipToViewport:!0};let G=Or;var Qi=`
...
fn mainFragment(
  @location(0) uv: vec2<f32>
   ...
   return out;
}`;class S extends G{constructor(e){const n=e.gpu,r=yn({source:es,...n}),o=de.from({vertex:{source:r,entryPoint:"mainVertex"},fragment:{source:r,entryPoint:"mainFragment"}}),i=e.gl,s=yn({source:Qi,...i}),a=E.from({vertex:Ki,fragment:s}),l=new sr({uBlend:{value:1,type:"f32"}});super({gpuProgram:o,glProgram:a,blendRequired:!0,resources:{blendUniforms:l,uBackTexture:le.EMPTY}})}}function yn(t){const{source:e,functions:n,main:r}=t;return e.replace("{FUNCTIONS}",n).replace("{MAIN}",r)}const on=`
	...
	`;class Ir extends S{constructor(){super({gl:{functions:`
                ...
                `}})}}Ir.extension={name:"color",type:y.BlendMode};class _r extends S{constructor(){super({gl:{functions:`
            ...
            `}})}}_r.extension={name:"color-burn",type:y.BlendMode};class Pr extends S{constructor(){super({gl:{functions:`
                ...
                `}})}}Pr.extension={name:"color-dodge",type:y.BlendMode};class Br extends S{constructor(){super({gl:{functions:`
                ...
                `}})}}Br.extension={name:"darken",type:y.BlendMode};class Ar extends S{constructor(){super({gl:{functions:`
            ...
            `}})}}Ar.extension={name:"difference",type:y.BlendMode};class Fr extends S{constructor(){super({gl:{functions:`
            ...
            `}})}}Fr.extension={name:"divide",type:y.BlendMode};class Dr extends S{constructor(){super({gl:{functions:`
            ...
            `}})}}Dr.extension={name:"exclusion",type:y.BlendMode};class zr extends S{constructor(){super({gl:{functions:`
            ...
            `},gpu:{functions:`
                ...
                `}})}}zr.extension={name:"hard-light",type:y.BlendMode};class Lr extends S{constructor(){super({gl:{functions:`
            ...
            `}})}}Lr.extension={name:"hard-mix",type:y.BlendMode};class Mr extends S{constructor(){super({gl:{functions:`
            ...
            `}})}}Mr.extension={name:"lighten",type:y.BlendMode};class Rr extends S{constructor(){super({gl:{functions:`
                ...
                `}})}}Rr.extension={name:"linear-burn",type:y.BlendMode};class Ur extends S{constructor(){super({gl:{functions:`
            ...
            `}})}}Ur.extension={name:"linear-dodge",type:y.BlendMode};class Er extends S{constructor(){super({gl:{functions:`
                float linearBurn(float base, float blend) {
                    return max(0.0, base + blend - 1.0);
                }
            ...
            `}})}}Er.extension={name:"linear-light",type:y.BlendMode};class $r extends S{constructor(){super({gl:{functions:`
                ${on}
            ...
            `}})}}$r.extension={name:"luminosity",type:y.BlendMode};class Nr extends S{constructor(){super({gl:{functions:`
            ...
            `}})}}Nr.extension={name:"negation",type:y.BlendMode};class Vr extends S{constructor(){super({gl:{functions:`
                ...
                `}})}}Vr.extension={name:"overlay",type:y.BlendMode};class jr extends S{constructor(){super({gl:{functions:`
            ...
            `,main:`
                ...
                `}})}}jr.extension={name:"pin-light",type:y.BlendMode};class Hr extends S{constructor(){super({gl:{functions:`
                ${on}
            ...
            `}})}}Hr.extension={name:"saturation",type:y.BlendMode};class Xr extends S{constructor(){super({gl:{functions:`
                ...
                `}})}}Xr.extension={name:"soft-light",type:y.BlendMode};class Gr extends S{constructor(){super({gl:{functions:`
                ...
                `}})}}Gr.extension={name:"subtract",type:y.BlendMode};class qr extends S{constructor(){super({gl:{functions:`
                float colorBurn(float base, float blend)
                {
                    return max((1.0-((1.0-base)/blend)),0.0);
                }
            ...
            `},gpu:{functions:`
                ...
                `}})}}qr.extension={name:"vivid-light",type:y.BlendMode};const qt=[];vt.handleByNamedList(y.Environment,qt);async function ts(t){if(!t)for(let e=0;e<qt.length;e++){const n=qt[e];if(n.value.test()){await n.value.load();return}}}let Pe;function ns(){if(typeof Pe=="boolean")return Pe;try{Pe=new Function("param1","param2","param3","return param1[param2] === param3;")({a:"b"},"a","b")===!0}catch{Pe=!1}return Pe}var Wr=(t=>(t[t.NONE=0]="NONE",t[t.COLOR=16384]="COLOR",t[t.STENCIL=1024]="STENCIL",t[t.DEPTH=256]="DEPTH",t[t.COLOR_DEPTH=16640]="COLOR_DEPTH",t[t.COLOR_STENCIL=17408]="COLOR_STENCIL",t[t.DEPTH_STENCIL=1280]="DEPTH_STENCIL",t[t.ALL=17664]="ALL",t))(Wr||{});class rs{constructor(e){this.items=[],this._name=e}emit(e,n,r,o,i,s,a,l){const{name:c,items:u}=this;for(let d=0,h=u.length;d<h;d++)u[d][c](e,n,r,o,i,s,a,l);return this}add(e){return e[this._name]&&(this.remove(e),this.items.push(e)),this}remove(e){const n=this.items.indexOf(e);return n!==-1&&this.items.splice(n,1),this}contains(e){return this.items.indexOf(e)!==-1}removeAll(){return this.items.length=0,this}destroy(){this.removeAll(),this.items=null,this._name=null}get empty(){return this.items.length===0}get name(){return this._name}}const os=["init","destroy","contextChange","resolutionChange","resetState","renderEnd","renderStart","render","update","postrender","prerender"],Yr=class Jr extends jo{constructor(e){super(),this.runners=Object.create(null),this.renderPipes=Object.create(null),this._initOptions={},this._systemsHash=Object.create(null),this.type=e.type,this.name=e.name,this.config=e;const n=[...os,...this.config.runners??[]];this._addRunners(...n),this._unsafeEvalCheck()}async init(e={}){const n=e.skipExtensionImports===!0?!0:e.manageImports===!1;await ts(n),this._addSystems(this.config.systems),this._addPipes(this.config.renderPipes,this.config.renderPipeAdaptors);for(const r in this._systemsHash)e={...this._systemsHash[r].constructor.defaultOptions,...e};e={...Jr.defaultOptions,...e},this._roundPixels=e.roundPixels?1:0;for(let r=0;r<this.runners.init.items.length;r++)await this.runners.init.items[r].init(e);this._initOptions=e}render(e,n){let r=e;if(r instanceof g&&(r={container:r},n&&(Ne(ft,"passing a second argument is deprecated, please use render options instead"),r.target=n.renderTexture)),r.target||(r.target=this.view.renderTarget),r.target===this.view.renderTarget&&(this._lastObjectRendered=r.container,r.clearColor??(r.clearColor=this.background.colorRgba),r.clear??(r.clear=this.background.clearBeforeRender)),r.clearColor){const o=Array.isArray(r.clearColor)&&r.clearColor.length===4;r.clearColor=o?r.clearColor:x.shared.setValue(r.clearColor).toArray()}r.transform||(r.container.updateLocalTransform(),r.transform=r.container.localTransform),r.container.enableRenderGroup(),this.runners.prerender.emit(r),this.runners.renderStart.emit(r),this.runners.render.emit(r),this.runners.renderEnd.emit(r),this.runners.postrender.emit(r)}resize(e,n,r){const o=this.view.resolution;this.view.resize(e,n,r),this.emit("resize",this.view.screen.width,this.view.screen.height,this.view.resolution),r!==void 0&&r!==o&&this.runners.resolutionChange.emit(r)}clear(e={}){const n=this;e.target||(e.target=n.renderTarget.renderTarget),e.clearColor||(e.clearColor=this.background.colorRgba),e.clear??(e.clear=Wr.ALL);const{clear:r,clearColor:o,target:i}=e;x.shared.setValue(o??this.background.colorRgba),n.renderTarget.clear(i,r,x.shared.toArray())}get resolution(){return this.view.resolution}set resolution(e){this.view.resolution=e,this.runners.resolutionChange.emit(e)}get width(){return this.view.texture.frame.width}get height(){return this.view.texture.frame.height}get canvas(){return this.view.canvas}get lastObjectRendered(){return this._lastObjectRendered}get renderingToScreen(){return this.renderTarget.renderingToScreen}get screen(){return this.view.screen}_addRunners(...e){e.forEach(n=>{this.runners[n]=new rs(n)})}_addSystems(e){let n;for(n in e){const r=e[n];this._addSystem(r.value,r.name)}}_addSystem(e,n){const r=new e(this);if(this[n])throw new Error(`Whoops! The name "${n}" is already in use`);this[n]=r,this._systemsHash[n]=r;for(const o in this.runners)this.runners[o].add(r);return this}_addPipes(e,n){const r=n.reduce((o,i)=>(o[i.name]=i.value,o),{});e.forEach(o=>{const i=o.value,s=o.name,a=r[s];this.renderPipes[s]=new i(this,a?new a:null)})}destroy(e=!1){this.runners.destroy.items.reverse(),this.runners.destroy.emit(e),Object.values(this.runners).forEach(n=>{n.destroy()}),this._systemsHash=null,this.renderPipes=null}generateTexture(e){return this.textureGenerator.generateTexture(e)}get roundPixels(){return!!this._roundPixels}_unsafeEvalCheck(){if(!ns())throw new Error("Current environment does not allow unsafe-eval, please use pixi.js/unsafe-eval module to enable support.")}resetState(){this.runners.resetState.emit()}};Yr.defaultOptions={resolution:1,failIfMajorPerformanceCaveat:!1,roundPixels:!1};let Zr=Yr,Qe;function is(t){return Qe!==void 0||(Qe=(()=>{const e={stencil:!0,failIfMajorPerformanceCaveat:t??Zr.defaultOptions.failIfMajorPerformanceCaveat};try{if(!Nt.get().getWebGLRenderingContext())return!1;let r=Nt.get().createCanvas().getContext("webgl",e);const o=!!r?.getContextAttributes()?.stencil;if(r){const i=r.getExtension("WEBGL_lose_context");i&&i.loseContext()}return r=null,o}catch{return!1}})()),Qe}let Ke;async function ss(t={}){return Ke!==void 0||(Ke=await(async()=>{const e=Nt.get().getNavigator().gpu;if(!e)return!1;try{return await(await e.requestAdapter(t)).requestDevice(),!0}catch{return!1}})()),Ke}const wn=["webgl","webgpu","canvas"];async function as(t){let e=[];t.preference?(e.push(t.preference),wn.forEach(i=>{i!==t.preference&&e.push(i)})):e=wn.slice();let n,r={};for(let i=0;i<e.length;i++){const s=e[i];if(s==="webgpu"&&await ss()){const{WebGPURenderer:a}=await xn(async()=>{const{WebGPURenderer:l}=await import("./WebGPURenderer-BT_dmrQR.js");return{WebGPURenderer:l}},__vite__mapDeps([0,1,2,3,4,5,6,7]));n=a,r={...t,...t.webgpu};break}else if(s==="webgl"&&is(t.failIfMajorPerformanceCaveat??Zr.defaultOptions.failIfMajorPerformanceCaveat)){const{WebGLRenderer:a}=await xn(async()=>{const{WebGLRenderer:l}=await import("./WebGLRenderer-CBxmEUJz.js");return{WebGLRenderer:l}},__vite__mapDeps([8,1,2,3,4,5,6,7]));n=a,r={...t,...t.webgl};break}else if(s==="canvas")throw r={...t},new Error("CanvasRenderer is not yet implemented")}if(delete r.webgpu,delete r.webgl,!n)throw new Error("No available renderer for the current environment");const o=new n;return await o.init(r),o}const Qr="8.8.1";class Kr{static init(){globalThis.__PIXI_APP_INIT__?.(this,Qr)}static destroy(){}}Kr.extension=y.Application;class ls{constructor(e){this._renderer=e}init(){globalThis.__PIXI_RENDERER_INIT__?.(this._renderer,Qr)}destroy(){this._renderer=null}}ls.extension={type:[y.WebGLSystem,y.WebGPUSystem],name:"initHook",priority:-10};const eo=class Wt{constructor(...e){this.stage=new g,e[0]!==void 0&&Ne(ft,"Application constructor options are deprecated, please use Application.init() instead.")}async init(e){e={...e},this.renderer=await as(e),Wt._plugins.forEach(n=>{n.init.call(this,e)})}render(){this.renderer.render({container:this.stage})}get canvas(){return this.renderer.canvas}get view(){return Ne(ft,"Application.view is deprecated, please use Application.canvas instead."),this.renderer.canvas}get screen(){return this.renderer.screen}destroy(e=!1,n=!1){const r=Wt._plugins.slice(0);r.reverse(),r.forEach(o=>{o.destroy.call(this)}),this.stage.destroy(n),this.stage=null,this.renderer.destroy(e),this.renderer=null}};eo._plugins=[];let to=eo;vt.handleByList(y.Application,to._plugins);vt.add(Kr);var cs=`in vec2 aPosition;
out vec2 vTextureCoord;
...
`;class Zn extends G{constructor(e){const n=E.from({vertex:Ye,fragment:rl,name:"oneColour-filter"});super({glProgram:n,resources:{colorReplaceUniforms:{uColour:{value:new Float32Array(3),type:"vec3<f32>"}}}});const r=this.resources.colorReplaceUniforms.uniforms,[o,i,s]=e.toArray();r.uColour[0]=o,r.uColour[1]=i,r.uColour[2]=s}}const Rt=({name:t,action:e,facingXy8:n,teleportingPhase:r})=>{if(e==="death")return{animationId:`${t}.fadeOut`};if(r==="out")return{animationId:`${t}.fadeOut`};if(r==="in")return{animationId:`${t}.fadeOut`};if(e==="moving")return{animationId:`${t}.walking.${n}`};if(e==="falling"){const i=`${t}.falling.${n}`;if(xi(i))return{textureId:i}}const o=`${t}.idle.${n}`;return yi(o)?{animationId:o}:{textureId:`${t}.walking.${n}.2`}},Qn=({gameTime:t,switchedToAt:e},n,r)=>(n==="headOverHeels"||n===r)&&e+Wi>t,ol=t=>{if(!$e(t))return!1;const{gameTime:e,lastDiedAt:n}=t.type==="headOverHeels"?t.state.head:t.state;return(e-n)%vn<vn*.15},Kn={head:b.pastelBlue,heels:b.pink},er=(t,e)=>{t.filters?Array.isArray(t.filters)?t.filters=[...t.filters,e]:t.filters=[t.filters,e]:t.filters=e},tr=(t,e)=>{t.filters=Array.isArray(t.filters)?t.filters.filter(n=>!(n instanceof e)):t.filters instanceof e?Te:t.filters},Ut=(t,{highlighted:e,flashing:n},r,o)=>{const i=r?.highlighted??!1;e&&!i?er(o,new we({outlineColor:Kn[t],upscale:C.getState().upscale.gameEngineUpscale,lowRes:!1})):!e&&i&&tr(o,we);const s=r?.flashing??!1;n&&!s?er(o,new Zn(Kn[t])):!n&&s&&tr(o,Zn)},Et=({subject:t,currentlyRenderedProps:e,previousRendering:n,gameState:r})=>{const{type:o,state:{action:i,facing:s,teleporting:a}}=t,l=cr(s)??"towards",c=t.type==="headOverHeels"?Qn(t.state.head,"headOverHeels","headOverHeels"):Qn(t.state,t.type,r.currentCharacterName),u=ol(t),d=ke(s),h=a?.phase??null,p={action:i,facingXy8:l,teleportingPhase:h,flashing:u,highlighted:c},m=e===void 0||e.action!==i||e.facingXy8!==l||e.teleportingPhase!==h,v=m?o==="headOverHeels"?nl({top:f(Rt({name:"head",...p})),bottom:f(Rt({name:"heels",...p}))}):f(Rt({name:o,...p})):n;return o==="headOverHeels"?(Ut("head",p,m?void 0:e,v.getChildAt(1)),Ut("heels",p,m?void 0:e,v.getChildAt(0))):Ut(o,p,m?void 0:e,v),i==="moving"&&n instanceof je&&(n.animationSpeed=d*vi),{container:v,renderProps:p}},il=(t,e)=>{const n=([s,a])=>a.config.direction==="away"||a.config.direction==="left",r=new g({label:"floorOverdraws",...T({x:-e.x,y:-e.y})}),o=He(z(ht(t.items)).filter(s=>s[1].type==="wall").filter(n).map(([s,{config:{times:a,direction:l},position:c}])=>f({textureId:"floorOverdraw.cornerNearWall",label:s,...T(c),times:a,anchor:{x:0,y:1},flipX:l==="away"})),new g({label:"floorOverdraws"})),i=He(z(ht(t.items)).filter(s=>s[1].type==="door").filter(n).map(([s,{config:{direction:a},position:l}])=>l.z===0?f({textureId:"floorOverdraw.behindDoor",label:s,...T(lt(l,{x:.5,y:.5})),anchor:{x:0,y:1},flipX:a==="away"}):f({textureId:"floorOverdraw.cornerNearWall",label:s,...T({...l,z:0}),times:{[Ge(Ve(a))]:2},anchor:{x:0,y:1},flipX:a==="away"})),new g({label:"doorOverdraws"}));return r.addChild(o),r.addChild(i),r},sl=t=>[...z(k(t.items)).filter(e=>e.type==="wall").filter(e=>Ve(e.config.direction)==="x"?e.position.x!==0&&e.position.x!==t.size.x:e.position.y!==0&&e.position.y!==t.size.y)],al=t=>{if(t.length===0)return;const e={};for(const n of t){const{config:{direction:r,times:o},position:{x:i,y:s}}=n;r==="left"||r==="right"?(e[r]||(e[r]=[1/0,-1/0]),e[r][0]=Math.min(e[r][0],s),e[r][1]=Math.max(e[r][1],s+(o?.y??1)-1)):(r==="towards"||r==="away")&&(e[r]||(e[r]=[1/0,-1/0]),e[r][0]=Math.min(e[r][0],i),e[r][1]=Math.max(e[r][1],i+(o?.x??1)-1))}return e},ll=({extraWallRanges:t,blockXMin:e,blockYMin:n})=>new j().poly((t.towards?[{x:t.towards[0]-.5+e,y:t.right[0]-.5+n},{x:t.towards[1]+.5-e,y:t.right[0]-.5+n},{x:t.towards[1]+.5-e,y:t.right[1]+.5-n},{x:t.towards[0]-.5+e,y:t.right[1]+.5-n}]:[{x:t.away[0]+1,y:t.left[0]+.5-n},{x:t.away[1]+2.5,y:t.left[0]+.5-n},{x:t.away[1]+2.5,y:t.left[1]+2.5-n},{x:t.away[0]+1,y:t.left[1]+2.5-n}]).map(T),!0).fill(0),cl=D(({subject:t,renderContext:{room:e}})=>{const{blockXMin:n,blockYMin:r,blockXMax:o,blockYMax:i,sidesWithDoors:s,edgeLeftX:a,edgeRightX:l}=Tt(e.roomJson),c=o-n,u=i-r,{floor:d,color:{shade:h},roomJson:p}=e,m=new g({label:`floor(${e.id})`});if(d!=="none"){const $=d==="deadly"?`generic${h==="dimmed"?".dark":""}.floor.deadly`:`${d}${h==="dimmed"?".dark":""}.floor`,_=new g;for(let M=-1;M<=o+2;M++)for(let K=M%2-1;K<=i+2;K+=2)_.addChild(Yi({x:M+(s.right?-.5:0),y:K+(s.towards?-.5:0)},f({textureId:$})));_.addChild(il(p,{x:n,y:r}));const P=new j().poly([te,T({x:c,y:0}),T({x:c,y:u}),T({x:0,y:u})],!0).fill({color:16711680,alpha:.5}).stroke({width:8});_.addChild(P),_.filters=ee(e),_.mask=P,m.addChild(_)}const v=sl(p),A=new j().poly([{x:a,y:16},{x:a,y:-999},{x:l,y:-999},{x:l,y:16}],!0).fill(16776960);m.addChild(A);const F=al(v);if(F!==void 0){const $=ll({extraWallRanges:F,blockXMin:n,blockYMin:r});m.addChild($)}return m.mask=A,m.y=-t.aabb.z,m.cacheAsTexture(!0),m}),ul=({blockXMin:t,blockYMin:e},n)=>{const r=s=>s[1].config.direction==="towards"||s[1].config.direction==="right",o=T({x:-t,y:-e}),i={towards:new g({label:"towards",...o}),right:new g({label:"right",...o})};return z(ht(n.items)).filter(s=>s[1].type==="wall"||s[1].type==="door").filter(r).forEach(([s,a])=>{const{config:{direction:l},position:c}=a,u=l==="right"&&c.x===0,d=l==="towards"&&c.y===0,h=u?{...c,x:t,z:0}:d?{...c,y:e,z:0}:{...c,z:0},p=f({label:s,textureId:`floorEdge.${l}`,...T(h),times:a.type==="wall"?a.config.times:{[Ge(Ve(l))]:2}});i[l].addChild(p),l==="right"&&c.y===0&&e<0&&i[l].addChild(f({label:`${s}-wxtraHalf`,textureId:`floorEdge.half.${l}`,...T(U(h,{y:-.5}))})),l==="towards"&&c.x===0&&t<0&&i[l].addChild(f({label:`${s}-wxtraHalf`,textureId:`floorEdge.half.${l}`,...T(U(h,{x:-.5}))}))}),i},dl=D(({renderContext:{displaySettings:t,onHold:e,room:n}})=>{const{blockXMin:r,blockYMin:o,blockXMax:i,blockYMax:s,edgeLeftX:a,edgeRightX:l}=Tt(n.roomJson),c=i-r,u=s-o,d=new g({label:"floorEdge"}),h=new j({label:"overDrawToHideFallenItems"}).poly([T({x:c,y:0}),T({x:0,y:0}),T({x:0,y:u}),{...T({x:0,y:u}),y:999},{...T({x:c,y:0}),y:999}],!0).fill(0);h.y=8,d.addChild(h);const{towards:p,right:m}=ul({blockXMin:r,blockYMin:o},n.roomJson),v=!e&&!(t.uncolourised??pt.displaySettings.uncolourised);p.filters=Jt(n,"towards",v),m.filters=Jt(n,"right",v),d.addChild(p),d.addChild(m);const A=new j({label:"floorMaskCutOffLeftAndRight"}).poly([{x:a,y:999},{x:a,y:-999},{x:l,y:-999},{x:l,y:999}],!0).fill(16776960);return d.addChild(A),d.mask=A,d.cacheAsTexture(!0),d}),fl=({subject:{config:t,state:e},currentlyRenderedProps:n,renderContext:{room:r}})=>{const{activated:o,busyLickingDoughnutsOffFace:i}=e,s=i?ks:o?void 0:lo(r);switch(t.which){case"skiHead":case"turtle":case"cyberman":case"computerBot":case"elephant":case"elephantHead":case"monkey":{const a=en(e.facing)??"towards";if(!(n===void 0||o!==n.activated||i!==n.busyLickingDoughnutsOffFace||a!==n.facingXy4))return"no-update";const c={facingXy4:a,activated:o,busyLickingDoughnutsOffFace:i};switch(t.which){case"skiHead":return{container:f({textureId:`${t.which}.${t.style}.${a}`,filter:s}),renderProps:c};case"elephantHead":return{container:f({textureId:`elephant.${a}`,filter:s}),renderProps:c};case"turtle":return{container:f(o&&!i?{animationId:`${t.which}.${a}`,filter:s}:{textureId:`${t.which}.${a}.1`,filter:s}),renderProps:c};case"cyberman":return{container:e.activated||e.busyLickingDoughnutsOffFace?ye({top:{textureId:`${t.which}.${a}`,filter:s||ee(r)},bottom:Mt}):f({textureId:`${t.which}.${a}`,filter:s}),renderProps:c};case"computerBot":case"elephant":case"monkey":return{container:ye({top:`${t.which}.${a}`,filter:s}),renderProps:c};default:throw new Error(`unexpected monster ${t}`)}break}case"helicopterBug":case"emperor":case"dalek":case"homingBot":case"bubbleRobot":case"emperorsGuardian":{if(!(n===void 0||i!==n.busyLickingDoughnutsOffFace||o!==n.activated))return"no-update";const l={activated:o,busyLickingDoughnutsOffFace:i};switch(t.which){case"helicopterBug":case"dalek":return{container:f(o&&!i?{animationId:t.which,filter:s}:{textureId:`${t.which}.1`,filter:s}),renderProps:l};case"homingBot":return{filter:s,container:f({textureId:t.which,filter:s}),renderProps:l};case"bubbleRobot":return{container:ye({top:Mt,filter:s}),renderProps:l};case"emperorsGuardian":return{container:ye({top:"ball",bottom:Mt,filter:s}),renderProps:l};case"emperor":return{container:f({animationId:"bubbles.cold",filter:s}),renderProps:l};default:throw new Error(`unexpected monster ${t}`)}break}default:throw new Error(`unexpected monster ${t}`)}},hl=(t,e,n)=>e==="tower"?"tower":e==="book"?"book.x":e==="organic"&&t?`block.organic.dark${n?".disappearing":""}`:`block.${e}${n?".disappearing":""}`,$t=b.moss,nr=()=>D(({subject:{config:{style:t}}})=>f(t==="book"?"book.y":t)),pl={head:Et,heels:Et,headOverHeels:Et,doorFrame:tl,doorLegs:el,monster:fl,stopAutowalk(){throw new Error("these should always be non-rendering")},portal(){throw new Error("these should always be non-rendering")},wall:D(({subject:{id:t,config:{direction:e,tiles:n}},renderContext:{room:r}})=>{if(e==="right"||e==="towards")throw new Error(`this wall should be non-rendering ${t}`);const o=Ge(Ve(e)),i=new g({label:"wallTiles"});for(let s=0;s<n.length;s++){const a=f({textureId:Za(r.planet,n[s],e,r.color.shade==="dimmed"),y:1,pivot:e==="away"?{x:Re.w,y:Re.h+1}:{x:0,y:Re.h+1},filter:ee(r)}),l=T({[o]:s});a.x+=l.x,a.y+=l.y,i.addChild(a)}return i}),barrier:D(({subject:{config:{axis:t,times:e}}})=>f({textureId:`barrier.${t}`,times:e})),deadlyBlock:D(({subject:{config:{style:t,times:e}},renderContext:{room:n}})=>f({textureId:t,filter:t==="volcano"?ee(n):void 0,times:e})),slidingDeadly:nr(),slidingBlock:nr(),block({subject:{config:{style:t,times:e},state:{disappear:n}},currentlyRenderedProps:r,renderContext:{room:o}}){return r===void 0||r.disappear!==n?{container:f({textureId:hl(o.color.shade==="dimmed",t,n!==null),filter:t==="organic"?ee(o):void 0,times:e}),renderProps:{disappear:n}}:"no-update"},switch({subject:{state:{setting:t},config:{store:e}},currentlyRenderedProps:n}){const r=e?wi(C.getState(),e.path)?"right":"left":t;return n===void 0||r!==n.setting?{container:f(`switch.${r}`),renderProps:{setting:r}}:"no-update"},conveyor({subject:{config:{direction:t,times:e},state:{stoodOnBy:n}},currentlyRenderedProps:r}){const o=n.size>0;if(!(r===void 0||r.moving!==o))return"no-update";const s=new g,a=Ve(t);return s.addChild(f(o?{animationId:`conveyor.${a}`,reverse:t==="towards"||t==="right",times:e}:{textureId:`conveyor.${a}.6`,times:e})),{container:s,renderProps:{moving:o}}},lift:D(()=>{const t=new g,e={x:Me.w/2,y:Me.h};return t.addChild(f({animationId:"lift",pivot:e})),t.addChild(f({textureId:"lift.static",pivot:e})),t}),teleporter({subject:{state:{stoodOnBy:t}},currentlyRenderedProps:e}){const n=z(t).find(H)!==void 0;return e===void 0||n!==e.flashing?{container:n?new g({children:[f("teleporter"),f({animationId:"teleporter.flashing"})]}):f("teleporter"),renderProps:{flashing:n}}:"no-update"},pickup:D(({subject:{config:t},renderContext:{room:e}})=>{if(t.gives==="crown")return f({textureId:`crown.${t.planet}`});const r={shield:"whiteRabbit",jumps:"whiteRabbit",fast:"whiteRabbit","extra-life":"whiteRabbit",bag:"bag",doughnuts:"doughnuts",hooter:"hooter",scroll:{textureId:"scroll",filter:ee(e)},reincarnation:{animationId:"fish"}}[t.gives];return f(r)}),moveableDeadly:D(({subject:{config:{style:t}}})=>f(t==="deadFish"?"fish.1":"puck.deadly")),charles({subject:{state:{facing:t}},currentlyRenderedProps:e}){const n=en(t)??"towards";return e===void 0||n!==e.facingXy4?{container:ye({top:`charles.${n}`}),renderProps:{facingXy4:n}}:"no-update"},joystick:st("joystick"),movableBlock:D(({subject:{config:{style:t}}})=>f(t)),portableBlock({subject:{config:{style:t},state:{wouldPickUpNext:e}},currentlyRenderedProps:n}){if(!(n===void 0||e!==n.highlighted))return"no-update";const o=e?new we({outlineColor:$t,lowRes:!1,upscale:C.getState().upscale.gameEngineUpscale}):void 0;return{container:f({textureId:t,filter:o}),renderProps:{highlighted:e}}},spring({subject:{state:{stoodOnBy:t,wouldPickUpNext:e}},currentlyRenderedProps:n}){const r=t.size>0;if(!(n===void 0||e!==n.highlighted||r!==n.compressed))return"no-update";const i=n?.compressed??!1,s=e?new we({outlineColor:$t,lowRes:!1,upscale:C.getState().upscale.gameEngineUpscale}):void 0;return{container:f(!r&&i?{animationId:"spring.bounce",playOnce:"and-stop",filter:s}:{textureId:r?"spring.compressed":"spring.released",filter:s}),renderProps:{compressed:r,highlighted:e}}},sceneryPlayer({subject:{config:{which:t,startDirection:e},state:{wouldPickUpNext:n}},currentlyRenderedProps:r}){if(!(r===void 0||n!==r.highlighted))return"no-update";const i=n?new we({outlineColor:$t,upscale:C.getState().upscale.gameEngineUpscale,lowRes:!1}):void 0;return{container:t==="headOverHeels"?ye({top:{textureId:`head.walking.${e}.2`,filter:i},bottom:{textureId:`heels.walking.${e}.2`,filter:i}}):f({textureId:`${t}.walking.${e}.2`,filter:i}),renderProps:{highlighted:n}}},hushPuppy:st("hushPuppy"),bubbles:D(({subject:{config:{style:t}}})=>f({animationId:`bubbles.${t}`})),firedDoughnut:st({animationId:"bubbles.doughnut"}),ball:st("ball"),floor:cl,floorEdge:dl},ml=t=>t.shadowMask!==void 0,bl=({item:t,room:e,gameState:n,pixiRenderer:r})=>{const o=C.getState(),i=Ci(o),s=pr(o),a=mr(o),l=i==="all"||i==="non-wall"&&t.type!=="wall",c=[];if(t.renders){const u=pl[t.type],d=new Xa(t,n,u);c.push(d),l&&(d.container.alpha=.66),!a&&s&&ml(t)&&c.push(new Ja(t,e,r))}return l&&c.push(new qa(t)),c.length===0?"not-needed":new Wa(t,new gl(c))};class gl{#t;#n=new g({label:"CompositeRenderer"});constructor(e){this.#t=e,this.#n.addChild(...e.map(n=>n.container))}tick(e){for(const n of this.#t)n.tick(e)}destroy(){for(const e of this.#t)e.destroy()}get container(){return this.#n}}const be=.33,vl=Ti()==="mobile"?-4:16,Kt=Re.h-Re.w/2,xl=ce.heels,yl=(t,e,n)=>{const{edgeLeftX:r,edgeRightX:o,frontSide:i,topEdgeY:s}=Tt(t.roomJson),a=r+i.x,l=o+i.x,c=(o+r)/2,u={x:n.x/2-c,y:n.y-vl-i.y-Math.abs(c/2)},d=u.x+a<0,h=u.x+l>n.x,p=u.y+s-Kt<0;return(m,v,A)=>{if(m===void 0)return;const F=w(m.state.position),$=U(F,u),_={x:d&&$.x<n.x*be?Math.min(-a,n.x*be-F.x):h&&$.x>n.x*(1-be)?Math.max(n.x-l,n.x*(1-be)-F.x):u.x,y:p&&$.y<n.y*be?n.y*be-F.y:u.y};if(A)e.x=_.x,e.y=_.y;else{const P=xl*v,M=Xe(e,_),K=dr(M);if(K>P){const ie={x:M.x/K,y:M.y/K};e.x-=ie.x*P,e.y-=ie.y*P}else e.x=_.x,e.y=_.y}}},wl=t=>{const{edgeLeftX:e,edgeRightX:n,frontSide:r,topEdgeY:o}=Tt(t);return new j().rect(e+r.x,o-Kt,n-e,r.y-o+Kt).stroke("red").rect(e+r.x,o,n-e,r.y-o).stroke("blue")};class rr{#t=new g({label:"items"});#n=new g({label:"floorEdge"});#e=new g({children:[this.#t,this.#n]});#r=!1;#s=new Map;#o=new Map;#i;#l;#c;#a;#d;#f;#u;constructor({gameState:e,roomState:n,paused:r,pixiRenderer:o}){const{userSettings:{displaySettings:i},upscale:s}=C.getState();this.#l=i,this.#c=s,this.#a=n,this.#d=e,this.#f=r,this.#u=o,this.#e.label=`RoomRenderer(${n.id})`;const a=!(i?.uncolourised??pt.displaySettings.uncolourised);this.initFilters(!r&&a,n.color),(i?.showBoundingBoxes??pt.displaySettings.showBoundingBoxes)!=="none"&&this.#e.addChild(wl(n.roomJson)),this.#i=yl(n,this.#e,s.gameEngineScreenSize)}initFilters(e,n){this.#t.filters=e?Te:new J(cn(n).main.original)}#h(e){for(const n of k(this.#a.items)){let r=this.#o.get(n.id);if(r!==void 0){if(r==="not-needed")continue}else{if(r=bl({item:n,room:this.#a,gameState:this.#d,pixiRenderer:this.#u}),r==="not-needed"){this.#o.set(n.id,"not-needed");continue}this.#o.set(n.id,r),(n.type==="floorEdge"?this.#n:this.#t).addChild(r.container),n.fixedZIndex&&(r.container.zIndex=n.fixedZIndex)}r.tick(e)}for(const[n,r]of this.#o.entries())this.#a.items[n]===void 0&&(r!=="not-needed"&&r.destroy(),this.#o.delete(n))}#p(e){const{order:n}=Bo(Ha(this.#a.items,e.movedItems,this.#s),this.#a.items);for(let r=0;r<n.length;r++){const o=this.#o.get(n[r]);if(o===void 0||o==="not-needed")throw new Error(`Item id=${n[r]} does not have a renderer - cannot assign a z-index`);o.container.zIndex=n.length-r}}tick(e){const n=this.#r?e:{...e,movedItems:new Set(k(this.#a.items))};this.#i(Q(this.#d),n.deltaMS,!this.#r);const r={...n,room:this.#a};this.#h(r),(!this.#r||n.movedItems.size>0)&&this.#p(r),this.#r=!0}destroy(){this.#e.destroy({children:!0}),this.#o.forEach(e=>{e!=="not-needed"&&e.destroy()})}get displaySettings(){return this.#l}get upscale(){return this.#c}get everRendered(){return this.#r}get container(){return this.#e}get roomState(){return this.#a}get paused(){return this.#f}}var kt=`in vec2 aPosition;
out vec2 vTextureCoord;
...
fn interlaceLines(co: vec3<f32>, coord: vec2<f32>) -> vec3<f32>
{
  ...
  return color;
}`,Sl=Object.defineProperty,kl=(t,e,n)=>e in t?Sl(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n,dt=(t,e,n)=>(kl(t,typeof e!="symbol"?e+"":e,n),n);const Fo=class Do extends G{constructor(e){e={...Do.DEFAULT_OPTIONS,...e};const n=de.from({vertex:{source:Ot,entryPoint:"mainVertex"},fragment:{source:Tl,entryPoint:"mainFragment"}}),r=E.from({vertex:kt,fragment:Cl,name:"crt-filter"});super({gpuProgram:n,glProgram:r,resources:{crtUniforms:{uLine:{value:new Float32Array(4),type:"vec4<f32>"},uNoise:{value:new Float32Array(2),type:"vec2<f32>"},uVignette:{value:new Float32Array(3),type:"vec3<f32>"},uSeed:{value:e.seed,type:"f32"},uTime:{value:e.time,type:"f32"},uDimensions:{value:new Float32Array(2),type:"vec2<f32>"}}}}),dt(this,"uniforms"),dt(this,"seed"),dt(this,"time"),this.uniforms=this.resources.crtUniforms.uniforms,Object.assign(this,e)}apply(e,n,r,o){this.uniforms.uDimensions[0]=n.frame.width,this.uniforms.uDimensions[1]=n.frame.height,this.uniforms.uSeed=this.seed,this.uniforms.uTime=this.time,e.applyFilter(this,n,r,o)}get curvature(){return this.uniforms.uLine[0]}set curvature(e){this.uniforms.uLine[0]=e}get lineWidth(){return this.uniforms.uLine[1]}set lineWidth(e){this.uniforms.uLine[1]=e}get lineContrast(){return this.uniforms.uLine[2]}set lineContrast(e){this.uniforms.uLine[2]=e}get verticalLine(){return this.uniforms.uLine[3]>.5}set verticalLine(e){this.uniforms.uLine[3]=e?1:0}get noise(){return this.uniforms.uNoise[0]}set noise(e){this.uniforms.uNoise[0]=e}get noiseSize(){return this.uniforms.uNoise[1]}set noiseSize(e){this.uniforms.uNoise[1]=e}get vignetting(){return this.uniforms.uVignette[0]}set vignetting(e){this.uniforms.uVignette[0]=e}get vignettingAlpha(){return this.uniforms.uVignette[1]}set vignettingAlpha(e){this.uniforms.uVignette[1]=e}get vignettingBlur(){return this.uniforms.uVignette[2]}set vignettingBlur(e){this.uniforms.uVignette[2]=e}};dt(Fo,"DEFAULT_OPTIONS",{curvature:1,lineWidth:1,lineContrast:.25,verticalLine:!1,noise:0,noiseSize:1,vignetting:.3,vignettingAlpha:1,vignettingBlur:.3,time:0,seed:0});let Ol=Fo;var Il=`
in vec2 vTextureCoord;
out vec4 finalColor;
...
`,Ll=`struct AdvancedBloomUniforms {
  uBloomScale: f32,
  uBrightness: f32,
};
