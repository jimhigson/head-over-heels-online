const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WebGPURenderer-WydIuQMo.js","assets/App-DR7GWzUW.js","assets/index-2QA1KDAF.js","assets/index-B2mZm_9H.css","assets/colorToUniform-KTpA7KSL.js","assets/SharedSystems-9Bo6dK1i.js","assets/Graphics-CELjk-VE.js","assets/changeCharacterRoom-DaBQiSnI.js","assets/WebGLRenderer-B6MgTICW.js"])))=>i.map(i=>d[i]);
import{b3 as ji,b4 as dr,b5 as qi,am as Wi,aq as Ce,ar as G,ae as hr,an as xe,Z as T,a2 as Ut,a0 as Ji,a3 as b,d as rt,v as Dt,aG as y,a6 as gn,ay as fe,_ as Ke,$ as Zi,V as Yi,b6 as Ki,b7 as Qi,b8 as es,ad as ts,b9 as q,ba as eo,K as _,bb as ns,bc as le,bd as F,be as Fn,s as $e,M as w,o as H,c as B,bf as os,bg as rs,bh as is,g as D,w as Ue,bi as ss,bj as An,bk as fr,bl as as,bm as ls,bn as cs,bo as Bt,H as oe,bp as Rn,bq as I,br as de,bs as Nt,R as ut,bt as _t,bu as us,bv as ds,bw as hs,bx as to,by as fs,bz as ps,bA as ms,i as ce,bB as zt,S as Ne,bC as Ht,bD as gs,l as L,bE as Gt,bF as pe,bG as dt,bH as Mn,j as J,bI as He,bJ as U,bK as Dn,bL as Ee,bM as et,bN as zn,t as Te,p as Ln,bO as pr,bP as bs,bQ as vs,bR as ys,bS as xs,I as it,bT as Ft,e as mr,bU as ke,bV as En,bW as ws,bX as gr,k as br,bY as vr,bZ as Vt,b_ as no,b$ as yr,c0 as Ss,c1 as ht,c2 as Ge,c3 as Xt,x as Ie,c4 as bn,c5 as Cs,c6 as Ts,c7 as ks,c8 as Is,A as Ve,c9 as Os,ca as Ps,cb as Bs,cc as vn,cd as _s,ce as Fs,cf as gt,f as $n,cg as As,ch as Rs,ci as Ms,m as Oe,C as xr,cj as oo,h as me,ck as Un,r as wr,a as Sr,n as Ds,a$ as Xe,cl as Qt,cm as bt,cn as zs,co as Ls,cp as qe,cq as ro,cr as Es,cs as $s,ct as Us,cu as Ns,cv as Hs,cw as Gs,cx as Vs,cy as Xs,cz as js,cA as qs,cB as io,L as so,cC as Cr,b2 as Tr,E as kr,F as Ws,B as ao,cD as Js,cE as Zs,cF as Ys,a_ as we,cG as Ks,cH as Qs,cI as ea,cJ as x,cK as yn,cL as Ir,q as ta,cM as st,cN as en,J as lo,cO as na,cP as oa,cQ as ra,cR as ia,aw as Me,cS as sa,cT as aa,cU as la,cV as ca,cW as ua,cX as da,cY as ha,cZ as fa,c_ as co,c$ as pa,N as uo,d0 as ma}from"./App-DR7GWzUW.js";import{f as xn,c as Nn,a as ga,m as jt,b as Hn,d as Or,r as ba,o as va}from"./changeCharacterRoom-DaBQiSnI.js";import{S as ya,G as W}from"./Graphics-CELjk-VE.js";import{g as Pr,_ as ho}from"./index-2QA1KDAF.js";var vt={},fo;function xa(){if(fo)return vt;fo=1;var t=ji(),e=t.mark(i),n=dr(),o=n.wrapWithIterableIterator,r=n.ensureIterable;function i(){var a,l,c,u,d,h,f=arguments;return t.wrap(function(v){for(;;)switch(v.prev=v.next){case 0:for(a=f.length,l=new Array(a),c=0;c<a;c++)l[c]=f[c];u=0,d=l;case 2:if(!(u<d.length)){v.next=8;break}return h=d[u],v.delegateYield(r(h),"t0",5);case 5:u++,v.next=2;break;case 8:case"end":return v.stop()}},e)}vt.__concat=i;var s=o(i);return vt.concat=s,vt}var yt={},po;function wa(){if(po)return yt;po=1;var t=dr(),e=t.iterableCurry,n=qi(),o=n.__firstOr,r=Symbol("none");function i(a){return o(a,r)===r}yt.__isEmpty=i;var s=e(i,{reduces:!0});return yt.isEmpty=s,yt}var tn,mo;function Sa(){return mo||(mo=1,tn=xa().concat),tn}var Ca=Sa();const go=Pr(Ca);var nn,bo;function Ta(){return bo||(bo=1,nn=wa().isEmpty),nn}var ka=Ta();const Ia=Pr(ka),Br=class wn extends Wi{constructor(e){e={...wn.defaultOptions,...e},super(e),this.enabled=!0,this._state=ya.for2d(),this.blendMode=e.blendMode,this.padding=e.padding,typeof e.antialias=="boolean"?this.antialias=e.antialias?"on":"off":this.antialias=e.antialias,this.resolution=e.resolution,this.blendRequired=e.blendRequired,this.clipToViewport=e.clipToViewport,this.addResource("uTexture",0,1)}apply(e,n,o,r){e.applyFilter(this,n,o,r)}get blendMode(){return this._state.blendMode}set blendMode(e){this._state.blendMode=e}static from(e){const{gpu:n,gl:o,...r}=e;let i,s;return n&&(i=Ce.from(n)),o&&(s=G.from(o)),new wn({gpuProgram:i,glProgram:s,...r})}};Br.defaultOptions={blendMode:"normal",resolution:1,padding:0,antialias:"off",blendRequired:!1,clipToViewport:!0};let K=Br;var Oa=`
...
`;class be extends K{constructor(e){const n=Object.keys(e).length,o=G.from({vertex:ft,fragment:Xa.replace(/\$\{SWOP_COUNT\}/g,n.toFixed(0)),name:"palette-swop-filter"});super({glProgram:o,resources:{colorReplaceUniforms:{uOriginal:{value:new Float32Array(3*n),type:"vec3<f32>",size:n},uReplacement:{value:new Float32Array(3*n),type:"vec3<f32>",size:n}}}});const r=this.resources.colorReplaceUniforms.uniforms;Object.entries(e).forEach(([i,s],a)=>{g[i].toArray().forEach((l,c)=>{r.uOriginal[a*3+c]=l}),s.toArray().forEach((l,c)=>{r.uReplacement[a*3+c]=l})})}}const ja=`precision mediump float;
in vec2 vTextureCoord;
out vec4 finalColor;
...
`;class Wa extends K{constructor(){const e=G.from({vertex:ft,fragment:qa,name:"halfbrite-filter"});super({glProgram:e,resources:{}})}}const li=({basic:t,dimmed:e})=>({replaceLight:t,replaceDark:e}),ci=t=>li(jn[t.color.hue][t.color.shade].main),ui=t=>new be({lightBeige:g.lightGrey,redShadow:g.shadow,pink:g.lightGrey,moss:g.lightGrey,midRed:g.midGrey,highlightBeige:g.lightGrey,...t&&ci(t)}),Ja=new be({midGrey:g.midRed,lightGrey:g.lightBeige,white:g.highlightBeige,metallicBlue:g.redShadow,pink:g.midRed,moss:g.midRed,replaceDark:g.midRed,replaceLight:g.lightBeige}),Za=t=>new be({replaceLight:t,replaceDark:Se(t)}),Tn=(t,e,n)=>n?new be(li(jn[t.color.hue][t.color.shade].edges[e])):new N(qn(t.color).edges[e].original),ge=t=>new be(ci(t)),wo=new Wa,Z=ns,Ya=new be(Va),So={x:.5,y:1},Co=t=>typeof t!="string"&&Object.hasOwn(t,"animationId"),kn=t=>{if(typeof t=="string")return kn({textureId:t});{const{anchor:e,flipX:n,pivot:o,x:r,y:i,filter:s,times:a,label:l}=t;let c;if(Co(t)?c=Ka(t):c=new fe(le().textures[t.textureId]),t.hasOwnProperty("times")){const u={x:1,y:1,z:1,...a},d=new b({label:l??"timesXyz"});for(let{x:h}=u;h>=1;h--)for(let{y:f}=u;f>=1;f--)for(let m=1;m<=u.z;m++){const v={...t,label:`(${h},${f},${m})`};delete v.times;const k=kn(v),O=F({x:h-1,y:f-1,z:m-1});k.x+=O.x,k.y+=+O.y,d.addChild(k)}return d}if(e===void 0&&o===void 0)if(Co(t))c.anchor=So;else{const u=le().data.frames[t.textureId].frame;u.pivot!==void 0?c.pivot=u.pivot:c.anchor=So}else e!==void 0&&(c.anchor=e),o!==void 0&&(c.pivot=o);return r!==void 0&&(c.x=r),i!==void 0&&(c.y=i),s!==void 0&&(c.filters=s),l!==void 0&&(c.label=l),c.eventMode="static",n===!0&&(c.scale.x=-1),c}},p=kn;function Ka({animationId:t,reverse:e,playOnce:n,paused:o}){const r=le().animations[t],s=(o?[r[0]]:r).map(l=>({texture:l,time:Fn}));e&&s.reverse();const a=new at(s);return a.animationSpeed=$e.animations[t].animationSpeed,a.play(),n!==void 0&&(a.loop=!1,a.onComplete=()=>{a.stop(),n==="and-destroy"&&(a.visible=!1)}),a}const Qa=`#version 300 es
