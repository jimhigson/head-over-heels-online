...
fn mainFragment(
  @location(0) uv: vec2<f32>
   ...
   return out;
}`;class S extends W{constructor(e){const n=e.gpu,r=en({source:bi,...n}),o=se.from({vertex:{source:r,entryPoint:"mainVertex"},fragment:{source:r,entryPoint:"mainFragment"}}),i=e.gl,s=en({source:mi,...i}),a=H.from({vertex:gi,fragment:s}),l=new Rn({uBlend:{value:1,type:"f32"}});super({gpuProgram:o,glProgram:a,blendRequired:!0,resources:{blendUniforms:l,uBackTexture:oe.EMPTY}})}}function en(t){const{source:e,functions:n,main:r}=t;return e.replace("{FUNCTIONS}",n).replace("{MAIN}",r)}const Et=`
