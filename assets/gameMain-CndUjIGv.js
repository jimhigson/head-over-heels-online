const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WebGPURenderer-CsbAX6il.js","assets/App-B7EkxCZa.js","assets/index-_RFH5brH.js","assets/index-dG3WBgIR.css","assets/colorToUniform-KTpA7KSL.js","assets/SharedSystems-C-c0vhWV.js","assets/Graphics-eE_TmYqd.js","assets/swopCharacters-2tFxmx4A.js","assets/WebGLRenderer-Cffh6Fhm.js"])))=>i.map(i=>d[i]);
import{aO as Ci,a8 as Eo,I as Si,L as be,N as U,t as Uo,J as he,E as C,g as At,f as Ti,C as b,d as Je,v as _t,a6 as w,D as on,_ as Ae,T as Ve,U as ki,V as Ii,aP as Oi,aQ as _i,aR as Pi,q as Bi,aS as ct,ae as le,aT as Fi,aU as Q,aj as $o,aV as ce,aW as No,ar as jo,al as y,o as te,ac as _,aX as Ai,aY as Mi,aZ as Di,ag as M,a_ as Me,a$ as zi,b0 as Vo,b1 as Xo,b2 as Li,b3 as Ct,ad as E,b4 as Ri,i as oe,b5 as Ei,b6 as Ui,b7 as $i,b8 as Ni,as as Ho,ah as Mt,b9 as Dn,ba as ji,bb as ot,bc as Go,bd as ve,be as Dt,p as rt,at as ye,af as rn,an as se,bf as Vi,bg as Xi,bh as Hi,bi as Gi,bj as xn,a9 as qo,bk as Xe,ai as qi,bl as Wi,bm as wn,bn as Ji,bo as Yi,bp as Wo,bq as Zi,br as Qi,bs as Ki,bt as es,ao as Pt,bu as St,bv as ts,bw as ns,bx as os,b as Ye,by as He,bz as x,bA as sn,aq as zn,bB as rs,bC as is,bD as ss,bE as Jo,Y as Oe,bF as as,av as ls,bG as cs,bH as us,bI as ds,bJ as fs,au as Ln,bK as hs}from"./App-B7EkxCZa.js";import{r as ps,l as an,j as Bt,g as Rn,k as En,h as z,p as k,m as xe,n as Cn,q as ms,t as gs,u as ln,v as Ze,w as Tt,c as Sn,x as L,i as G,y as Yo,z as Zo,A as Qo,B as pe,C as zt,D as Tn,E as De,F as bs,G as vs,H as ys,I as cn,J as xs,K as ut,L as ws,M as Cs,N as Ss,a as we,O as Ko,P as er,Q as Un,R as ue,S as tr,T as nr,f as Ts,U as or,V as ks,b as ze,W as Nt,X as dt,Y as Is,Z as Le,_ as $n,$ as Os,a0 as kn,a1 as _s,a2 as it,a3 as Ps,a4 as Bs,a5 as Fs,a6 as As,a7 as Nn,a8 as rr,e as ir,o as sr,a9 as Ms,aa as jn,ab as Ds,s as Qe,ac as zs,ad as jt,ae as S,af as Ls,ag as Rs,ah as Es,ai as Vn,aj as Lt,ak as Us,al as $s,am as Vt,an as Xn}from"./swopCharacters-2tFxmx4A.js";import{S as Ns,G as H}from"./Graphics-eE_TmYqd.js";import{g as ar,_ as Hn}from"./index-_RFH5brH.js";var ft={},Gn;function js(){if(Gn)return ft;Gn=1;var t=Ci(),e=t.mark(i),n=Eo(),o=n.wrapWithIterableIterator,r=n.ensureIterable;function i(){var a,l,c,u,d,f,h=arguments;return t.wrap(function(v){for(;;)switch(v.prev=v.next){case 0:for(a=h.length,l=new Array(a),c=0;c<a;c++)l[c]=h[c];u=0,d=l;case 2:if(!(u<d.length)){v.next=8;break}return f=d[u],v.delegateYield(r(f),"t0",5);case 5:u++,v.next=2;break;case 8:case"end":return v.stop()}},e)}ft.__concat=i;var s=o(i);return ft.concat=s,ft}var ht={},qn;function Vs(){if(qn)return ht;qn=1;var t=Eo(),e=t.iterableCurry,n=ps(),o=n.__firstOr,r=Symbol("none");function i(a){return o(a,r)===r}ht.__isEmpty=i;var s=e(i,{reduces:!0});return ht.isEmpty=s,ht}var Xt,Wn;function Xs(){return Wn||(Wn=1,Xt=js().concat),Xt}var Hs=Xs();const un=ar(Hs);var Ht,Jn;function Gs(){return Jn||(Jn=1,Ht=Vs().isEmpty),Ht}var qs=Gs();const Ws=ar(qs),lr=class dn extends Si{constructor(e){e={...dn.defaultOptions,...e},super(e),this.enabled=!0,this._state=Ns.for2d(),this.blendMode=e.blendMode,this.padding=e.padding,typeof e.antialias=="boolean"?this.antialias=e.antialias?"on":"off":this.antialias=e.antialias,this.resolution=e.resolution,this.blendRequired=e.blendRequired,this.clipToViewport=e.clipToViewport,this.addResource("uTexture",0,1)}apply(e,n,o,r){e.applyFilter(this,n,o,r)}get blendMode(){return this._state.blendMode}set blendMode(e){this._state.blendMode=e}static from(e){const{gpu:n,gl:o,...r}=e;let i,s;return n&&(i=be.from(n)),o&&(s=U.from(o)),new dn({gpuProgram:i,glProgram:s,...r})}};lr.defaultOptions={blendMode:"normal",resolution:1,padding:0,antialias:"off",blendRequired:!1,clipToViewport:!0};let W=lr;var Js=`
...
fn mainFragment(
  @location(0) uv: vec2<f32>
   ...
   return out;
}`;class I extends W{constructor(e){const n=e.gpu,o=Yn({source:Zs,...n}),r=be.from({vertex:{source:o,entryPoint:"mainVertex"},fragment:{source:o,entryPoint:"mainFragment"}}),i=e.gl,s=Yn({source:Js,...i}),a=U.from({vertex:Ys,fragment:s}),l=new Uo({uBlend:{value:1,type:"f32"}});super({gpuProgram:r,glProgram:a,blendRequired:!0,resources:{blendUniforms:l,uBackTexture:he.EMPTY}})}}function Yn(t){const{source:e,functions:n,main:o}=t;return e.replace("{FUNCTIONS}",n).replace("{MAIN}",o)}const In=`
...
`;class Ce extends W{constructor(e){const n=Object.keys(e).length,o=U.from({vertex:st,fragment:pa.replace(/\$\{SWOP_COUNT\}/g,n.toFixed(0)),name:"palette-swop-filter"});super({glProgram:o,resources:{colorReplaceUniforms:{uOriginal:{value:new Float32Array(3*n),type:"vec3<f32>",size:n},uReplacement:{value:new Float32Array(3*n),type:"vec3<f32>",size:n}}}});const r=this.resources.colorReplaceUniforms.uniforms;Object.entries(e).forEach(([i,s],a)=>{g[i].toArray().forEach((l,c)=>{r.uOriginal[a*3+c]=l}),s.toArray().forEach((l,c)=>{r.uReplacement[a*3+c]=l})})}}const ma=`precision mediump float;
in vec2 vTextureCoord;
out vec4 finalColor;
...
`;class ba extends W{constructor(){const e=U.from({vertex:st,fragment:ga,name:"halfbrite-filter"});super({glProgram:e,resources:{}})}}const jr=({basic:t,dimmed:e})=>({replaceLight:t,replaceDark:e}),Vr=t=>jr(Pn[t.color.hue][t.color.shade].main),Xr=t=>new Ce({lightBeige:g.lightGrey,redShadow:g.shadow,pink:g.lightGrey,moss:g.lightGrey,midRed:g.midGrey,highlightBeige:g.lightGrey,...t&&Vr(t)}),va=new Ce({midGrey:g.midRed,lightGrey:g.lightBeige,white:g.highlightBeige,metallicBlue:g.redShadow,pink:g.midRed,moss:g.midRed,replaceDark:g.midRed,replaceLight:g.lightBeige}),ya=t=>new Ce({replaceLight:t,replaceDark:me(t)}),pn=(t,e,n)=>n?new Ce(jr(Pn[t.color.hue][t.color.shade].edges[e])):new R(Bn(t.color).edges[e].original),re=t=>new Ce(Vr(t)),eo=new ba,ge=$o,to={x:.5,y:1},no=t=>typeof t!="string"&&Object.hasOwn(t,"animationId"),p=t=>{if(typeof t=="string")return p({textureId:t});{const{anchor:e,flipX:n,pivot:o,x:r,y:i,filter:s,times:a,label:l}=t;let c;if(no(t)?c=xa(t):c=new Ae(ce().textures[t.textureId]),a!==void 0){const u={x:1,y:1,z:1,...a},d=new b({label:l??"timesXyz"});for(let{x:f}=u;f>=1;f--)for(let{y:h}=u;h>=1;h--)for(let m=1;m<=u.z;m++){const v=p({...t,times:void 0,label:`(${f},${h},${m})`}),T=k({x:f-1,y:h-1,z:m-1});v.x+=T.x,v.y+=+T.y,d.addChild(v)}return d}if(e===void 0&&o===void 0)if(no(t))c.anchor=to;else{const u=ce().data.frames[t.textureId].frame;u.pivot!==void 0?c.pivot=u.pivot:c.anchor=to}else e!==void 0&&(c.anchor=e),o!==void 0&&(c.pivot=o);return r!==void 0&&(c.x=r),i!==void 0&&(c.y=i),s!==void 0&&(c.filters=s),l!==void 0&&(c.label=l),c.eventMode="static",n===!0&&(c.scale.x=-1),c}};function xa({animationId:t,reverse:e,playOnce:n,paused:o}){const r=ce().animations[t],s=(o?[r[0]]:r).map(l=>({texture:l,time:No}));e&&s.reverse();const a=new Ke(s);return a.animationSpeed=jo.animations[t].animationSpeed,a.play(),n!==void 0&&(a.loop=!1,a.onComplete=()=>{a.stop(),n==="and-destroy"&&(a.visible=!1)}),a}const wa=`#version 300 es
