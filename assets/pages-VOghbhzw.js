var e=Object.assign({"./bag.md":`## Bag
...
> Section adapted from the original Head over Heels manual`,"./bookWorld.md":`## Planet Book World
...
> Section adapted from the original Head over Heels manual
`,"./conveyorBelts.md":`## Conveyor Belts

![](texture-animated-heels_walking_right?z-topSprite&relative&ml-centreSmallBlockOnLarge&mr-12px)![](texture-animated-conveyor_x?&relative&clear-left&bottom-bottomStackPullup)The rollers on the conveyor simply push you along it. If you wish to go the
...
©2025 Jim Higson`,"./crowns.md":`## Crowns

![](texture-crown_blacktooth)![](texture-crown_bookworld?clear-left)![](texture-crown_egyptus?clear-left)![](texture-crown_penitentiary?clear-left)![](texture-crown_safari?clear-left)Find a crown and start a revolution.

At the beginning of each game, a screen
...
> Section adapted from the original Head over Heels manual`,"./cuddlyStuffedWhiteRabbits.md":`## Cuddly Stuffed White Rabbits
...
## ![](texture-whiteRabbit_extra-life?sprites-normal-height&float-right&text-white)**2** Extra lives
...
![](texture-animated-heels_walking_right?float-left&sprites-normal-height) During Heels’s evolution, the arms have totally disappeared while the legs have
become very powerful.

Heels can jump their own height and can also run very fast.

> Section adapted from the original Head over Heels manual`,"./hintsAndTips.md":`## Hints and Tips
...
2. **2** ![](texture-animated-head_idle_towards?float-right&relative&z-topSprite)![](texture-animated-heels_idle_towards&float-right&clear-right&relative&bottom-bottomStackPullup)When you first get Head and Heels in the same location, practice placing Head on top of Heels and joining them together accurately with the swop key. Both of their icons will light up when they are successfully joined.
...
> Section adapted from the original Head over Heels manual`,"./historyOfTheBlacktoothEmpire.md":`## The Blacktooth Empire
...
The hooter may only be used by **Head** and requires a tray of *doughnuts* to be of any use.

> Section adapted from the original Head over Heels manual
`,"./hushPuppies.md":`## Hush Puppies

![](texture-hushPuppy)These are a very strange type of beast; they are incredibly 
...
![](texture-animated-bubbles_white)Nobody knows where they go, but
...
> Section adapted from the original Head over Heels manual
`,"./reincarnationFish.md":`## Reincarnation Fish
...
> Section adapted from the original Head over Heels manual
`,"./remake/installGuideNative.md":`## Download and install
...
\`\`\``,"./remake/installGuidePwa.md":`## PWA install instructions
...
* Work without an App Store or downloading an installer

----

## On Chrome

For: **Mac**, **Windows**, **Linux**, **Chromebooks**, **iphone**, or **Android**

To install:

* Go to [blockstack.ing](https://blockstack.ing)
...
* Go to [blockstack.ing](https://blockstack.ing) in Safari
* Tap the **share button **
* The share button is either at the bottom of the screen, or to the right of the address
...
* Doesn't support PWAs.`,"./remake/supportedPlatforms.md":`## Supported platforms
...
* **ZX Spectrum** - Currently untested`,"./returnOfTheEmpire2.md":`## The Return of the Empire

![](texture-crown_blacktooth)![](texture-crown_bookworld?float-right)Thirty-eight years have passed since Head and Heels, against all sensible
...
![](texture-animated-dalek?float-right)The Emperor’s dynasty kept very thorough records (in a secret annex of Bookworld,
naturally). A distant cousin of the old Emperor, having spent the
intervening decades hiding on a small asteroid, has returned to Blacktooth
with a rebuilt army of mechanical guardians and a grudge that has had
thirty-eight years to ferment.
...
In short, it’s a bit more puzzle-y.

![](texture-teleporter)Enjoying their lives of freedom, Head and Heels must now teleport back to their
cells in Blacktooth jail, arriving separately to the cells they once escaped
from. The irony of voluntarily returning to prison has not been lost on either
of them.

Your job, once more, is to get them out, find the crowns, and return to freedom.
`,"./safari.md":`## Planet Safari

![](texture-monkey_right?float-left&relative&z-topSprite)![](texture-headlessBase?float-left&clear-left&relative&bottom-bottomStackPullup)![](texture-elephant_towards?float-right&relative&z-topSprite)![](texture-headlessBase?float-right&clear-right&relative&bottom-bottomStackPullup)A densely vegetated planet, mainly used for hunting.

The natives live in wooden forts in the jungle, **beware traps!**

> Section adapted from the original Head over Heels manual`,"./springs.md":`## Springs
...
> Section adapted from the original Head over Heels manual`,"./teleportBack.md":`## Exalted Emperor:
...
> Section adapted from the original Head over Heels manual `,"./theEmperorsGuardian.md":`## The Emperor’s Guardian

![](texture-animated-emperorsGuardian?relative&z-topSprite)![](texture-animated-bubbles_cold?relative&clear-both&bottom-bottomStackPullup)The guardian blocks the door to the throne room in Blacktooth castle. He is **VERY
...
> Section adapted from the original Head over Heels manual
`}),t={historyOfTheBlacktoothEmpire:e[`./historyOfTheBlacktoothEmpire.md`],theGame:e[`./theGame.md`],egyptus:e[`./egyptus.md`],penitentiary:e[`./penitentiary.md`],safari:e[`./safari.md`],bookWorld:e[`./bookWorld.md`],blacktooth:e[`./blacktooth.md`],head:e[`./head.md`],heels:e[`./heels.md`],reincarnationFish:e[`./reincarnationFish.md`],cuddlyStuffedWhiteRabbits:e[`./cuddlyStuffedWhiteRabbits.md`],hooter:e[`./hooter.md`],doughnuts:e[`./doughnuts.md`],bag:e[`./bag.md`],crowns:e[`./crowns.md`],teleports:e[`./teleports.md`],springs:e[`./springs.md`],switches:e[`./switches.md`],conveyorBelts:e[`./conveyorBelts.md`],hushPuppies:e[`./hushPuppies.md`],theEmperorsGuardian:e[`./theEmperorsGuardian.md`],swopKey:e[`./swopKey.md`],hintsAndTips:e[`./hintsAndTips.md`],credits:e[`./credits.md`],installPwa:e[`./remake/installGuidePwa.md`],installNative:e[`./remake/installGuideNative.md`]},n={...t,teleportBack:e[`./teleportBack.md`]},r=/^##\s+(.*)$/m,i=e=>{let t=e.match(r);if(t===null)return`no title found`;let[,n]=t;return n};export{n,i as r,t};