...
fn mainFragment(
  @location(0) uv: vec2<f32>
   ...
   return out;
}`;class w extends J{constructor(e){const n=e.gpu,r=Zt({source:qo,...n}),o=se.from({vertex:{source:r,entryPoint:"mainVertex"},fragment:{source:r,entryPoint:"mainFragment"}}),i=e.gl,s=Zt({source:Xo,...i}),a=G.from({vertex:Go,fragment:s}),l=new In({uBlend:{value:1,type:"f32"}});super({gpuProgram:o,glProgram:a,blendRequired:!0,resources:{blendUniforms:l,uBackTexture:fe.EMPTY}})}}function Zt(t){const{source:e,functions:n,main:r}=t;return e.replace("{FUNCTIONS}",n).replace("{MAIN}",r)}const Mt=`
...
`;class Ce extends J{constructor(e,n){const r=G.from({vertex:Ut,fragment:ui,name:"outline-filter"});super({glProgram:r,padding:n,resources:{colorReplaceUniforms:{uOutline:{value:new Float32Array(3),type:"vec3<f32>"},uOutlineWidth:{value:new Float32Array(1),type:"f32"}}}});const o=this.resources.colorReplaceUniforms.uniforms,[i,s,a]=e.toArray();o.uOutline[0]=i,o.uOutline[1]=s,o.uOutline[2]=a,o.uOutlineWidth[0]=n}}const di=`precision mediump float;
in vec2 vTextureCoord;
out vec4 finalColor;
