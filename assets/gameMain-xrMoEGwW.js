const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WebGPURenderer-ToQp00Kq.js","assets/index-BdmaLhq8.js","assets/index-D0Ooe6Gp.css","assets/colorToUniform-KTpA7KSL.js","assets/SharedSystems-B0crnpb0.js","assets/Graphics-DgWD1WaX.js","assets/changeCharacterRoom-DOUpxkmH.js","assets/WebGLRenderer-B2BJZ37l.js"])))=>i.map(i=>d[i]);
import{y as no,a6 as le,a7 as H,n as Un,A as de,E as v,e as tt,c as ro,C as b,d as qe,v as Tt,am as m,D as Ct,aI as en,ae as je,T as ze,U as oo,aJ as io,F as so,g as ao,aK as lo,aL as ae,aM as En,a3 as co,aN as uo,Y as z,aO as Nn,aP as Te,aQ as fo,L as I,W as k,aR as ke,Q as Ut,aS as be,aT as Et,a0 as se,aU as Ye,aV as ho,aW as po,N as _,K as Nt,aX as Pe,X as $n,aY as Vn,O as St,aZ as tn,a4 as Be,a_ as mo,a$ as bo,b0 as go,b1 as $t,$ as q,a1 as P,b2 as Je,b3 as vo,Z as Vt,b4 as yo,b5 as xo,b6 as wo,b7 as dt,b8 as To,b9 as Ce,_ as Co,ba as So,bb as Hn,ab as fe,J as ko,bc as Oo}from"./index-BdmaLhq8.js";import{l as kt,f as Ze,a as j,e as L,g as nn,h as rn,j as De,s as Oe,k as te,i as D,m as Ot,t as _o,p as Le,o as Io,n as Po,w as Bo,q as Y,r as Ao,u as Fo,v as zo,x as ge,y as ft,z as _t,A as on,B as ht,c as Ht,C as J,D as Xn,E as Gn,F as Do,G as nt,H as V,I as rt,J as Wn,K as sn,L as qn,M as Lo,N as It,O as Mo,P as jn,d as Ro,Q as _e,R as Ke,S as pe,T as Uo,U as Eo,V as No,W as $o,X as an,Y as Pt,Z as Bt,_ as At,$ as Vo,a0 as Ie,a1 as Ho,b as ot,a2 as x,a3 as $,a4 as it,a5 as Qe,a6 as Yn,a7 as Xo}from"./changeCharacterRoom-DOUpxkmH.js";import{S as Go,G as W}from"./Graphics-DgWD1WaX.js";const Jn=class Ft extends no{constructor(e){e={...Ft.defaultOptions,...e},super(e),this.enabled=!0,this._state=Go.for2d(),this.blendMode=e.blendMode,this.padding=e.padding,typeof e.antialias=="boolean"?this.antialias=e.antialias?"on":"off":this.antialias=e.antialias,this.resolution=e.resolution,this.blendRequired=e.blendRequired,this.clipToViewport=e.clipToViewport,this.addResource("uTexture",0,1)}apply(e,n,r,o){e.applyFilter(this,n,r,o)}get blendMode(){return this._state.blendMode}set blendMode(e){this._state.blendMode=e}static from(e){const{gpu:n,gl:r,...o}=e;let i,s;return n&&(i=le.from(n)),r&&(s=H.from(r)),new Ft({gpuProgram:i,glProgram:s,...o})}};Jn.defaultOptions={blendMode:"normal",resolution:1,padding:0,antialias:"off",blendRequired:!1,clipToViewport:!0};let Z=Jn;var Wo=`
...
fn mainFragment(
  @location(0) uv: vec2<f32>
   ...
   return out;
}`;class w extends Z{constructor(e){const n=e.gpu,r=ln({source:jo,...n}),o=le.from({vertex:{source:r,entryPoint:"mainVertex"},fragment:{source:r,entryPoint:"mainFragment"}}),i=e.gl,s=ln({source:Wo,...i}),a=H.from({vertex:qo,fragment:s}),l=new Un({uBlend:{value:1,type:"f32"}});super({gpuProgram:o,glProgram:a,blendRequired:!0,resources:{blendUniforms:l,uBackTexture:de.EMPTY}})}}function ln(t){const{source:e,functions:n,main:r}=t;return e.replace("{FUNCTIONS}",n).replace("{MAIN}",r)}const Xt=`
