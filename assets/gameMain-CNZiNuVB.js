const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WebGPURenderer-C2fkxRea.js","assets/App-9EfB7euI.js","assets/index-B5XERbuR.js","assets/index-CGQ8pOyP.css","assets/colorToUniform-KTpA7KSL.js","assets/SharedSystems-B_HPotLx.js","assets/Graphics-DTVAf6KP.js","assets/swopCharacters-C3BnI92P.js","assets/WebGLRenderer-CF9Lg59y.js"])))=>i.map(i=>d[i]);
import{aO as pi,a8 as mi,I as gi,L as ge,N as $,t as Ao,J as de,E as C,g as Bt,f as bi,C as g,d as We,v as It,a6 as w,D as en,_ as Ae,T as Ve,U as vi,V as yi,aP as xi,aQ as wi,aR as Ci,q as Si,aS as at,ae as ne,aT as Ti,aU as Q,ai as Mo,aV as ae,aW as Do,ar as Lo,al as y,o as ee,ac as O,aX as ki,aY as Ii,aZ as Oi,ag as A,a_ as Me,a$ as Pi,b0 as zo,b1 as Ro,b2 as _i,b3 as xt,ad as E,b4 as Bi,i as le,b5 as Fi,b6 as Ai,b7 as Mi,b8 as Di,as as Uo,ah as Ft,b9 as An,ba as Li,bb as nt,bc as Eo,bd as be,be as At,p as ot,at as ve,af as tn,an as ie,bf as zi,bg as Ri,bh as Ui,bi as Ei,bj as gn,a9 as $o,bk as Xe,aj as $i,bl as Ni,bm as bn,bn as Vi,bo as Xi,bp as No,bq as ji,br as Hi,bs as Gi,ao as Ot,bt as wt,bu as qi,bv as Wi,bw as Ji,b as Je,bx as je,by as x,bz as Te,bA as Yi,bB as Zi,bC as Qi,bD as Vo,Y as Oe,bE as Ki,av as es,bF as ts,bG as ns,bH as os,bI as rs,au as Mn,bJ as is}from"./App-9EfB7euI.js";import{l as nn,j as Pt,g as Dn,k as Ln,h as L,p as T,m as ye,n as vn,q as ss,r as as,t as on,u as Ye,v as Ct,c as yn,w as z,i as G,x as Xo,y as jo,z as Ho,A as fe,B as Mt,C as xn,D as De,E as ls,F as cs,G as us,H as rn,I as ds,J as lt,K as fs,L as hs,M as ps,a as xe,N as Go,O as qo,P as zn,Q as he,R as Wo,S as Jo,f as ms,T as Yo,U as gs,b as Le,V as Et,W as ct,X as bs,Y as ze,Z as Rn,_ as vs,$ as wn,a0 as ys,a1 as rt,a2 as xs,a3 as ws,a4 as Cs,a5 as Ss,a6 as Un,a7 as Zo,e as Qo,o as Ko,a8 as Ts,a9 as En,aa as ks,s as Ze,ab as Is,ac as $t,ad as S,ae as Os,af as Ps,ag as _s,ah as $n,ai as Dt,aj as Bs,ak as Fs,al as Nt,am as Nn}from"./swopCharacters-C3BnI92P.js";import{S as As,G as H}from"./Graphics-DTVAf6KP.js";import{g as Ms,_ as Vn}from"./index-B5XERbuR.js";var ut={},Xn;function Ds(){if(Xn)return ut;Xn=1;var t=pi(),e=t.mark(i),n=mi(),o=n.wrapWithIterableIterator,r=n.ensureIterable;function i(){var a,l,c,u,d,f,h=arguments;return t.wrap(function(v){for(;;)switch(v.prev=v.next){case 0:for(a=h.length,l=new Array(a),c=0;c<a;c++)l[c]=h[c];u=0,d=l;case 2:if(!(u<d.length)){v.next=8;break}return f=d[u],v.delegateYield(r(f),"t0",5);case 5:u++,v.next=2;break;case 8:case"end":return v.stop()}},e)}ut.__concat=i;var s=o(i);return ut.concat=s,ut}var Vt,jn;function Ls(){return jn||(jn=1,Vt=Ds().concat),Vt}var zs=Ls();const sn=Ms(zs),er=class an extends gi{constructor(e){e={...an.defaultOptions,...e},super(e),this.enabled=!0,this._state=As.for2d(),this.blendMode=e.blendMode,this.padding=e.padding,typeof e.antialias=="boolean"?this.antialias=e.antialias?"on":"off":this.antialias=e.antialias,this.resolution=e.resolution,this.blendRequired=e.blendRequired,this.clipToViewport=e.clipToViewport,this.addResource("uTexture",0,1)}apply(e,n,o,r){e.applyFilter(this,n,o,r)}get blendMode(){return this._state.blendMode}set blendMode(e){this._state.blendMode=e}static from(e){const{gpu:n,gl:o,...r}=e;let i,s;return n&&(i=ge.from(n)),o&&(s=$.from(o)),new an({gpuProgram:i,glProgram:s,...r})}};er.defaultOptions={blendMode:"normal",resolution:1,padding:0,antialias:"off",blendRequired:!1,clipToViewport:!0};let W=er;var Rs=`
...
fn mainFragment(
  @location(0) uv: vec2<f32>
   ...
   return out;
	...
	`;class tr extends k{constructor(){super({gl:{functions:`
                ${Cn}
                ...
                `}})}}tr.extension={name:"color",type:C.BlendMode};class nr extends k{constructor(){super({gl:{functions:`
            ...
            `}})}}nr.extension={name:"color-burn",type:C.BlendMode};class or extends k{constructor(){super({gl:{functions:`
                ...
                `}})}}or.extension={name:"color-dodge",type:C.BlendMode};class rr extends k{constructor(){super({gl:{functions:`
                ...
                `}})}}rr.extension={name:"darken",type:C.BlendMode};class ir extends k{constructor(){super({gl:{functions:`
            ...
            `}})}}ir.extension={name:"difference",type:C.BlendMode};class sr extends k{constructor(){super({gl:{functions:`
            ...
            `}})}}sr.extension={name:"divide",type:C.BlendMode};class ar extends k{constructor(){super({gl:{functions:`
            ...
            `}})}}ar.extension={name:"exclusion",type:C.BlendMode};class lr extends k{constructor(){super({gl:{functions:`
            ...
            `},gpu:{functions:`
                ...
                `}})}}lr.extension={name:"hard-light",type:C.BlendMode};class cr extends k{constructor(){super({gl:{functions:`
            ...
            `}})}}cr.extension={name:"hard-mix",type:C.BlendMode};class ur extends k{constructor(){super({gl:{functions:`
            ...
            `}})}}ur.extension={name:"lighten",type:C.BlendMode};class dr extends k{constructor(){super({gl:{functions:`
                ...
                `}})}}dr.extension={name:"linear-burn",type:C.BlendMode};class fr extends k{constructor(){super({gl:{functions:`
            ...
            `}})}}fr.extension={name:"linear-dodge",type:C.BlendMode};class hr extends k{constructor(){super({gl:{functions:`
                float linearBurn(float base, float blend) {
                    return max(0.0, base + blend - 1.0);
                }
            ...
            `}})}}hr.extension={name:"linear-light",type:C.BlendMode};class pr extends k{constructor(){super({gl:{functions:`
                ${Cn}
            ...
            `}})}}pr.extension={name:"luminosity",type:C.BlendMode};class mr extends k{constructor(){super({gl:{functions:`
            ...
            `}})}}mr.extension={name:"negation",type:C.BlendMode};class gr extends k{constructor(){super({gl:{functions:`
                ...
                `}})}}gr.extension={name:"overlay",type:C.BlendMode};class br extends k{constructor(){super({gl:{functions:`
            ...
            `,main:`
                ...
                `}})}}br.extension={name:"pin-light",type:C.BlendMode};class vr extends k{constructor(){super({gl:{functions:`
                ${Cn}
            ...
            `}})}}vr.extension={name:"saturation",type:C.BlendMode};class yr extends k{constructor(){super({gl:{functions:`
                ...
                `}})}}yr.extension={name:"soft-light",type:C.BlendMode};class xr extends k{constructor(){super({gl:{functions:`
                ...
                `}})}}xr.extension={name:"subtract",type:C.BlendMode};class wr extends k{constructor(){super({gl:{functions:`
                float colorBurn(float base, float blend)
                {
                    return max((1.0-((1.0-base)/blend)),0.0);
                }
            ...
            `},gpu:{functions:`
                ...
                `}})}}wr.extension={name:"vivid-light",type:C.BlendMode};const ln=[];Bt.handleByNamedList(C.Environment,ln);async function $s(t){if(!t)for(let e=0;e<ln.length;e++){const n=ln[e];if(n.value.test()){await n.value.load();return}}}let Re;function Ns(){if(typeof Re=="boolean")return Re;try{Re=new Function("param1","param2","param3","return param1[param2] === param3;")({a:"b"},"a","b")===!0}catch{Re=!1}return Re}var Cr=(t=>(t[t.NONE=0]="NONE",t[t.COLOR=16384]="COLOR",t[t.STENCIL=1024]="STENCIL",t[t.DEPTH=256]="DEPTH",t[t.COLOR_DEPTH=16640]="COLOR_DEPTH",t[t.COLOR_STENCIL=17408]="COLOR_STENCIL",t[t.DEPTH_STENCIL=1280]="DEPTH_STENCIL",t[t.ALL=17664]="ALL",t))(Cr||{});class Vs{constructor(e){this.items=[],this._name=e}emit(e,n,o,r,i,s,a,l){const{name:c,items:u}=this;for(let d=0,f=u.length;d<f;d++)u[d][c](e,n,o,r,i,s,a,l);return this}add(e){return e[this._name]&&(this.remove(e),this.items.push(e)),this}remove(e){const n=this.items.indexOf(e);return n!==-1&&this.items.splice(n,1),this}contains(e){return this.items.indexOf(e)!==-1}removeAll(){return this.items.length=0,this}destroy(){this.removeAll(),this.items=null,this._name=null}get empty(){return this.items.length===0}get name(){return this._name}}const Xs=["init","destroy","contextChange","resolutionChange","resetState","renderEnd","renderStart","render","update","postrender","prerender"],Sr=class Tr extends bi{constructor(e){super(),this.runners=Object.create(null),this.renderPipes=Object.create(null),this._initOptions={},this._systemsHash=Object.create(null),this.type=e.type,this.name=e.name,this.config=e;const n=[...Xs,...this.config.runners??[]];this._addRunners(...n),this._unsafeEvalCheck()}async init(e={}){const n=e.skipExtensionImports===!0?!0:e.manageImports===!1;await $s(n),this._addSystems(this.config.systems),this._addPipes(this.config.renderPipes,this.config.renderPipeAdaptors);for(const o in this._systemsHash)e={...this._systemsHash[o].constructor.defaultOptions,...e};e={...Tr.defaultOptions,...e},this._roundPixels=e.roundPixels?1:0;for(let o=0;o<this.runners.init.items.length;o++)await this.runners.init.items[o].init(e);this._initOptions=e}render(e,n){let o=e;if(o instanceof g&&(o={container:o},n&&(We(It,"passing a second argument is deprecated, please use render options instead"),o.target=n.renderTexture)),o.target||(o.target=this.view.renderTarget),o.target===this.view.renderTarget&&(this._lastObjectRendered=o.container,o.clearColor??(o.clearColor=this.background.colorRgba),o.clear??(o.clear=this.background.clearBeforeRender)),o.clearColor){const r=Array.isArray(o.clearColor)&&o.clearColor.length===4;o.clearColor=r?o.clearColor:w.shared.setValue(o.clearColor).toArray()}o.transform||(o.container.updateLocalTransform(),o.transform=o.container.localTransform),o.container.enableRenderGroup(),this.runners.prerender.emit(o),this.runners.renderStart.emit(o),this.runners.render.emit(o),this.runners.renderEnd.emit(o),this.runners.postrender.emit(o)}resize(e,n,o){const r=this.view.resolution;this.view.resize(e,n,o),this.emit("resize",this.view.screen.width,this.view.screen.height,this.view.resolution),o!==void 0&&o!==r&&this.runners.resolutionChange.emit(o)}clear(e={}){const n=this;e.target||(e.target=n.renderTarget.renderTarget),e.clearColor||(e.clearColor=this.background.colorRgba),e.clear??(e.clear=Cr.ALL);const{clear:o,clearColor:r,target:i}=e;w.shared.setValue(r??this.background.colorRgba),n.renderTarget.clear(i,o,w.shared.toArray())}get resolution(){return this.view.resolution}set resolution(e){this.view.resolution=e,this.runners.resolutionChange.emit(e)}get width(){return this.view.texture.frame.width}get height(){return this.view.texture.frame.height}get canvas(){return this.view.canvas}get lastObjectRendered(){return this._lastObjectRendered}get renderingToScreen(){return this.renderTarget.renderingToScreen}get screen(){return this.view.screen}_addRunners(...e){e.forEach(n=>{this.runners[n]=new Vs(n)})}_addSystems(e){let n;for(n in e){const o=e[n];this._addSystem(o.value,o.name)}}_addSystem(e,n){const o=new e(this);if(this[n])throw new Error(`Whoops! The name "${n}" is already in use`);this[n]=o,this._systemsHash[n]=o;for(const r in this.runners)this.runners[r].add(o);return this}_addPipes(e,n){const o=n.reduce((r,i)=>(r[i.name]=i.value,r),{});e.forEach(r=>{const i=r.value,s=r.name,a=o[s];this.renderPipes[s]=new i(this,a?new a:null)})}destroy(e=!1){this.runners.destroy.items.reverse(),this.runners.destroy.emit(e),Object.values(this.runners).forEach(n=>{n.destroy()}),this._systemsHash=null,this.renderPipes=null}generateTexture(e){return this.textureGenerator.generateTexture(e)}get roundPixels(){return!!this._roundPixels}_unsafeEvalCheck(){if(!Ns())throw new Error("Current environment does not allow unsafe-eval, please use pixi.js/unsafe-eval module to enable support.")}resetState(){this.runners.resetState.emit()}};Sr.defaultOptions={resolution:1,failIfMajorPerformanceCaveat:!1,roundPixels:!1};let kr=Sr,dt;function js(t){return dt!==void 0||(dt=(()=>{const e={stencil:!0,failIfMajorPerformanceCaveat:t??kr.defaultOptions.failIfMajorPerformanceCaveat};try{if(!en.get().getWebGLRenderingContext())return!1;let o=en.get().createCanvas().getContext("webgl",e);const r=!!o?.getContextAttributes()?.stencil;if(o){const i=o.getExtension("WEBGL_lose_context");i&&i.loseContext()}return o=null,r}catch{return!1}})()),dt}let ft;async function Hs(t={}){return ft!==void 0||(ft=await(async()=>{const e=en.get().getNavigator().gpu;if(!e)return!1;try{return await(await e.requestAdapter(t)).requestDevice(),!0}catch{return!1}})()),ft}const Gn=["webgl","webgpu","canvas"];async function Gs(t){let e=[];t.preference?(e.push(t.preference),Gn.forEach(i=>{i!==t.preference&&e.push(i)})):e=Gn.slice();let n,o={};for(let i=0;i<e.length;i++){const s=e[i];if(s==="webgpu"&&await Hs()){const{WebGPURenderer:a}=await Vn(async()=>{const{WebGPURenderer:l}=await import("./WebGPURenderer-C2fkxRea.js");return{WebGPURenderer:l}},__vite__mapDeps([0,1,2,3,4,5,6,7]));n=a,o={...t,...t.webgpu};break}else if(s==="webgl"&&js(t.failIfMajorPerformanceCaveat??kr.defaultOptions.failIfMajorPerformanceCaveat)){const{WebGLRenderer:a}=await Vn(async()=>{const{WebGLRenderer:l}=await import("./WebGLRenderer-CF9Lg59y.js");return{WebGLRenderer:l}},__vite__mapDeps([8,1,2,3,4,5,6,7]));n=a,o={...t,...t.webgl};break}else if(s==="canvas")throw o={...t},new Error("CanvasRenderer is not yet implemented")}if(delete o.webgpu,delete o.webgl,!n)throw new Error("No available renderer for the current environment");const r=new n;return await r.init(o),r}const Ir="8.8.1";class Or{static init(){globalThis.__PIXI_APP_INIT__?.(this,Ir)}static destroy(){}}Or.extension=C.Application;class qs{constructor(e){this._renderer=e}init(){globalThis.__PIXI_RENDERER_INIT__?.(this._renderer,Ir)}destroy(){this._renderer=null}}qs.extension={type:[C.WebGLSystem,C.WebGPUSystem],name:"initHook",priority:-10};const Pr=class cn{constructor(...e){this.stage=new g,e[0]!==void 0&&We(It,"Application constructor options are deprecated, please use Application.init() instead.")}async init(e){e={...e},this.renderer=await Gs(e),cn._plugins.forEach(n=>{n.init.call(this,e)})}render(){this.renderer.render({container:this.stage})}get canvas(){return this.renderer.canvas}get view(){return We(It,"Application.view is deprecated, please use Application.canvas instead."),this.renderer.canvas}get screen(){return this.renderer.screen}destroy(e=!1,n=!1){const o=cn._plugins.slice(0);o.reverse(),o.forEach(r=>{r.destroy.call(this)}),this.stage.destroy(n),this.stage=null,this.renderer.destroy(e),this.renderer=null}};Pr._plugins=[];let _r=Pr;Bt.handleByList(C.Application,_r._plugins);Bt.add(Or);var Ws=`in vec2 aPosition;
out vec2 vTextureCoord;
...
`;class ia extends W{constructor(){const e=$.from({vertex:it,fragment:ra,name:"halfbrite-filter"});super({glProgram:e,resources:{}})}}const Dr=({basic:t,dimmed:e})=>({replaceLight:t,replaceDark:e}),Lr=t=>Dr(kn[t.color.hue][t.color.shade].main),zr=t=>new we({lightBeige:m.lightGrey,redShadow:m.shadow,pink:m.lightGrey,moss:m.lightGrey,midRed:m.midGrey,highlightBeige:m.lightGrey,...t&&Lr(t)}),sa=new we({midGrey:m.midRed,lightGrey:m.lightBeige,white:m.highlightBeige,metallicBlue:m.redShadow,pink:m.midRed,moss:m.midRed,replaceDark:m.midRed,replaceLight:m.lightBeige}),aa=t=>new we({replaceLight:t,replaceDark:pe(t)}),un=(t,e,n)=>n?new we(Dr(kn[t.color.hue][t.color.shade].edges[e])):new R(In(t.color).edges[e].original),oe=t=>new we(Lr(t)),Jn=new ia,me=Mo,Yn={x:.5,y:1},Zn=t=>typeof t!="string"&&Object.hasOwn(t,"animationId"),p=t=>{if(typeof t=="string")return p({textureId:t});{const{anchor:e,flipX:n,pivot:o,x:r,y:i,filter:s,times:a,label:l}=t;let c;if(Zn(t)?c=la(t):c=new Ae(ae().textures[t.textureId]),a!==void 0){const u={x:1,y:1,z:1,...a},d=new g({label:l??"timesXyz"});for(let{x:f}=u;f>=1;f--)for(let{y:h}=u;h>=1;h--)for(let b=1;b<=u.z;b++){const v=p({...t,times:void 0,label:`(${f},${h},${b})`}),M=T({x:f-1,y:h-1,z:b-1});v.x+=M.x,v.y+=+M.y,d.addChild(v)}return d}if(e===void 0&&o===void 0)if(Zn(t))c.anchor=Yn;else{const u=ae().data.frames[t.textureId].frame;u.pivot!==void 0?c.pivot=u.pivot:c.anchor=Yn}else e!==void 0&&(c.anchor=e),o!==void 0&&(c.pivot=o);return r!==void 0&&(c.x=r),i!==void 0&&(c.y=i),s!==void 0&&(c.filters=s),l!==void 0&&(c.label=l),c.eventMode="static",n===!0&&(c.scale.x=-1),c}};function la({animationId:t,reverse:e,playOnce:n,paused:o}){const r=ae().animations[t],s=(o?[r[0]]:r).map(l=>({texture:l,time:Do}));e&&s.reverse();const a=new Qe(s);return a.animationSpeed=Lo.animations[t].animationSpeed,a.play(),n!==void 0&&(a.loop=!1,a.onComplete=()=>{a.stop(),n==="and-destroy"&&(a.visible=!1)}),a}const ca=`#version 300 es
...
fn interlaceLines(co: vec3<f32>, coord: vec2<f32>) -> vec3<f32>
{
  ...
  return color;
}`,Ec=Object.defineProperty,$c=(t,e,n)=>e in t?Ec(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n,kt=(t,e,n)=>($c(t,typeof e!="symbol"?e+"":e,n),n);const ri=class ii extends W{constructor(e){e={...ii.DEFAULT_OPTIONS,...e};const n=ge.from({vertex:{source:Rt,entryPoint:"mainVertex"},fragment:{source:Uc,entryPoint:"mainFragment"}}),o=$.from({vertex:zt,fragment:Rc,name:"crt-filter"});super({gpuProgram:n,glProgram:o,resources:{crtUniforms:{uLine:{value:new Float32Array(4),type:"vec4<f32>"},uNoise:{value:new Float32Array(2),type:"vec2<f32>"},uVignette:{value:new Float32Array(3),type:"vec3<f32>"},uSeed:{value:e.seed,type:"f32"},uTime:{value:e.time,type:"f32"},uDimensions:{value:new Float32Array(2),type:"vec2<f32>"}}}}),kt(this,"uniforms"),kt(this,"seed"),kt(this,"time"),this.uniforms=this.resources.crtUniforms.uniforms,Object.assign(this,e)}apply(e,n,o,r){this.uniforms.uDimensions[0]=n.frame.width,this.uniforms.uDimensions[1]=n.frame.height,this.uniforms.uSeed=this.seed,this.uniforms.uTime=this.time,e.applyFilter(this,n,o,r)}get curvature(){return this.uniforms.uLine[0]}set curvature(e){this.uniforms.uLine[0]=e}get lineWidth(){return this.uniforms.uLine[1]}set lineWidth(e){this.uniforms.uLine[1]=e}get lineContrast(){return this.uniforms.uLine[2]}set lineContrast(e){this.uniforms.uLine[2]=e}get verticalLine(){return this.uniforms.uLine[3]>.5}set verticalLine(e){this.uniforms.uLine[3]=e?1:0}get noise(){return this.uniforms.uNoise[0]}set noise(e){this.uniforms.uNoise[0]=e}get noiseSize(){return this.uniforms.uNoise[1]}set noiseSize(e){this.uniforms.uNoise[1]=e}get vignetting(){return this.uniforms.uVignette[0]}set vignetting(e){this.uniforms.uVignette[0]=e}get vignettingAlpha(){return this.uniforms.uVignette[1]}set vignettingAlpha(e){this.uniforms.uVignette[1]=e}get vignettingBlur(){return this.uniforms.uVignette[2]}set vignettingBlur(e){this.uniforms.uVignette[2]=e}};kt(ri,"DEFAULT_OPTIONS",{curvature:1,lineWidth:1,lineContrast:.25,verticalLine:!1,noise:0,noiseSize:1,vignetting:.3,vignettingAlpha:1,vignettingBlur:.3,time:0,seed:0});let Nc=ri;var Vc=`
in vec2 vTextureCoord;
out vec4 finalColor;
