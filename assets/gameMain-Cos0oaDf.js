const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WebGPURenderer-BGjuKasF.js","assets/App-BZp2_j1p.js","assets/index-DYiTPRPp.js","assets/index-BgGgSFa3.css","assets/colorToUniform-KTpA7KSL.js","assets/SharedSystems-DkRkEZfL.js","assets/Graphics-CKZ2QAYP.js","assets/changeCharacterRoom-DEQWbjdJ.js","assets/WebGLRenderer-IvQJ2XMG.js"])))=>i.map(i=>d[i]);
import{b3 as Ls,b4 as nr,b5 as Es,am as $s,aq as Te,ar as H,ae as or,an as xe,Z as C,a2 as zt,a0 as Us,a3 as b,d as nt,v as At,aG as y,a6 as pn,ay as fe,_ as Ze,$ as Ns,V as Gs,b6 as Hs,b7 as Vs,b8 as Xs,ad as js,b9 as q,ba as Jn,K as A,bb as qs,bc as ae,bd as B,be as rr,s as Lt,M as w,o as G,c as _,bf as Ws,bg as Js,bh as Zs,g as M,w as at,bi as Ys,bj as Bn,bk as sr,bl as Ks,bm as Qs,bn as ei,bo as kt,i as le,t as ke,p as _n,l as $,bp as ti,bq as ni,br as oi,bs as ri,bt as si,bu as ii,I as ot,bv as It,e as ai,bw as lt,bx as ir,by as li,bz as ar,k as lr,bA as Et,bB as U,j as J,bC as cr,bD as An,bE as Zn,bF as ur,bG as ci,bH as ct,bI as Fn,bJ as Ie,bK as $t,bL as de,R as ut,H as ce,bM as pe,x as Oe,bN as mn,bO as ui,bP as di,bQ as hi,bR as fi,bS as Rn,A as Ue,bT as pi,bU as mi,bV as gi,bW as gn,bX as bi,bY as vi,bZ as ft,f as Mn,b_ as yi,b$ as xi,c0 as wi,m as Pe,C as dr,c1 as Yn,h as me,c2 as hr,r as fr,b as Si,a as pr,n as Ci,a$ as Ne,c3 as Yt,c4 as Ke,c5 as pt,c6 as Ut,c7 as Ti,c8 as ki,c9 as Xe,ca as Kn,cb as Nt,cc as Ii,cd as Oi,ce as Ge,cf as Pi,cg as Bi,ch as _i,ci as Ai,cj as Fi,ck as Ri,cl as Mi,cm as Di,cn as Qn,L as eo,co as mr,b2 as gr,E as br,F as zi,B as to,cp as Li,cq as Ei,cr as $i,a_ as we,cs as vr,ct as Ui,cu as Ni,cv as k,cw as Dn,S as He,cx as Gi,cy as Ft,cz as x,cA as bn,cB as yr,q as Hi,cC as rt,cD as Kt,J as no,cE as Vi,cF as Ot,cG as Xi,cH as ji,cI as oo,cJ as qi,cK as Wi,cL as Ji,cM as Gt,cN as Zi,cO as $e,cP as Yi,cQ as Ki,cR as Qi,aw as De,cS as ea,cT as ta,cU as na,cV as oa,cW as ra,cX as sa,cY as ia,cZ as aa,c_ as ro,c$ as la,N as so,d0 as ca}from"./App-BZp2_j1p.js";import{a as ua,f as vn,c as zn,m as Ht,b as Ln,d as xr,r as da,o as ha}from"./changeCharacterRoom-DEQWbjdJ.js";import{S as fa,G as W}from"./Graphics-CKZ2QAYP.js";import{g as wr,_ as io}from"./index-DYiTPRPp.js";var mt={},ao;function pa(){if(ao)return mt;ao=1;var t=Ls(),e=t.mark(s),n=nr(),o=n.wrapWithIterableIterator,r=n.ensureIterable;function s(){var a,l,c,u,d,h,f=arguments;return t.wrap(function(v){for(;;)switch(v.prev=v.next){case 0:for(a=f.length,l=new Array(a),c=0;c<a;c++)l[c]=f[c];u=0,d=l;case 2:if(!(u<d.length)){v.next=8;break}return h=d[u],v.delegateYield(r(h),"t0",5);case 5:u++,v.next=2;break;case 8:case"end":return v.stop()}},e)}mt.__concat=s;var i=o(s);return mt.concat=i,mt}var gt={},lo;function ma(){if(lo)return gt;lo=1;var t=nr(),e=t.iterableCurry,n=Es(),o=n.__firstOr,r=Symbol("none");function s(a){return o(a,r)===r}gt.__isEmpty=s;var i=e(s,{reduces:!0});return gt.isEmpty=i,gt}var Qt,co;function ga(){return co||(co=1,Qt=pa().concat),Qt}var ba=ga();const uo=wr(ba);var en,ho;function va(){return ho||(ho=1,en=ma().isEmpty),en}var ya=va();const xa=wr(ya),Sr=class yn extends $s{constructor(e){e={...yn.defaultOptions,...e},super(e),this.enabled=!0,this._state=fa.for2d(),this.blendMode=e.blendMode,this.padding=e.padding,typeof e.antialias=="boolean"?this.antialias=e.antialias?"on":"off":this.antialias=e.antialias,this.resolution=e.resolution,this.blendRequired=e.blendRequired,this.clipToViewport=e.clipToViewport,this.addResource("uTexture",0,1)}apply(e,n,o,r){e.applyFilter(this,n,o,r)}get blendMode(){return this._state.blendMode}set blendMode(e){this._state.blendMode=e}static from(e){const{gpu:n,gl:o,...r}=e;let s,i;return n&&(s=Te.from(n)),o&&(i=H.from(o)),new yn({gpuProgram:s,glProgram:i,...r})}};Sr.defaultOptions={blendMode:"normal",resolution:1,padding:0,antialias:"off",blendRequired:!1,clipToViewport:!0};let Y=Sr;var wa=`
...
fn mainFragment(
  @location(0) uv: vec2<f32>
   ...
   return out;
	...
	`;class Cr extends F{constructor(){super({gl:{functions:`
                ${En}
                ...
                `}})}}Cr.extension={name:"color",type:C.BlendMode};class Tr extends F{constructor(){super({gl:{functions:`
            ...
            `}})}}Tr.extension={name:"color-burn",type:C.BlendMode};class kr extends F{constructor(){super({gl:{functions:`
                ...
                `}})}}kr.extension={name:"color-dodge",type:C.BlendMode};class Ir extends F{constructor(){super({gl:{functions:`
                ...
                `}})}}Ir.extension={name:"darken",type:C.BlendMode};class Or extends F{constructor(){super({gl:{functions:`
            ...
            `}})}}Or.extension={name:"difference",type:C.BlendMode};class Pr extends F{constructor(){super({gl:{functions:`
            ...
            `}})}}Pr.extension={name:"divide",type:C.BlendMode};class Br extends F{constructor(){super({gl:{functions:`
            ...
            `}})}}Br.extension={name:"exclusion",type:C.BlendMode};class _r extends F{constructor(){super({gl:{functions:`
            ...
            `},gpu:{functions:`
                ...
                `}})}}_r.extension={name:"hard-light",type:C.BlendMode};class Ar extends F{constructor(){super({gl:{functions:`
            ...
            `}})}}Ar.extension={name:"hard-mix",type:C.BlendMode};class Fr extends F{constructor(){super({gl:{functions:`
            ...
            `}})}}Fr.extension={name:"lighten",type:C.BlendMode};class Rr extends F{constructor(){super({gl:{functions:`
                ...
                `}})}}Rr.extension={name:"linear-burn",type:C.BlendMode};class Mr extends F{constructor(){super({gl:{functions:`
            ...
            `}})}}Mr.extension={name:"linear-dodge",type:C.BlendMode};class Dr extends F{constructor(){super({gl:{functions:`
                float linearBurn(float base, float blend) {
                    return max(0.0, base + blend - 1.0);
                }
            ...
            `}})}}Dr.extension={name:"linear-light",type:C.BlendMode};class zr extends F{constructor(){super({gl:{functions:`
                ${En}
            ...
            `}})}}zr.extension={name:"luminosity",type:C.BlendMode};class Lr extends F{constructor(){super({gl:{functions:`
            ...
            `}})}}Lr.extension={name:"negation",type:C.BlendMode};class Er extends F{constructor(){super({gl:{functions:`
                ...
                `}})}}Er.extension={name:"overlay",type:C.BlendMode};class $r extends F{constructor(){super({gl:{functions:`
            ...
            `,main:`
                ...
                `}})}}$r.extension={name:"pin-light",type:C.BlendMode};class Ur extends F{constructor(){super({gl:{functions:`
                ${En}
            ...
            `}})}}Ur.extension={name:"saturation",type:C.BlendMode};class Nr extends F{constructor(){super({gl:{functions:`
                ...
                `}})}}Nr.extension={name:"soft-light",type:C.BlendMode};class Gr extends F{constructor(){super({gl:{functions:`
                ...
                `}})}}Gr.extension={name:"subtract",type:C.BlendMode};class Hr extends F{constructor(){super({gl:{functions:`
                float colorBurn(float base, float blend)
                {
                    return max((1.0-((1.0-base)/blend)),0.0);
                }
            ...
            `},gpu:{functions:`
                ...
                `}})}}Hr.extension={name:"vivid-light",type:C.BlendMode};const xn=[];zt.handleByNamedList(C.Environment,xn);async function Ta(t){if(!t)for(let e=0;e<xn.length;e++){const n=xn[e];if(n.value.test()){await n.value.load();return}}}let je;function ka(){if(typeof je=="boolean")return je;try{je=new Function("param1","param2","param3","return param1[param2] === param3;")({a:"b"},"a","b")===!0}catch{je=!1}return je}var Vr=(t=>(t[t.NONE=0]="NONE",t[t.COLOR=16384]="COLOR",t[t.STENCIL=1024]="STENCIL",t[t.DEPTH=256]="DEPTH",t[t.COLOR_DEPTH=16640]="COLOR_DEPTH",t[t.COLOR_STENCIL=17408]="COLOR_STENCIL",t[t.DEPTH_STENCIL=1280]="DEPTH_STENCIL",t[t.ALL=17664]="ALL",t))(Vr||{});class Ia{constructor(e){this.items=[],this._name=e}emit(e,n,o,r,s,i,a,l){const{name:c,items:u}=this;for(let d=0,h=u.length;d<h;d++)u[d][c](e,n,o,r,s,i,a,l);return this}add(e){return e[this._name]&&(this.remove(e),this.items.push(e)),this}remove(e){const n=this.items.indexOf(e);return n!==-1&&this.items.splice(n,1),this}contains(e){return this.items.indexOf(e)!==-1}removeAll(){return this.items.length=0,this}destroy(){this.removeAll(),this.items=null,this._name=null}get empty(){return this.items.length===0}get name(){return this._name}}const Oa=["init","destroy","contextChange","resolutionChange","resetState","renderEnd","renderStart","render","update","postrender","prerender"],Xr=class jr extends Us{constructor(e){super(),this.runners=Object.create(null),this.renderPipes=Object.create(null),this._initOptions={},this._systemsHash=Object.create(null),this.type=e.type,this.name=e.name,this.config=e;const n=[...Oa,...this.config.runners??[]];this._addRunners(...n),this._unsafeEvalCheck()}async init(e={}){const n=e.skipExtensionImports===!0?!0:e.manageImports===!1;await Ta(n),this._addSystems(this.config.systems),this._addPipes(this.config.renderPipes,this.config.renderPipeAdaptors);for(const o in this._systemsHash)e={...this._systemsHash[o].constructor.defaultOptions,...e};e={...jr.defaultOptions,...e},this._roundPixels=e.roundPixels?1:0;for(let o=0;o<this.runners.init.items.length;o++)await this.runners.init.items[o].init(e);this._initOptions=e}render(e,n){let o=e;if(o instanceof b&&(o={container:o},n&&(nt(At,"passing a second argument is deprecated, please use render options instead"),o.target=n.renderTexture)),o.target||(o.target=this.view.renderTarget),o.target===this.view.renderTarget&&(this._lastObjectRendered=o.container,o.clearColor??(o.clearColor=this.background.colorRgba),o.clear??(o.clear=this.background.clearBeforeRender)),o.clearColor){const r=Array.isArray(o.clearColor)&&o.clearColor.length===4;o.clearColor=r?o.clearColor:y.shared.setValue(o.clearColor).toArray()}o.transform||(o.container.updateLocalTransform(),o.transform=o.container.localTransform),o.container.enableRenderGroup(),this.runners.prerender.emit(o),this.runners.renderStart.emit(o),this.runners.render.emit(o),this.runners.renderEnd.emit(o),this.runners.postrender.emit(o)}resize(e,n,o){const r=this.view.resolution;this.view.resize(e,n,o),this.emit("resize",this.view.screen.width,this.view.screen.height,this.view.resolution),o!==void 0&&o!==r&&this.runners.resolutionChange.emit(o)}clear(e={}){const n=this;e.target||(e.target=n.renderTarget.renderTarget),e.clearColor||(e.clearColor=this.background.colorRgba),e.clear??(e.clear=Vr.ALL);const{clear:o,clearColor:r,target:s}=e;y.shared.setValue(r??this.background.colorRgba),n.renderTarget.clear(s,o,y.shared.toArray())}get resolution(){return this.view.resolution}set resolution(e){this.view.resolution=e,this.runners.resolutionChange.emit(e)}get width(){return this.view.texture.frame.width}get height(){return this.view.texture.frame.height}get canvas(){return this.view.canvas}get lastObjectRendered(){return this._lastObjectRendered}get renderingToScreen(){return this.renderTarget.renderingToScreen}get screen(){return this.view.screen}_addRunners(...e){e.forEach(n=>{this.runners[n]=new Ia(n)})}_addSystems(e){let n;for(n in e){const o=e[n];this._addSystem(o.value,o.name)}}_addSystem(e,n){const o=new e(this);if(this[n])throw new Error(`Whoops! The name "${n}" is already in use`);this[n]=o,this._systemsHash[n]=o;for(const r in this.runners)this.runners[r].add(o);return this}_addPipes(e,n){const o=n.reduce((r,s)=>(r[s.name]=s.value,r),{});e.forEach(r=>{const s=r.value,i=r.name,a=o[i];this.renderPipes[i]=new s(this,a?new a:null)})}destroy(e=!1){this.runners.destroy.items.reverse(),this.runners.destroy.emit(e),Object.values(this.runners).forEach(n=>{n.destroy()}),this._systemsHash=null,this.renderPipes=null}generateTexture(e){return this.textureGenerator.generateTexture(e)}get roundPixels(){return!!this._roundPixels}_unsafeEvalCheck(){if(!ka())throw new Error("Current environment does not allow unsafe-eval, please use pixi.js/unsafe-eval module to enable support.")}resetState(){this.runners.resetState.emit()}};Xr.defaultOptions={resolution:1,failIfMajorPerformanceCaveat:!1,roundPixels:!1};let qr=Xr,bt;function Pa(t){return bt!==void 0||(bt=(()=>{const e={stencil:!0,failIfMajorPerformanceCaveat:t??qr.defaultOptions.failIfMajorPerformanceCaveat};try{if(!pn.get().getWebGLRenderingContext())return!1;let o=pn.get().createCanvas().getContext("webgl",e);const r=!!o?.getContextAttributes()?.stencil;if(o){const s=o.getExtension("WEBGL_lose_context");s&&s.loseContext()}return o=null,r}catch{return!1}})()),bt}let vt;async function Ba(t={}){return vt!==void 0||(vt=await(async()=>{const e=pn.get().getNavigator().gpu;if(!e)return!1;try{return await(await e.requestAdapter(t)).requestDevice(),!0}catch{return!1}})()),vt}const po=["webgl","webgpu","canvas"];async function _a(t){let e=[];t.preference?(e.push(t.preference),po.forEach(s=>{s!==t.preference&&e.push(s)})):e=po.slice();let n,o={};for(let s=0;s<e.length;s++){const i=e[s];if(i==="webgpu"&&await Ba()){const{WebGPURenderer:a}=await io(async()=>{const{WebGPURenderer:l}=await import("./WebGPURenderer-BGjuKasF.js");return{WebGPURenderer:l}},__vite__mapDeps([0,1,2,3,4,5,6,7]));n=a,o={...t,...t.webgpu};break}else if(i==="webgl"&&Pa(t.failIfMajorPerformanceCaveat??qr.defaultOptions.failIfMajorPerformanceCaveat)){const{WebGLRenderer:a}=await io(async()=>{const{WebGLRenderer:l}=await import("./WebGLRenderer-IvQJ2XMG.js");return{WebGLRenderer:l}},__vite__mapDeps([8,1,2,3,4,5,6,7]));n=a,o={...t,...t.webgl};break}else if(i==="canvas")throw o={...t},new Error("CanvasRenderer is not yet implemented")}if(delete o.webgpu,delete o.webgl,!n)throw new Error("No available renderer for the current environment");const r=new n;return await r.init(o),r}const Wr="8.8.1";class Jr{static init(){globalThis.__PIXI_APP_INIT__?.(this,Wr)}static destroy(){}}Jr.extension=C.Application;class Aa{constructor(e){this._renderer=e}init(){globalThis.__PIXI_RENDERER_INIT__?.(this._renderer,Wr)}destroy(){this._renderer=null}}Aa.extension={type:[C.WebGLSystem,C.WebGPUSystem],name:"initHook",priority:-10};const Zr=class wn{constructor(...e){this.stage=new b,e[0]!==void 0&&nt(At,"Application constructor options are deprecated, please use Application.init() instead.")}async init(e){e={...e},this.renderer=await _a(e),wn._plugins.forEach(n=>{n.init.call(this,e)})}render(){this.renderer.render({container:this.stage})}get canvas(){return this.renderer.canvas}get view(){return nt(At,"Application.view is deprecated, please use Application.canvas instead."),this.renderer.canvas}get screen(){return this.renderer.screen}destroy(e=!1,n=!1){const o=wn._plugins.slice(0);o.reverse(),o.forEach(r=>{r.destroy.call(this)}),this.stage.destroy(n),this.stage=null,this.renderer.destroy(e),this.renderer=null}};Zr._plugins=[];let Yr=Zr;zt.handleByList(C.Application,Yr._plugins);zt.add(Jr);var Fa=`in vec2 aPosition;
out vec2 vTextureCoord;
...
`;class Ga extends Y{constructor(){const e=H.from({vertex:dt,fragment:Na,name:"halfbrite-filter"});super({glProgram:e,resources:{}})}}const ns=({basic:t,dimmed:e})=>({replaceLight:t,replaceDark:e}),os=t=>ns(Nn[t.color.hue][t.color.shade].main),rs=t=>new be({lightBeige:g.lightGrey,redShadow:g.shadow,pink:g.lightGrey,moss:g.lightGrey,midRed:g.midGrey,highlightBeige:g.lightGrey,...t&&os(t)}),Ha=new be({midGrey:g.midRed,lightGrey:g.lightBeige,white:g.highlightBeige,metallicBlue:g.redShadow,pink:g.midRed,moss:g.midRed,replaceDark:g.midRed,replaceLight:g.lightBeige}),Va=t=>new be({replaceLight:t,replaceDark:Se(t)}),Sn=(t,e,n)=>n?new be(ns(Nn[t.color.hue][t.color.shade].edges[e])):new N(Gn(t.color).edges[e].original),ge=t=>new be(os(t)),go=new Ga,ne=qs,Xa=new be(Ea),bo={x:.5,y:1},vo=t=>typeof t!="string"&&Object.hasOwn(t,"animationId"),Cn=t=>{if(typeof t=="string")return Cn({textureId:t});{const{anchor:e,flipX:n,pivot:o,x:r,y:s,filter:i,times:a,label:l}=t;let c;if(vo(t)?c=ja(t):c=new fe(ae().textures[t.textureId]),t.hasOwnProperty("times")){const u={x:1,y:1,z:1,...a},d=new b({label:l??"timesXyz"});for(let{x:h}=u;h>=1;h--)for(let{y:f}=u;f>=1;f--)for(let p=1;p<=u.z;p++){const v={...t,label:`(${h},${f},${p})`};delete v.times;const T=Cn(v),I=B({x:h-1,y:f-1,z:p-1});T.x+=I.x,T.y+=+I.y,d.addChild(T)}return d}if(e===void 0&&o===void 0)if(vo(t))c.anchor=bo;else{const u=ae().data.frames[t.textureId].frame;u.pivot!==void 0?c.pivot=u.pivot:c.anchor=bo}else e!==void 0&&(c.anchor=e),o!==void 0&&(c.pivot=o);return r!==void 0&&(c.x=r),s!==void 0&&(c.y=s),i!==void 0&&(c.filters=i),l!==void 0&&(c.label=l),c.eventMode="static",n===!0&&(c.scale.x=-1),c}},m=Cn;function ja({animationId:t,reverse:e,playOnce:n,paused:o}){const r=ae().animations[t],i=(o?[r[0]]:r).map(l=>({texture:l,time:rr}));e&&i.reverse();const a=new st(i);return a.animationSpeed=Lt.animations[t].animationSpeed,a.play(),n!==void 0&&(a.loop=!1,a.onComplete=()=>{a.stop(),n==="and-destroy"&&(a.visible=!1)}),a}const qa=`#version 300 es
