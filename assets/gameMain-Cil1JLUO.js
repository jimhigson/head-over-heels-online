const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WebGPURenderer-BiUwi-Wq.js","assets/App-Bf9f4LK0.js","assets/index-BLITf8aZ.js","assets/index-DozW7tHb.css","assets/colorToUniform-KTpA7KSL.js","assets/SharedSystems-ByCNdmff.js","assets/Graphics-C7WHdF1o.js","assets/swopCharacters-nypvcXEs.js","assets/WebGLRenderer-ANrzkAAz.js"])))=>i.map(i=>d[i]);
import{aJ as No,H as Vo,A as jo,a9 as de,aa as E,n as sr,F as le,E as x,f as vt,e as Ho,C as g,d as Ne,v as ft,ap as y,D as Nt,ah as Te,T as Le,U as Xo,V as Go,aK as qo,aL as Wo,aM as Yo,m as Jo,aN as Zo,aO as Y,aP as Qo,aQ as oe,aR as ar,a4 as lr,Z as C,a2 as k,L as _,aS as Ko,aT as ei,W as B,aU as Oe,aV as ti,aW as cr,aX as yt,aY as ni,aZ as at,N as U,a_ as ri,a0 as z,a$ as oi,b0 as ii,a5 as ur,X as xt,b1 as si,b2 as Xe,b3 as dr,b4 as fe,b5 as wt,p as Ge,$ as qe,a6 as Ie,Q as Vt,b6 as dn,a1 as te,b7 as ai,b8 as li,b9 as ci,ba as ui,I as fr,bb as Me,bc as di,bd as en,be as fi,bf as hi,O as hr,bg as pi,bh as mi,bi,bj as ht,bk as lt,bl as gi,bm as vi,bn as yi,a as Ve,bo as pt,bp as xi,bq as Re,br as wi,bs as pr,bt as mr,bu as Ci,af as ye,bv as It,bw as _t,a7 as fn,bx as Ti}from"./App-Bf9f4LK0.js";import{l as jt,h as mt,j as hn,g as L,p as T,k as he,m as tn,n as Si,q as ki,r as Ht,t as bt,u as ct,c as nn,v as H,i as X,w as br,x as gr,y as ce,z as Ct,A as Oi,B as Ii,C as _i,D as Pi,E as Xt,F as Bi,G as Je,H as Ai,I as Fi,J as Di,a as pe,K as vr,L as yr,M as pn,N as xr,f as zi,O as wr,P as Cr,Q as Li,b as Q,s as ue,R as Pt,S as Ze,T as Mi,U as Ri,V as Pe,W as mn,X as Ui,Y as rn,Z as Ei,_ as $i,$ as Ni,a0 as Vi,a1 as ji,a2 as bn,a3 as Tr,e as Sr,o as kr,a4 as Hi,a5 as gn,a6 as Bt,a7 as w,a8 as Xi,a9 as Gi,aa as qi,ab as vn,ac as Tt,ad as Wi}from"./swopCharacters-nypvcXEs.js";import{S as Yi,G as j}from"./Graphics-C7WHdF1o.js";import{g as Ji,_ as yn}from"./index-BLITf8aZ.js";var Qe={},xn;function Zi(){if(xn)return Qe;xn=1;var t=No(),e=t.mark(i),n=Vo(),r=n.wrapWithIterableIterator,o=n.ensureIterable;function i(){var a,l,c,u,d,f,p=arguments;return t.wrap(function(v){for(;;)switch(v.prev=v.next){case 0:for(a=p.length,l=new Array(a),c=0;c<a;c++)l[c]=p[c];u=0,d=l;case 2:if(!(u<d.length)){v.next=8;break}return f=d[u],v.delegateYield(o(f),"t0",5);case 5:u++,v.next=2;break;case 8:case"end":return v.stop()}},e)}Qe.__concat=i;var s=r(i);return Qe.concat=s,Qe}var At,wn;function Qi(){return wn||(wn=1,At=Zi().concat),At}var Ki=Qi();const Gt=Ji(Ki),Or=class qt extends jo{constructor(e){e={...qt.defaultOptions,...e},super(e),this.enabled=!0,this._state=Yi.for2d(),this.blendMode=e.blendMode,this.padding=e.padding,typeof e.antialias=="boolean"?this.antialias=e.antialias?"on":"off":this.antialias=e.antialias,this.resolution=e.resolution,this.blendRequired=e.blendRequired,this.clipToViewport=e.clipToViewport,this.addResource("uTexture",0,1)}apply(e,n,r,o){e.applyFilter(this,n,r,o)}get blendMode(){return this._state.blendMode}set blendMode(e){this._state.blendMode=e}static from(e){const{gpu:n,gl:r,...o}=e;let i,s;return n&&(i=de.from(n)),r&&(s=E.from(r)),new qt({gpuProgram:i,glProgram:s,...o})}};Or.defaultOptions={blendMode:"normal",resolution:1,padding:0,antialias:"off",blendRequired:!1,clipToViewport:!0};let G=Or;var es=`
...
fn mainFragment(
  @location(0) uv: vec2<f32>
   ...
   return out;
}`;class S extends G{constructor(e){const n=e.gpu,r=Cn({source:ns,...n}),o=de.from({vertex:{source:r,entryPoint:"mainVertex"},fragment:{source:r,entryPoint:"mainFragment"}}),i=e.gl,s=Cn({source:es,...i}),a=E.from({vertex:ts,fragment:s}),l=new sr({uBlend:{value:1,type:"f32"}});super({gpuProgram:o,glProgram:a,blendRequired:!0,resources:{blendUniforms:l,uBackTexture:le.EMPTY}})}}function Cn(t){const{source:e,functions:n,main:r}=t;return e.replace("{FUNCTIONS}",n).replace("{MAIN}",r)}const on=`
	...
	`;class Ir extends S{constructor(){super({gl:{functions:`
            ...
            `},gpu:{functions:`
                ...
                `}})}}qr.extension={name:"vivid-light",type:x.BlendMode};const Wt=[];vt.handleByNamedList(x.Environment,Wt);async function rs(t){if(!t)for(let e=0;e<Wt.length;e++){const n=Wt[e];if(n.value.test()){await n.value.load();return}}}let Be;function os(){if(typeof Be=="boolean")return Be;try{Be=new Function("param1","param2","param3","return param1[param2] === param3;")({a:"b"},"a","b")===!0}catch{Be=!1}return Be}var Wr=(t=>(t[t.NONE=0]="NONE",t[t.COLOR=16384]="COLOR",t[t.STENCIL=1024]="STENCIL",t[t.DEPTH=256]="DEPTH",t[t.COLOR_DEPTH=16640]="COLOR_DEPTH",t[t.COLOR_STENCIL=17408]="COLOR_STENCIL",t[t.DEPTH_STENCIL=1280]="DEPTH_STENCIL",t[t.ALL=17664]="ALL",t))(Wr||{});class is{constructor(e){this.items=[],this._name=e}emit(e,n,r,o,i,s,a,l){const{name:c,items:u}=this;for(let d=0,f=u.length;d<f;d++)u[d][c](e,n,r,o,i,s,a,l);return this}add(e){return e[this._name]&&(this.remove(e),this.items.push(e)),this}remove(e){const n=this.items.indexOf(e);return n!==-1&&this.items.splice(n,1),this}contains(e){return this.items.indexOf(e)!==-1}removeAll(){return this.items.length=0,this}destroy(){this.removeAll(),this.items=null,this._name=null}get empty(){return this.items.length===0}get name(){return this._name}}const ss=["init","destroy","contextChange","resolutionChange","resetState","renderEnd","renderStart","render","update","postrender","prerender"],Yr=class Jr extends Ho{constructor(e){super(),this.runners=Object.create(null),this.renderPipes=Object.create(null),this._initOptions={},this._systemsHash=Object.create(null),this.type=e.type,this.name=e.name,this.config=e;const n=[...ss,...this.config.runners??[]];this._addRunners(...n),this._unsafeEvalCheck()}async init(e={}){const n=e.skipExtensionImports===!0?!0:e.manageImports===!1;await rs(n),this._addSystems(this.config.systems),this._addPipes(this.config.renderPipes,this.config.renderPipeAdaptors);for(const r in this._systemsHash)e={...this._systemsHash[r].constructor.defaultOptions,...e};e={...Jr.defaultOptions,...e},this._roundPixels=e.roundPixels?1:0;for(let r=0;r<this.runners.init.items.length;r++)await this.runners.init.items[r].init(e);this._initOptions=e}render(e,n){let r=e;if(r instanceof g&&(r={container:r},n&&(Ne(ft,"passing a second argument is deprecated, please use render options instead"),r.target=n.renderTexture)),r.target||(r.target=this.view.renderTarget),r.target===this.view.renderTarget&&(this._lastObjectRendered=r.container,r.clearColor??(r.clearColor=this.background.colorRgba),r.clear??(r.clear=this.background.clearBeforeRender)),r.clearColor){const o=Array.isArray(r.clearColor)&&r.clearColor.length===4;r.clearColor=o?r.clearColor:y.shared.setValue(r.clearColor).toArray()}r.transform||(r.container.updateLocalTransform(),r.transform=r.container.localTransform),r.container.enableRenderGroup(),this.runners.prerender.emit(r),this.runners.renderStart.emit(r),this.runners.render.emit(r),this.runners.renderEnd.emit(r),this.runners.postrender.emit(r)}resize(e,n,r){const o=this.view.resolution;this.view.resize(e,n,r),this.emit("resize",this.view.screen.width,this.view.screen.height,this.view.resolution),r!==void 0&&r!==o&&this.runners.resolutionChange.emit(r)}clear(e={}){const n=this;e.target||(e.target=n.renderTarget.renderTarget),e.clearColor||(e.clearColor=this.background.colorRgba),e.clear??(e.clear=Wr.ALL);const{clear:r,clearColor:o,target:i}=e;y.shared.setValue(o??this.background.colorRgba),n.renderTarget.clear(i,r,y.shared.toArray())}get resolution(){return this.view.resolution}set resolution(e){this.view.resolution=e,this.runners.resolutionChange.emit(e)}get width(){return this.view.texture.frame.width}get height(){return this.view.texture.frame.height}get canvas(){return this.view.canvas}get lastObjectRendered(){return this._lastObjectRendered}get renderingToScreen(){return this.renderTarget.renderingToScreen}get screen(){return this.view.screen}_addRunners(...e){e.forEach(n=>{this.runners[n]=new is(n)})}_addSystems(e){let n;for(n in e){const r=e[n];this._addSystem(r.value,r.name)}}_addSystem(e,n){const r=new e(this);if(this[n])throw new Error(`Whoops! The name "${n}" is already in use`);this[n]=r,this._systemsHash[n]=r;for(const o in this.runners)this.runners[o].add(r);return this}_addPipes(e,n){const r=n.reduce((o,i)=>(o[i.name]=i.value,o),{});e.forEach(o=>{const i=o.value,s=o.name,a=r[s];this.renderPipes[s]=new i(this,a?new a:null)})}destroy(e=!1){this.runners.destroy.items.reverse(),this.runners.destroy.emit(e),Object.values(this.runners).forEach(n=>{n.destroy()}),this._systemsHash=null,this.renderPipes=null}generateTexture(e){return this.textureGenerator.generateTexture(e)}get roundPixels(){return!!this._roundPixels}_unsafeEvalCheck(){if(!os())throw new Error("Current environment does not allow unsafe-eval, please use pixi.js/unsafe-eval module to enable support.")}resetState(){this.runners.resetState.emit()}};Yr.defaultOptions={resolution:1,failIfMajorPerformanceCaveat:!1,roundPixels:!1};let Zr=Yr,Ke;function as(t){return Ke!==void 0||(Ke=(()=>{const e={stencil:!0,failIfMajorPerformanceCaveat:t??Zr.defaultOptions.failIfMajorPerformanceCaveat};try{if(!Nt.get().getWebGLRenderingContext())return!1;let r=Nt.get().createCanvas().getContext("webgl",e);const o=!!r?.getContextAttributes()?.stencil;if(r){const i=r.getExtension("WEBGL_lose_context");i&&i.loseContext()}return r=null,o}catch{return!1}})()),Ke}let et;async function ls(t={}){return et!==void 0||(et=await(async()=>{const e=Nt.get().getNavigator().gpu;if(!e)return!1;try{return await(await e.requestAdapter(t)).requestDevice(),!0}catch{return!1}})()),et}const Tn=["webgl","webgpu","canvas"];async function cs(t){let e=[];t.preference?(e.push(t.preference),Tn.forEach(i=>{i!==t.preference&&e.push(i)})):e=Tn.slice();let n,r={};for(let i=0;i<e.length;i++){const s=e[i];if(s==="webgpu"&&await ls()){const{WebGPURenderer:a}=await yn(async()=>{const{WebGPURenderer:l}=await import("./WebGPURenderer-BiUwi-Wq.js");return{WebGPURenderer:l}},__vite__mapDeps([0,1,2,3,4,5,6,7]));n=a,r={...t,...t.webgpu};break}else if(s==="webgl"&&as(t.failIfMajorPerformanceCaveat??Zr.defaultOptions.failIfMajorPerformanceCaveat)){const{WebGLRenderer:a}=await yn(async()=>{const{WebGLRenderer:l}=await import("./WebGLRenderer-ANrzkAAz.js");return{WebGLRenderer:l}},__vite__mapDeps([8,1,2,3,4,5,6,7]));n=a,r={...t,...t.webgl};break}else if(s==="canvas")throw r={...t},new Error("CanvasRenderer is not yet implemented")}if(delete r.webgpu,delete r.webgl,!n)throw new Error("No available renderer for the current environment");const o=new n;return await o.init(r),o}const Qr="8.8.1";class Kr{static init(){globalThis.__PIXI_APP_INIT__?.(this,Qr)}static destroy(){}}Kr.extension=x.Application;class us{constructor(e){this._renderer=e}init(){globalThis.__PIXI_RENDERER_INIT__?.(this._renderer,Qr)}destroy(){this._renderer=null}}us.extension={type:[x.WebGLSystem,x.WebGPUSystem],name:"initHook",priority:-10};const eo=class Yt{constructor(...e){this.stage=new g,e[0]!==void 0&&Ne(ft,"Application constructor options are deprecated, please use Application.init() instead.")}async init(e){e={...e},this.renderer=await cs(e),Yt._plugins.forEach(n=>{n.init.call(this,e)})}render(){this.renderer.render({container:this.stage})}get canvas(){return this.renderer.canvas}get view(){return Ne(ft,"Application.view is deprecated, please use Application.canvas instead."),this.renderer.canvas}get screen(){return this.renderer.screen}destroy(e=!1,n=!1){const r=Yt._plugins.slice(0);r.reverse(),r.forEach(o=>{o.destroy.call(this)}),this.stage.destroy(n),this.stage=null,this.renderer.destroy(e),this.renderer=null}};eo._plugins=[];let to=eo;vt.handleByList(x.Application,to._plugins);vt.add(Kr);var ds=`in vec2 aPosition;
out vec2 vTextureCoord;
...
`;class _e extends G{constructor(e){const n=Object.keys(e).length,r=E.from({vertex:Ye,fragment:xs.replace(/\$\{SWOP_COUNT\}/g,n.toFixed(0)),name:"palette-swop-filter"});super({glProgram:r,resources:{colorReplaceUniforms:{uOriginal:{value:new Float32Array(3*n),type:"vec3<f32>",size:n},uReplacement:{value:new Float32Array(3*n),type:"vec3<f32>",size:n}}}});const o=this.resources.colorReplaceUniforms.uniforms;Object.entries(e).forEach(([i,s],a)=>{b[i].toArray().forEach((l,c)=>{o.uOriginal[a*3+c]=l}),s.toArray().forEach((l,c)=>{o.uReplacement[a*3+c]=l})})}}const ws=`precision mediump float;
in vec2 vTextureCoord;
out vec4 finalColor;
...
`;class Ts extends G{constructor(){const e=E.from({vertex:Ye,fragment:Cs,name:"halfbrite-filter"});super({glProgram:e,resources:{}})}}const so=({basic:t,dimmed:e})=>({replaceLight:t,replaceDark:e}),ao=t=>so(ln[t.color.hue][t.color.shade].main),lo=t=>new _e({lightBeige:b.lightGrey,redShadow:b.shadow,pink:b.lightGrey,moss:b.lightGrey,midRed:b.midGrey,highlightBeige:b.lightGrey,...t&&ao(t)}),Ss=new _e({midGrey:b.midRed,lightGrey:b.lightBeige,white:b.highlightBeige,metallicBlue:b.redShadow,pink:b.midRed,moss:b.midRed,replaceDark:b.midRed,replaceLight:b.lightBeige}),ks=t=>new _e({replaceLight:t,replaceDark:We(t)}),Jt=(t,e,n)=>n?new _e(so(ln[t.color.hue][t.color.shade].edges[e])):new J(cn(t.color).edges[e].original),ee=t=>new _e(ao(t)),Os=new Ts,Se=Qo,kn={x:.5,y:1},On=t=>typeof t!="string"&&Object.hasOwn(t,"animationId"),h=t=>{if(typeof t=="string")return h({textureId:t});{const{anchor:e,flipX:n,pivot:r,x:o,y:i,filter:s,times:a,label:l}=t;let c;if(On(t)?c=Is(t):c=new Te(oe().textures[t.textureId]),a!==void 0){const u={x:1,y:1,z:1,...a},d=new g({label:l??"timesXyz"});for(let{x:f}=u;f>=1;f--)for(let{y:p}=u;p>=1;p--)for(let m=1;m<=u.z;m++){const v=h({...t,times:void 0,label:`(${f},${p},${m})`}),A=T({x:f-1,y:p-1,z:m-1});v.x+=A.x,v.y+=+A.y,d.addChild(v)}return d}if(e===void 0&&r===void 0)if(On(t))c.anchor=kn;else{const u=oe().data.frames[t.textureId].frame;u.pivot!==void 0?c.pivot=u.pivot:c.anchor=kn}else e!==void 0&&(c.anchor=e),r!==void 0&&(c.pivot=r);return o!==void 0&&(c.x=o),i!==void 0&&(c.y=i),s!==void 0&&(c.filters=s),l!==void 0&&(c.label=l),c.eventMode="static",n===!0&&(c.scale.x=-1),c}};function Is({animationId:t,reverse:e,playOnce:n}){const o=oe().animations[t].map(s=>({texture:s,time:ar}));e&&o.reverse();const i=new je(o);return i.animationSpeed=lr.animations[t].animationSpeed,i.play(),n!==void 0&&(i.loop=!1,i.onComplete=()=>{i.stop(),n==="and-destroy"&&(i.visible=!1)}),i}const _s=`#version 300 es
...
`;class Ce extends G{constructor({outlineColor:e,upscale:n,lowRes:r}){const o=E.from({vertex:Ye,fragment:_s,name:"outline-filter"});super({glProgram:o,padding:n,resources:{colorReplaceUniforms:{uOutline:{value:new Float32Array(3),type:"vec3<f32>"},uOutlineWidth:{value:new Float32Array(1),type:"f32"}}}});const i=this.resources.colorReplaceUniforms.uniforms,[s,a,l]=e.toArray();i.uOutline[0]=s,i.uOutline[1]=a,i.uOutline[2]=l,i.uOutlineWidth[0]=n,r&&(this.resolution=1/n,this.padding=n,i.uOutlineWidth[0]=1)}}const ne=new Ce({outlineColor:b.pureBlack,upscale:C.getState().upscale.gameEngineUpscale,lowRes:!0}),Ue=new J,In=new J,Zt=new J,_n=new J(b.moss),Ee=new J,R=[Ue,ne],Ps=[Ee,ne],Bs=[ne,Zt],tt={original:[ne,Ee],colourised:{head:[ne,new J(b.pastelBlue)],heels:[ne,new J(b.pink)]}},me=13,As=2;class Fs{constructor(e,n){this.inputStateTracker=e,this.inputDirectionMode=n,this.arrowSprites={away:h({textureId:"hud.char.↗",anchor:{x:.5,y:.5},x:me,y:-13,filter:R}),right:h({textureId:"hud.char.↘",anchor:{x:.5,y:.5},x:me,y:me,filter:R}),towards:h({textureId:"hud.char.↙",anchor:{x:.5,y:.5},x:-13,y:me,filter:R}),left:h({textureId:"hud.char.↖",anchor:{x:.5,y:.5},x:-13,y:-13,filter:R}),...n!=="4-way"?{awayRight:h({textureId:"hud.char.➡",anchor:{x:.5,y:.5},x:me*Math.SQRT2,filter:R}),towardsRight:h({textureId:"hud.char.⬇",anchor:{x:.5,y:.5},y:me*Math.SQRT2,filter:R}),towardsLeft:h({textureId:"hud.char.⬅",anchor:{x:.5,y:.5},x:-13*Math.SQRT2,filter:R}),awayLeft:h({textureId:"hud.char.⬆",anchor:{x:.5,y:.5},y:-13*Math.SQRT2,filter:R})}:{}},this.container.addChild(this.#t),this.container.addChild(new j().circle(0,0,24).fill("#00000000"));for(const r of k(this.arrowSprites))this.container.addChild(r);this.container.on("pointerenter",this.handlePointerEnter),this.container.on("globalpointermove",this.usePointerLocation),this.container.on("pointerup",this.stopCurrentPointer),this.container.on("pointerupoutside",this.stopCurrentPointer)}container=new g({label:"OnScreenJoystick",eventMode:"static"});arrowSprites;#t=h({textureId:"joystick",anchor:{x:.5,y:.5},y:1});#n;handlePointerEnter=e=>{this.#n!==void 0&&this.stopCurrentPointer(),this.#n=e.pointerId,this.usePointerLocation(e)};stopCurrentPointer=()=>{this.#n=void 0,this.inputStateTracker.hudInputState.directionVector=_};usePointerLocation=e=>{if(e.pointerId!==this.#n)return;const n=Ko(C.getState()),{x:r,y:o}=this.container,{x:i,y:s}=e,{width:a,height:l}=this.container.getLocalBounds(),c=(i/n-r)/(a/2),u=(s/n-o)/(l/2),d=ei({x:-c,y:-u}),f=B(d,As);this.inputStateTracker.hudInputState.directionVector=f};tick(e){const{directionVector:n}=this.inputStateTracker;if(C.getState().openMenus.length>0){this.stopCurrentPointer();return}const o=Oe(n)>ti?cr(n):void 0;for(const[i,s]of yt(this.arrowSprites))s.filters=i===o?Ps:R;this.#t.filters=e?Se:Ue}destroy(){this.stopCurrentPointer(),this.container.off("pointerenter",this.handlePointerEnter),this.container.off("globalpointermove",this.usePointerLocation),this.container.off("pointerup",this.stopCurrentPointer),this.container.off("pointerupoutside",this.stopCurrentPointer),this.container.destroy()}}const Qt={colourised:{jump:b.pastelBlue,fire:b.highlightBeige,carry:b.moss,carryAndJump:b.midRed,menu:b.lightGrey},zx:{jump:Y.zxBlue,fire:Y.zxYellow,carry:Y.zxGreen,carryAndJump:Y.zxRed,menu:Y.zxWhite}};function He(t,e){const n=e||new g;for(const r of t)n.addChild(r);return n}function*co(t){const e=typeof t=="string"?t.split(""):Number.isFinite(t)?t.toString().split(""):"∞",n=e.length;for(let r=0;r<n;r++){const o=`hud.char.${e[r]}`;ni(o),yield h({textureId:o,x:(r+.5-n/2)*at.w})}}function ge(t,e){return t.removeChildren(),He(co(e),t),t}function Ds(t,e){return t.removeChildren(),He(co(e),t),t}const gt=Symbol(),uo=Symbol(),fo=Symbol(),nt=({colourise:t,button:{which:e}})=>{const n=new g({label:"depress"}),r=new g({label:"arcadeButton"});r.addChild(n);const o=h("button");t?o.filters=ks(Qt.colourised[e]):r.filters=new J(Qt.zx[e]),n.addChild(o);const i=new g({label:"surface"}),s=h({textureId:"button.surfaceMask",label:"surfaceMask"});return n.addChild(s),i.mask=s,n.addChild(i),r[uo]=o,r[gt]=i,r[fo]=n,r},Ae=(t,...e)=>{t[gt].removeChildren();for(const n of e)n!==void 0&&t[gt].addChild(n)},rt=(t,e)=>{t[uo].texture=oe().textures[e?"button.pressed":"button"],t[fo].y=e?1:0},Pn=(t,e,n)=>{n&&(t[gt].filters=e?lo():Se)},Bn=({which:t},e,n)=>{const r=Ds(new g,n);return r.filters=new _e({white:e?We(Qt.colourised[t]):b.pureBlack}),r};class ho{constructor(e,n,r){this.subject=e,this.gameState=n,this.appearance=r,this.#n=new g({label:`AppearanceRenderer ${e.id}`})}#t=void 0;#n;destroy(){this.#n.destroy({children:!0})}tick(e){const n=this.appearance({subject:this.subject,currentlyRenderedProps:this.#t,previousRendering:this.#n.children.at(0)??null,renderContext:e,gameState:this.gameState});n!=="no-update"&&(this.#t=n.renderProps,this.#n.children.at(0)!==n.container&&(this.#n.removeChildren(),n.container!==null&&this.#n.addChild(n.container)))}get container(){return this.#n}}const po=t=>h(t.type==="spring"?"spring.released":t.type==="sceneryPlayer"?t.config.which==="head"?"head.walking.towards.2":"heels.walking.away.2":t.config.style),zs=(t,e,n,r)=>{const o=Math.max(0,Math.min(t.x+e.x,n.x+r.x)-Math.max(t.x,n.x)),i=Math.max(0,Math.min(t.y+e.y,n.y+r.y)-Math.max(t.y,n.y));return o*i},An=({state:{position:t},aabb:e},{state:{position:n},aabb:r})=>zs(t,e,n,r),un=(t,e,n=.001)=>{if(!he(e,t)||t.id===e.id)return!1;const{state:{vels:{gravity:{z:r}}}}=t;return r>0?!1:tn({state:{position:U(t.state.position,{x:0,y:0,z:-.001})},aabb:{...t.aabb,z:n+ri},id:t.id},{state:{position:U(e.state.position,{x:0,y:0,z:e.aabb.z})},aabb:{...e.aabb,z:0},id:e.id})},mo=(t,e)=>{const r=[...z(e).filter(i=>un(t,i))];return r.length===0?void 0:r.reduce((i,s)=>{const a=Si(s,i);return a<0||a===0&&An(t,s)>An(t,i)?s:i})},$e=t=>{const{gameTime:e,lastDiedAt:n}=t.type==="headOverHeels"?t.state.head:t.state;return e-n<ki};function bo({room:{roomTime:t},movingItem:e}){if(e.state.action==="death")return;const n=e.type==="headOverHeels"?e.state.head:e.state;oo(n)>0||$e(e)||(e.state.action="death",e.state.expires=t+Ht)}const go=t=>{const{gameState:e,movingItem:n,touchedItem:r,room:{id:o}}=t;if(e.pickupsCollected[o][r.id]===!0)return;const i=e.pickupsCollected[o];switch(i[r.id]=!0,r.config.gives){case"hooter":{const s=ct(n);if(s!==void 0){s.hasHooter=!0;break}break}case"doughnuts":{const s=ct(n);s!==void 0&&(s.doughnuts+=6);break}case"bag":{const s=bt(n);if(s!==void 0){s.hasBag=!0;break}break}case"shield":{n.type==="headOverHeels"?(n.state.head.shieldCollectedAt=n.state.head.gameTime,n.state.heels.shieldCollectedAt=n.state.heels.gameTime):n.state.shieldCollectedAt=n.state.gameTime;break}case"fast":{const s=ct(n);s!==void 0&&(s.fastStepsStartedAtDistance=s.gameWalkDistance);break}case"jumps":{const s=bt(n);s!==void 0&&(s.bigJumps+=10);break}case"extra-life":if(n.type==="headOverHeels"){n.state.head.lives+=2,n.state.heels.lives+=2;break}else n.state.lives+=2;break;case"scroll":C.dispatch(ii(r.config.page));break;case"reincarnation":break;case"crown":{C.dispatch(oi(r.config.planet));break}default:r.config}},Ls=({gameState:t,movingItem:e,touchedItem:n,movementVector:r})=>{const{config:{toRoom:o,direction:i}}=n;ur(i,r)<=0||e.state.action!=="death"&&nn({playableItem:e,gameState:t,toRoomId:o,sourceItem:n,changeType:"portal"})},Ms=({movingItem:t,movementVector:e,touchedItem:n})=>{const{config:{direction:r,part:o}}=n,i=xt(r);if(o==="top")return;const s=o==="far"?{x:i==="x"?-Math.abs(e.y):Math.abs(e.y)*(r==="left"?-1:1),y:i==="y"?-Math.abs(e.x):Math.abs(e.x)*(r==="away"?-1:1),z:0}:{x:i==="x"?Math.abs(e.y):Math.abs(e.y)*(r==="left"?-1:1),y:i==="y"?Math.abs(e.x):Math.abs(e.x)*(r==="away"?-1:1),z:0};t.state.position=U(t.state.position,s)};function Rs({movingItem:t}){t.state.autoWalk=!1}const Z=(t,...e)=>X(...e)(t.touchedItem),Fe=(t,...e)=>X(...e)(t.movingItem),vo=t=>H(t.movingItem),Us=t=>H(t.touchedItem),Es=t=>br(t.touchedItem),Fn=t=>{switch(!0){case Z(t,"stopAutowalk"):Rs(t);break;case Es(t):bo(t);break;case Z(t,"portal"):Ls(t);break;case Z(t,"pickup"):go(t);break;case Z(t,"doorFrame"):Ms(t);break}},ke={movementType:"steady"},yo=150,xo=t=>t[Math.floor(Math.random()*t.length)],re=Object.freeze({movementType:"vel",vels:{walking:_}}),St=t=>gr(t)?ce[t.config.which]:ce[t.type],Dn=L.w/2,$s=({state:{position:t,vels:{walking:e}}},n,r,o)=>{const i=ce.homingBot;if(!wt(e,te))return{movementType:"steady"};const{items:{head:s,heels:a}}=n;for(const l of[s,a]){if(l===void 0)continue;const c=Xe(l.state.position,t);if(Math.abs(c.y)<Dn)return{movementType:"vel",vels:{walking:{x:c.x>0?i:-.05,y:0,z:0}}};if(Math.abs(c.x)<Dn)return{movementType:"vel",vels:{walking:{x:0,y:c.y>0?i:-.05,z:0}}}}return{movementType:"steady"}},wo=(t,e)=>{const{items:{head:n,heels:r,headOverHeels:o}}=e;if(o!==void 0)return $e(o)?void 0:e.items.headOverHeels;const i=n===void 0||$e(n)||n.state.action==="death"?void 0:dn(n.state.position,t),s=r===void 0||$e(r)||r.state.action==="death"?void 0:dn(r.state.position,t);return i===void 0?r:s===void 0||i<s?n:r},Ns=(t,e,n,r)=>{const{state:{position:o,standingOn:i,timeOfLastDirectionChange:s,facing:a}}=t;if(i===null)return re;const l=wo(o,e);if(l===void 0||s+yo>e.roomTime)return ke;const c=Xe(l?.state.position,o),u=Math.abs(c.x)<Math.abs(c.y)?"x":"y",d=Math.abs(c[u])>L.w/4?u:Ge(u),f=St(t),p={..._,[d]:c[d]>0?f:-f},m=fe(p),v=!wt(m,a);return{movementType:"vel",vels:{walking:p},stateDelta:{facing:m,...v?{timeOfLastDirectionChange:e.roomTime}:qe}}},zn=(t,e,n,r,o=!1)=>{const{state:{position:i,standingOn:s}}=t;if(s===null)return re;const a=wo(i,e);if(a===void 0)return re;const l=a.state.position,c=L.w*3;if(!(i.x>l.x-c&&i.x<l.x+c&&i.y>l.y-c&&i.y<l.y+c))return re;const d=Xe(a?.state.position,i),f=St(t),p=(1+Math.sqrt(2))/2,m=f*p,v=B({...d,z:0},m/dr(d)*(o?-1:1));return{movementType:"vel",vels:{walking:v},stateDelta:{facing:fe(v)}}},Ft=(t,e,n,r,o)=>{const{state:{vels:{walking:i},standingOn:s}}=t;if(s===null)return re;if(!(Ie(i,_)||Math.random()<r/1e3))return ke;const l=xo(o);return{movementType:"vel",vels:{walking:B(Vt[l],St(t))},stateDelta:{facing:Vt[l]}}},Vs=(t,e,n,r)=>{const{state:{facing:o,vels:{walking:i},standingOn:s}}=t;return s===null?re:wt(i,te)?{movementType:"vel",vels:{walking:B(o,St(t))}}:ke},js=(t,e,n)=>{switch(n){case"opposite":return{x:e.x===0?t.x:-t.x,y:e.y===0?t.y:-t.y,z:0};case"clockwise":return{x:-t.y,y:t.x,z:0};case"perpendicular":{const r=xo([-1,1]);return{x:e.x===0?r*t.y:0,y:e.y===0?r*t.x:0,z:0}}}},Dt=({movingItem:t,touchedItem:{state:{position:e},aabb:n},deltaMS:r},o)=>{const{state:{position:i,vels:{walking:s},activated:a},aabb:l}=t;if(!a||(t.state.durationOfTouch+=r,t.state.durationOfTouch<yo))return;const c=Ct(i,l,e,n);if(c.x===0&&c.y===0)return;const u=js(s,c,o);t.state.vels.walking=u,t.state.facing=fe(u),t.state.durationOfTouch=0},Hs=({movingItem:t,movementVector:e})=>{e.z<0||(t.state.vels.walking=_)},Xs=(t,e,n,r)=>{if(!t.state.activated||gr(t)&&t.state.busyLickingDoughnutsOffFace)return re;switch(t.config.movement){case"patrol-randomly-diagonal":return Ft(t,e,n,r,ci);case"patrol-randomly-xy8":return Ft(t,e,n,r,li);case"patrol-randomly-xy4":return Ft(t,e,n,r,ai);case"towards-tripped-on-axis-xy4":return $s(t,e);case"towards-on-shortest-axis-xy4":return Ns(t,e);case"back-forth":case"clockwise":return Vs(t);case"unmoving":case"free":return re;case"towards-when-in-square-xy8":return zn(t,e);case"towards-when-in-square-xy8-unless-planet-crowns":return zn(t,e,n,r,si(C.getState()));default:throw t.config,new Error("this should be unreachable")}},Gs=t=>{const{movingItem:e,touchedItem:n}=t;if(he(n,e))switch(e.config.movement){case"patrol-randomly-xy4":Dt(t,"perpendicular");break;case"back-forth":case"patrol-randomly-diagonal":case"patrol-randomly-xy8":Dt(t,"opposite");break;case"clockwise":Dt(t,"clockwise");break;case"towards-tripped-on-axis-xy4":Hs(t);break;case"towards-on-shortest-axis-xy4":case"towards-when-in-square-xy8":case"towards-when-in-square-xy8-unless-planet-crowns":case"unmoving":case"free":return;default:throw e.config,new Error("this should be unreachable")}},qs=({touchedItem:t,gameState:{progression:e},room:n})=>{const{config:{activates:r,store:o},state:{setting:i,touchedOnProgression:s}}=t;if(t.state.touchedOnProgression=e,!(e===s+1||e===s)){if(r){const a=t.state.setting=i==="left"?"right":"left";for(const[l,c]of yt(r)){const u=n.items[l];u!==void 0&&(u.state={...u.state,...c[a]})}}o&&C.dispatch(ui(o.path))}},Ws=({movingItem:t,touchedItem:e})=>{if(!he(t))return;const{state:{position:n},aabb:r}=e,o=Ct(t.state.position,t.aabb,n,r);if(o.x===0&&o.y===0)return;const i=fe(o),s=B(i,-.05);return e.state.vels.sliding=s,!1},Ys=({movingItem:t,touchedItem:e})=>{if(!he(e))return;const n=t.state.vels.sliding;if(Ie(n,_))return;const{state:{position:r},aabb:o}=t,i=Ct(e.state.position,e.aabb,r,o);return ur(i,t.state.vels.sliding)>0&&(t.state.vels.sliding=_),!1},Js=2*Oi,Co=(t,e,n)=>{t.state.latentMovement.push({moveAtRoomTime:e.roomTime+Js,positionDelta:n})},Zs=(t,e,n)=>{for(const r of t){const o=n[r.id];if(o===void 0)continue;const s={...fr(r.state.position,o),z:0};if(!Ie(s,_))for(const a of r.state.stoodOnBy)Co(a,e,s)}},Qs=({movingItem:t,room:e,touchedItem:n,deltaMS:r})=>{const{config:{controls:o},state:{position:i},aabb:s}=n,a=Ct(t.state.position,t.aabb,i,s);if(a.x===0&&a.y===0)return;const l=fe(a);for(const c of o){const u=e.items[c],d=B(l,-.025*r);u.state.facing=d,Co(u,e,d)}},ot=t=>{const n=t/Bi*ar;return(t+.5*Xt*n**2)/n},Ks={head:ot(Je.head),headOnSpring:ot(Je.head+L.h),heels:ot(Je.heels),heelsOnSpring:ot(Je.heels+L.h)},ea=(t,e)=>{const n=t.type==="headOverHeels"?"head":t.type==="heels"&&t.state.bigJumps>0?(t.state.bigJumps--,"head"):t.type;return Ks[`${n}${e?"OnSpring":""}`]},ta=t=>!(t===null||_i(t)||Pi(t)&&t.config.gives==="scroll"||H(t)&&t.state.standingOn===null),To=(t,e)=>{const{state:{standingOn:n}}=t,{inputStateTracker:r}=e,o=r.currentActionPress("jump")!=="released"&&ta(n);if(o&&console.log("starting a jump!"),!o)return n!==null?{movementType:"steady",stateDelta:{jumped:!1}}:ke;const i=Ii(n);return{movementType:"vel",vels:{gravity:{x:0,y:0,z:ea(t,i)}},stateDelta:{action:"moving",jumped:!0}}},na=({vel:t,acc:e,unitD:n,maxSpeed:r,deltaMS:o,minSpeed:i=0})=>{const s=Oe(t),a=Math.max(i,Math.min(r,s+e*o)),l=Math.min(a,r);return B(n,l)},Ln={movementType:"vel",vels:{walking:_}},So=(t,e,n)=>{const r=ra(t,e,n);if(r.movementType==="vel"&&r.vels.walking!==void 0){const o=Oe(r.vels.walking);r.stateDelta={...r.stateDelta,walkDistance:o===0?0:t.state.walkDistance+o*n},t.type==="head"&&t.state.standingOn!==null&&(r.stateDelta={...r.stateDelta,gameWalkDistance:t.state.gameWalkDistance+o*n})}return t.state.action==="idle"&&r.movementType==="vel"&&r.vels.walking!==void 0&&!Ie(r.vels.walking,_)&&(r.stateDelta={...r.stateDelta,walkStartFacing:t.state.facing}),r},ra=(t,{inputStateTracker:e,currentCharacterName:n},r)=>{const{type:o,state:{action:i,autoWalk:s,standingOn:a,facing:l,teleporting:c,walkDistance:u,walkStartFacing:d,vels:{walking:f,gravity:p}}}=t,m=n===t.id,v=m?e.currentActionPress("jump"):"released",A=m?e.directionVector:_,F=a===null&&p.z<0,$=o==="head"&&io(t.state)>0&&a!==null,I=o==="headOverHeels"?F?"head":"heels":$?"heels":o,P=s?l:A,M=ce[I];if(c!==null||i==="death")return Ln;if(o==="heels"){if(a===null)return t.state.jumped?{movementType:"vel",vels:{walking:fr(f,B(f,Ai*r))}}:Ln;if(v!=="released"){const ie=fe(wt(P,te)?l:P),$o=X("spring")(a)?1:Fi;return{movementType:"vel",vels:{walking:B({...ie,z:0},M*$o)},stateDelta:{facing:ie}}}}if(Oe(P)!==0)return F?{movementType:"vel",vels:{walking:B({...P,z:0},M)},stateDelta:{facing:P,action:"falling"}}:{movementType:"vel",vels:{walking:na({vel:f,acc:Di[I],deltaMS:r,maxSpeed:M,unitD:P,minSpeed:0})},stateDelta:{facing:P,action:"moving"}};if(u>0&&u<1){const ie=Ie(d,l)?1:0;return{movementType:"position",posDelta:B(l,ie-u),stateDelta:{action:F?"falling":"idle",walkDistance:0}}}return{movementType:"vel",vels:{walking:_},stateDelta:{action:F?"falling":"idle"}}},Mn=t=>pe(t.movingItem)&&un(t.movingItem,t.touchedItem,Math.abs(t.movementVector.z)),ko=(t,e)=>{let n=_;for(const r of e){if(r.movementType==="position"&&(n=U(n,r.posDelta)),r.movementType==="vel"&&(pe(t)||X("lift")(t)))for(const[i,s]of yt(r.vels)){const a={..._,...s};t.state.vels[i]=a}const o=r.stateDelta;o!==void 0&&(t.state={...t.state,...o})}return n},Rn=t=>{if(t.touchedItem.state.disappear==="onTouch"||t.touchedItem.state.disappear==="onTouchByPlayer"&&H(t.movingItem)||t.touchedItem.state.disappear==="onStand"&&Mn(t)){if(Mn(t)&&vo(t)){vr({above:t.movingItem,below:t.touchedItem});const n=[To(t.movingItem,t.gameState),So(t.movingItem,t.gameState,t.deltaMS)];ko(t.movingItem,n)}yr(t)}};function oa(t){const e=t.movingItem.type==="monster"?t.movingItem:t.touchedItem;e.config.which!=="emperorsGuardian"&&(e.state.busyLickingDoughnutsOffFace=!0)}const Oo=t=>{vo(t)&&Fn(t),Us(t)&&Fn({...t,movingItem:t.touchedItem,touchedItem:t.movingItem}),Z(t,...pn)&&Ws(t),Fe(t,...pn)&&Ys(t),(Fe(t,"monster")&&Z(t,"firedDoughnut")||Fe(t,"firedDoughnut")&&Z(t,"monster"))&&oa(t),(Fe(t,"monster")||Fe(t,"movableBlock"))&&Gs(t),Z(t,"switch")&&qs(t),Z(t,"joystick")&&Qs(t),t.touchedItem.state.disappear&&Rn(t),t.movingItem.state.disappear&&he(t.touchedItem,t.movingItem)&&Rn({...t,movingItem:t.touchedItem,touchedItem:t.movingItem})},ia=(t,e,n,r)=>{const{inputStateTracker:o}=n,i=t.type==="heels"?t.state:t.state.heels,{carrying:s,hasBag:a}=i,{state:{position:l}}=t;if(!a)return;const c=z(k(e.items)).filter(xr),u=s===null?Io(t,e):void 0;for(const d of c)d.state.wouldPickUpNext=!1;if(u!==void 0&&(u.state.wouldPickUpNext=!0),o.currentActionPress("carry")==="tap")if(s===null){if(u===void 0){console.warn("nothing to pick up");return}sa(e,i,u)}else{if(t.state.standingOn===null||!_o(t,k(e.items)))return;const d=zi({gameState:n,room:e,itemType:s.type,config:s.config,position:l});wr({subjectItem:t,gameState:n,room:e,posDelta:{x:0,y:0,z:d.aabb.z},pusher:t,forceful:!0,deltaMS:r,onTouch:Oo}),i.carrying=null}},sa=(t,e,n)=>{const r={type:n.type,config:n.config};e.carrying=r,Cr({room:t,item:n})},Io=(t,e)=>mo(t,z(k(e.items)).filter(xr)),_o=(t,e)=>{const n={position:U(t.state.position,{z:L.h})},r=Li({id:t.id,aabb:t.aabb,state:n},e);for(const o of r)if(he(o,t)){if(!pe(o))return console.log("carrying: cannot put down due to collision: item:",t,"can't move up because it would collide with non-free",o),!1;if(!_o(o,e))return console.log("carrying: cannot put down due to collision: item:",t,"can't move up because it would collide with free that has nowhere to go:",o),!1}return!0},zt=-11,aa={jump({subject:t,gameState:e,currentlyRenderedProps:n,previousRendering:r,renderContext:{colourise:o}}){const{inputStateTracker:i}=e,a=Q(e)?.state.standingOn?.type==="teleporter",l=t.actions.every(u=>i.currentActionPress(u)!=="released"),c=r===null?nt({colourise:o,button:t}):r;if(n?.pressed!==l&&rt(c,l),a!==n?.standingOnTeleporter)if(a)Ae(c,h({textureId:"teleporter",y:5}),h({animationId:"teleporter.flashing",y:5}));else{const u=Bn(t,o,"JUMP");u.y=zt,Ae(c,u)}return{container:c,renderProps:{pressed:l,standingOnTeleporter:a,colourise:o}}},carry({subject:t,gameState:e,currentlyRenderedProps:n,previousRendering:r,renderContext:{colourise:o}}){const{inputStateTracker:i}=e,s=Q(e),a=bt(s),l=a?.hasBag??!1,c=a?.carrying??null,u=c===null&&Io(s,ue(e))!==void 0,d=t.actions.every(v=>i.currentActionPress(v)!=="released"),f=l&&!u&&c===null,p=r===null?nt({colourise:o,button:t}):r;if(p.visible=l,l&&(f!==n?.disabled&&Pn(p,f,o),p.visible=!0,n?.pressed!==d&&rt(p,d),l!==n?.hasBag||c!==n?.carrying)){let v;c!==null?v=po(c):l&&(v=h({textureId:"bag",y:-2})),Ae(p,v)}return{container:p,renderProps:{pressed:d,hasBag:l,colourise:o,carrying:c,disabled:f}}},fire({subject:t,gameState:e,currentlyRenderedProps:n,previousRendering:r,renderContext:{colourise:o}}){const{inputStateTracker:i}=e,s=Q(e),a=ct(s),l=a?.hasHooter??!1,c=a?.doughnuts??0,u=t.actions.every(p=>i.currentActionPress(p)!=="released"),d=r===null?nt({colourise:o,button:t}):r,f=l||c>0;if(d.visible=f,f&&(n?.pressed!==u&&rt(d,u),l!==n?.hasHooter||c!==n?.doughnuts)){let p;l?p=h({textureId:"hooter",y:-3}):c>0&&(p=h({textureId:"doughnuts",y:-2}));const m=ge(new g,c);m.y=zt,m.filters=ne,Ae(d,p,m),Pn(d,c===0,o)}return{container:d,renderProps:{pressed:u,colourise:o,doughnuts:c,hasHooter:l}}},carryAndJump({subject:t,gameState:e,currentlyRenderedProps:n,previousRendering:r,renderContext:{colourise:o}}){const{inputStateTracker:i}=e,s=Q(e),l=bt(s)?.hasBag??!1,c=t.actions.every(f=>i.currentActionPress(f)!=="released");if(!(n===void 0||c!==n.pressed||o!==n.colourise||l!==n.hasBag))return"no-update";let d;if(r===null){d=nt({colourise:o,button:t});const f=Bn(t,o,"C+J");f.y=zt,Ae(d,f)}else d=r;return l?(d.visible=!0,n?.pressed!==c&&rt(d,c)):d.visible=!1,{container:d,renderProps:{pressed:c,hasBag:l,colourise:o}}},menu({previousRendering:t}){if(t!==null)return"no-update";const e=h("hud.char.Menu");return e.scale=2,e.filters=R,{container:e,renderProps:qe}}};class De extends ho{constructor(e,n){super(e,n,aa[e.which]),this.button=e}}const la=26,ca=13;class ua{constructor(e,n,r){this.gameState=e,this.colourise=n,this.inputDirectionMode=r,this.#n={mainButtonNest:new g({label:"mainButtonNest"}),buttons:{jump:new De({which:"jump",actions:["jump"],id:"jump"},e),fire:new De({which:"fire",actions:["fire"],id:"fire"},e),carry:new De({which:"carry",actions:["carry"],id:"carry"},e),carryAndJump:new De({which:"carryAndJump",actions:["carry","jump"],id:"carryAndJump"},e),menu:new De({which:"menu",actions:["menu_openOrExit"],id:"menu"},e)},joystick:new Fs(e.inputStateTracker,r)};const{buttons:o}=this.#n,{mainButtonNest:i,joystick:s}=this.#n;for(const a of k(o))a.button.which==="menu"?this.#t.addChild(o.menu.container):i.addChild(a.container);o.jump.container.y=ca,o.carry.container.x=-26,o.carryAndJump.container.y=-13,o.fire.container.x=la,o.menu.container.x=24,o.menu.container.y=24,this.#t.addChild(i),this.#t.addChild(s.container),this.#e()}#t=new g({label:"OnScreenControls"});#n;#e(){const{gameState:{inputStateTracker:e}}=this;for(const n of k(this.#n.buttons)){const{button:{actions:r}}=n;n.container.eventMode="static",n.container.on("pointerdown",()=>{for(const o of r)e.hudInputState[o]=!0}),n.container.on("pointerup",()=>{for(const o of r)e.hudInputState[o]=!1}),n.container.on("pointerleave",()=>{for(const o of r)e.hudInputState[o]=!1})}}#r(e){this.#n.mainButtonNest.x=e.x-40,this.#n.mainButtonNest.y=e.y-14,this.#n.joystick.container.x=32,this.#n.joystick.container.y=e.y-28}tick({screenSize:e}){this.#r(e);for(const n of k(this.#n.buttons))n.tick({colourise:this.colourise});this.#n.joystick.tick(this.colourise)}get container(){return this.#t}destroy(){this.#t.destroy(),this.#n.joystick.destroy()}}lr.frames.button.frame;const da=250,fa=t=>t?12:24,ha=t=>t?32:56,pa=t=>t?40:80,ma=t=>t?18:24,Un=112,ze=t=>t==="heels"?1:-1;class En{constructor(e,n,r,o){this.gameState=e,this.onScreenControls=n,this.colourise=r,this.inputDirectionMode=o;for(const i of Pt)this.#t.addChild(this.#e[i].livesText),this.#t.addChild(this.#e[i].sprite),this.#t.addChild(this.#e[i].shield.container),this.#t.addChild(this.#e[i].extraSkill.container);n||(this.#t.addChild(this.#e.head.doughnuts.container),this.#t.addChild(this.#e.head.hooter.container),this.#t.addChild(this.#e.heels.bag.container),this.#t.addChild(this.#e.heels.carrying.container)),this.#t.addChild(this.#e.fps),this.#e.fps.filters=[_n],this.#e.fps.y=at.h,this.#r(),n&&(this.#n=new ua(e,this.colourise,o),this.#t.addChild(this.#n.container))}#t=new g({label:"HudRenderer"});#n=void 0;#e={head:{sprite:this.#o("head"),livesText:this.#i({label:"headLives",doubleHeight:!0,outline:!0}),shield:this.#s({label:"headShield",textureId:"hud.shield",outline:!0}),extraSkill:this.#s({label:"headFastSteps",textureId:"hud.fastSteps",outline:!0}),doughnuts:this.#s({label:"headDoughnuts",textureId:"doughnuts",textOnTop:!0,outline:"text-only"}),hooter:this.#s({label:"headHooter",textureId:"hooter",textOnTop:!0,noText:!0})},heels:{sprite:this.#o("heels"),livesText:this.#i({label:"heelsLives",doubleHeight:!0,outline:!0}),shield:this.#s({label:"heelsShield",textureId:"hud.shield",outline:!0}),extraSkill:this.#s({label:"heelsBigJumps",textureId:"hud.bigJumps",outline:!0}),bag:this.#s({label:"heelsBag",textureId:"bag",textOnTop:!0,noText:!0}),carrying:{container:new g({label:"heelsCarrying"})}},fps:this.#i({label:"fps",outline:!0})};#r(){const{inputStateTracker:{hudInputState:e}}=this.gameState;for(const n of Pt){const{sprite:r}=this.#e[n];r.eventMode="static",r.on("pointerdown",()=>{e[`swop.${n}`]=!0}),r.on("pointerup",()=>{e[`swop.${n}`]=!1}),r.on("pointerleave",()=>{e[`swop.${n}`]=!1})}}#s({textureId:e,textOnTop:n=!1,noText:r=!1,outline:o=!1,label:i}){const s=new g({label:i});s.pivot={x:4,y:16};const a=new Te({texture:oe().textures[e],anchor:n?{x:.5,y:0}:{x:.5,y:1},filters:In,y:n?0:8});s.addChild(a);const l=this.#i({outline:o==="text-only"});return l.y=n?0:16,l.x=a.x=at.w/2,s.addChild(l),r&&(l.visible=!1),o===!0&&(s.filters=ne),{text:l,icon:a,container:s}}#o(e){const n=new Te(oe().textures[`${e}.walking.${e==="head"?"right":"towards"}.2`]);return n.anchor={x:.5,y:0},n}#i({doubleHeight:e=!1,outline:n=!1,label:r="text"}={}){return new g({label:r,filters:n?Bs:Zt,scale:{x:1,y:e?2:1}})}#l(e){this.#e.head.hooter.container.x=this.#e.head.doughnuts.container.x=(e.x>>1)+ze("head")*Un,this.#e.head.doughnuts.container.y=e.y-Me.h-8,this.#e.heels.carrying.container.y=e.y-Me.h,this.#e.heels.carrying.container.x=this.#e.heels.bag.container.x=(e.x>>1)+ze("heels")*Un,this.#e.heels.bag.container.y=this.#e.head.hooter.container.y=e.y-8,this.#e.fps.x=e.x-at.w*2}#c(e,n){return e?n?Se:Ee:Ue}#a(e){const n=Ze(e,"heels"),r=n?.hasBag??!1,o=n?.carrying??null,{container:i}=this.#e.heels.carrying,s=i.children.length>0;if(o===null&&s)for(const a of i.children)a.destroy();o!==null&&!s&&i.addChild(po(o)),i.filters=this.#c(!0,this.colourise),this.#e.heels.bag.icon.filters=this.#c(r,this.colourise)}#d(e){const n=Ze(e,"head"),r=n?.hasHooter??!1,o=n?.doughnuts??0;this.#e.head.hooter.icon.filters=this.#c(r,this.colourise),this.#e.head.doughnuts.icon.filters=this.#c(o!==0,this.colourise),ge(this.#e.head.doughnuts.text,o)}#f(e,n,r){const o=Ze(e,r),{text:i,container:s}=this.#e[r].shield,{text:a,container:l}=this.#e[r].extraSkill,c=oo(o),u=c>0||!this.onScreenControls;s.visible=u,u&&(ge(i,c),s.y=n.y),l.x=s.x=(n.x>>1)+ze(r)*pa(this.onScreenControls);const d=o===void 0?0:r==="head"?io(o):o.bigJumps,f=d>0||!this.onScreenControls;l.visible=f,f&&(ge(a,d),l.y=n.y-ma(this.onScreenControls))}#u(e,n){const{currentCharacterName:r}=e;return r===n||r==="headOverHeels"}#h(e,n,r){const o=this.#u(e,r),i=this.#e[r].sprite;o?i.filters=this.colourise?Se:Ee:i.filters=this.colourise?Os:Ue,i.x=(n.x>>1)+ze(r)*ha(this.onScreenControls),i.y=n.y-Me.h}#p(e,n,r){const i=Ze(e,r)?.lives??0,s=this.#e[r].livesText;s.x=(n.x>>1)+ze(r)*fa(this.onScreenControls),s.y=n.y,ge(s,i??0)}#b(e){const n=ue(e);if(n===void 0)return;const r=cn(n.color);Ue.targetColor=r.hud.dimmed[this.colourise?"dimmed":"original"],Zt.targetColor=r.hud.dimmed[this.colourise?"basic":"original"],In.targetColor=r.hud.icons[this.colourise?"basic":"original"],Ee.targetColor=r.hud.lives.original,this.#e.head.livesText.filters=this.colourise?this.#u(e,"head")?tt.colourised.head:R:tt.original,this.#e.heels.livesText.filters=this.colourise?this.#u(e,"heels")?tt.colourised.heels:R:tt.original}#m=Number.NEGATIVE_INFINITY;#g(){if(di(C.getState())){if(performance.now()>this.#m+da){const e=Le.shared.FPS;ge(this.#e.fps,Math.round(e)),_n.targetColor=e>100?b.white:e>58?b.moss:e>55?b.pastelBlue:e>50?b.metallicBlue:e>40?b.pink:b.midRed,this.#m=performance.now()}this.#e.fps.visible=!0}else this.#e.fps.visible=!1}tick(e){const{gameState:n,screenSize:r}=e;this.#b(n);for(const o of Pt)this.#p(n,r,o),this.#h(n,r,o),this.#f(n,r,o);this.#l(r),this.#d(n),this.#a(n),this.#g(),this.#n?.tick(e)}get container(){return this.#t}destroy(){this.#t.destroy(),this.#n?.destroy()}}const $n={movementType:"vel",vels:{gravity:_}},ba=(t,e,n)=>{if(!he(t))return $n;const{type:r,state:{vels:{gravity:{z:o}},standingOn:i}}=t,a=Mi[(r==="headOverHeels"?"head":r)==="head"?"head":"others"];return i!==null?X("lift")(i)&&i.state.vels.lift.z<0?{movementType:"vel",vels:{gravity:{z:Math.max(o-Xt*n,-a)}}}:$n:{movementType:"vel",vels:{gravity:{z:Math.max(o-Xt*n,-a)}}}},Nn=L.h,Vn=.001,ga=({totalDistance:t,currentAltitude:e,direction:n})=>{const r=mn**2/(2*Pe);if(n==="up"){if(e<=r)return Math.max(Vn,Math.sqrt(2*Pe*Math.max(e,0)));if(e>=t-r){const o=Math.max(0,t-e);return Math.max(Vn,Math.sqrt(2*Pe*o))}else return mn}else if(e>=t-r){const o=Math.max(0,t-e);return Math.min(-.001,-Math.sqrt(2*Pe*o))}else return e<=r?Math.min(-.001,-Math.sqrt(2*Pe*Math.max(e,0))):-.036},va={movementType:"vel",vels:{lift:{x:0,y:0,z:0}}};function ya({config:{bottom:t,top:e},state:{direction:n,position:{z:r},stoodOnBy:o}},i,s){if(z(o).some(f=>Ri(f)&&f.config.style==="stepStool"))return va;const l=t*Nn,c=e*Nn,u=ga({currentAltitude:r-l,direction:n,totalDistance:c-l});if(Number.isNaN(u))throw new Error("velocity is NaN");const d=r<=l?"up":r>=c?"down":n;return{movementType:"vel",vels:{lift:{x:0,y:0,z:u}},stateDelta:{direction:d}}}function xa(t,e,n){const{state:{teleporting:r,standingOn:o}}=t,{inputStateTracker:i}=e,s=i.currentActionPress("jump");if(r===null)return s!=="released"&&o!==null&&X("teleporter")(o)?{movementType:"steady",stateDelta:{teleporting:{phase:"out",toRoom:o.config.toRoom,timeRemaining:Ht}}}:ke;const a=Math.max(r.timeRemaining-n,0);switch(r.phase){case"out":if(a===0)return nn({changeType:"teleport",sourceItem:o,playableItem:t,gameState:e,toRoomId:r.toRoom}),{movementType:"steady",stateDelta:{teleporting:{phase:"in",timeRemaining:Ht}}};break;case"in":if(a===0)return{movementType:"steady",stateDelta:{teleporting:null}};break}return{movementType:"steady",stateDelta:{teleporting:{...r,timeRemaining:a}}}}const jn={movementType:"vel",vels:{movingFloor:_}},wa=(t,e,n)=>{if(H(t)&&t.state.teleporting!==null)return jn;const{state:{standingOn:r}}=t;if(r===null||!X("conveyor")(r))return jn;const{config:{direction:o}}=r,s=X("heels")(t)&&t.state.action==="moving"&&en(t.state.facing)===fi(o)?ce.heels:Ui;return{movementType:"vel",vels:{movingFloor:B(Vt[o],s)}}};function*Ca(t,e,n,r){for(;(t.state.latentMovement.at(0)?.moveAtRoomTime??Number.POSITIVE_INFINITY)<e.roomTime;){const{positionDelta:o}=t.state.latentMovement.shift();yield{movementType:"position",posDelta:o}}}const Ta=L.w*Math.sqrt(2)+1,Sa=(t,e,n,r)=>{const{inputStateTracker:o}=n,i=t.type==="head"?t.state:t.state.head,{doughnuts:s,hasHooter:a,doughnutLastFireTime:l,gameTime:c}=i,{state:{position:u,facing:d}}=t,f=500,p=fe(d);if(o.currentActionPress("fire")==="tap"&&a&&s>0&&l+f<c){const m={type:"firedDoughnut",...Ei,config:qe,id:`firedDoughnut/${n.progression}`,shadowCastTexture:"shadow.smallRound",state:{position:U(u,B(p,Ta),t.type==="headOverHeels"?{z:L.h}:_),vels:{fired:B(p,ce.firedDoughnut)},disappear:"onTouch",expires:null,stoodOnBy:new Set}};rn({room:e,item:m}),i.doughnuts-=1,i.doughnutLastFireTime=i.gameTime}},ka=2;function*Oa(t,e,n,r){pe(t)&&(yield ba(t,n,r),yield wa(t),yield*Ca(t,e)),H(t)&&(yield So(t,n,r),t.id===n.currentCharacterName&&(yield xa(t,n,r),yield To(t,n),$i(t)&&ia(t,e,n,r),Ni(t)&&Sa(t,e,n))),Vi(t)&&(yield ya(t)),ji(t)&&(yield Xs(t,e,n,r))}const Ia=(t,e,n,r)=>{!pe(t)||t.state.standingOn===null||(H(t)&&(t.state.standingOn.type==="movableBlock"&&t.state.standingOn.config.movement!=="free"&&t.state.standingOn.config.activated==="onStand"&&(t.state.standingOn.state.activated=!0),t.state.standingOn.type==="pickup"&&go({gameState:n,movingItem:t,touchedItem:t.state.standingOn,room:e})),(t.state.standingOn.state.disappear==="onStand"||t.state.standingOn.state.disappear==="onTouch"||H(t)&&t.state.standingOn.state.disappear==="onTouchByPlayer")&&yr({touchedItem:t.state.standingOn,gameState:n,room:e}))},_a=(t,e,n,r)=>{H(t)&&t.state.standingOn!==null&&br(t.state.standingOn)&&bo({room:e,movingItem:t,touchedItem:t.state.standingOn});const o=[...Oa(t,e,n,r)];Ia(t,e,n);let i=ko(t,o);(pe(t)||X("lift")(t)||X("firedDoughnut")(t))&&(i=U(i,...z(k(t.state.vels)).map(l=>B(l,r))));const s=Math.ceil(Oe(i)/ka),a=B(i,1/s);for(let l=0;l<s;l++)wr({subjectItem:t,posDelta:a,gameState:n,room:e,deltaMS:r,onTouch:Oo})},Pa=(t,e)=>{const n=t.characterRooms.headOverHeels;if(e.state.head.lives--,e.state.heels.lives--,e.state.head.lastDiedAt=e.state.head.gameTime,e.state.heels.lastDiedAt=e.state.heels.gameTime,e.state.head.lives+e.state.heels.lives===0){t.events.emit("gameOver");return}const o=e.state.head.lives>0,i=e.state.heels.lives>0;if(e.state.heels.carrying=null,o&&!i||!o&&i){const c=o?"head":"heels";t.currentCharacterName=c,ae(t,e);const u=bn(e)[c],d=xe({gameState:t,playableItems:[u],roomId:n.id});t.characterRooms={[c]:d},t.entryState={[c]:mt(u)};return}if(t.entryState.headOverHeels!==void 0){ae(t,e);const c=xe({gameState:t,playableItems:[e],roomId:n.id});t.characterRooms={headOverHeels:c};return}else{const{head:c,heels:u}=bn(e);if(ae(t,c),ae(t,u),tn(c,u)){const d=Tr({head:c,heels:u});ae(t,d,"heels");const f=xe({gameState:t,playableItems:[d],roomId:n.id});t.characterRooms={headOverHeels:f},t.entryState={headOverHeels:mt(d)};return}else{const d=xe({gameState:t,playableItems:[c,u],roomId:n.id});t.characterRooms={head:d,heels:d};return}}},xe=({gameState:t,playableItems:e,roomId:n})=>{const{campaign:r}=t,o=jt(r.rooms[n],t.pickupsCollected[n]);for(const i of e)rn({room:o,item:i}),(i.type==="head"||i.type==="headOverHeels")&&Hi(o,t);return o},ae=(t,e,n=e.id)=>{const r=t.entryState[n];e.state={...e.state,...r,expires:null,standingOn:null}},Ba=(t,e)=>{const n=Sr(t,kr(e.type));if(e.state.lives--,e.state.lastDiedAt=e.state.gameTime,e.type==="heels"&&(e.state.carrying=null),e.state.lives===0)if(delete t.characterRooms[e.id],n!==void 0){t.currentCharacterName=n.type;return}else{t.events.emit("gameOver");return}else{const r=t.characterRooms[e.type];ae(t,e);const o=n===void 0?void 0:t.characterRooms[n.type];if(r===o){if(t.entryState.headOverHeels!==void 0){const a=Tr({head:e.id==="head"?e:r.items.head,heels:e.id==="heels"?e:r.items.heels});ae(t,a);const l=xe({gameState:t,playableItems:[a],roomId:r.id});t.characterRooms={headOverHeels:l},t.currentCharacterName="headOverHeels";return}rn({room:r,item:e});return}else{const s=xe({gameState:t,playableItems:[e],roomId:r.id});t.characterRooms[e.id]=s;return}}},Aa=(t,e)=>{e.type==="headOverHeels"?Pa(t,e):Ba(t,e),Q(t)===void 0&&C.dispatch(hi())},Fa=t=>{for(const e of k(t.items))for(const n of e.state.stoodOnBy){if(!t.items[n.id]){gn(n);continue}if(!un(n,e)){gn(n);const r=mo(n,k(t.items));r!==void 0&&vr({above:n,below:r})}}},Da=(t,e)=>t.state.expires!==null&&t.state.expires<e.roomTime,za=(t,e,n)=>{for(const r of k(t.items))!pe(r)||t.roomTime===r.state.actedOnAt||pi(r.state.position)||(console.log(`snapping item ${r.id} to pixel grid (not acted on in tick)`),r.state.position=mi(r.state.position),n.add(r))},La=(t,e)=>{const n={lift:-4,head:-3,heels:-3,monster:-2,block:1,deadlyBlock:1},r=n[t.type]??0,o=n[e.type]??0;return r-o},Ma=qe,Ra=(t,e)=>{if(t.gameSpeed>1){let n=new Set;for(let r=0;r<t.gameSpeed;r++){const o=Hn(t,e),i=ue(t)?.items??Ma;n=new Set(z(Gt(n,o)).filter(({id:s})=>i[s]!==void 0))}return n}return Hn(t,e*t.gameSpeed)},Hn=(t,e)=>{const{inputStateTracker:n}=t,r=ue(t);if(r===void 0)return hr;const o=Object.fromEntries(z(yt(r.items)).map(([a,l])=>[a,l.state.position]));n.currentActionPress("swop")==="tap"&&Bt(t),n.currentActionPress("swop.head")==="tap"&&Bt(t,"head"),n.currentActionPress("swop.heels")==="tap"&&Bt(t,"heels");for(const a of k(r.items))Da(a,r)&&(Cr({room:r,item:a}),H(a)&&Aa(t,a));const i=Object.values(r.items).sort(La);for(const a of i){const l=Q(t);if(l===void 0||l.state.action==="death")break;r.items[a.id]!==void 0&&_a(a,r,t,e)}Fa(r);const s=new Set(z(k(r.items)).filter(a=>o[a.id]===void 0||!Ie(a.state.position,o[a.id])));return Zs(s,r,o),za(r,o,s),Ua(t,r,e),s},Ua=(t,e,n)=>{t.progression++,t.gameTime+=n,e.roomTime+=n;const r=Q(t);if(r!==void 0){if(r.type==="headOverHeels")r.state.head.gameTime+=n,r.state.heels.gameTime+=n;else if(r.state.gameTime+=n,t.characterRooms.head===t.characterRooms.heels){const i=Sr(t,kr(r.type));i!==void 0&&(i.state.gameTime+=n)}}},Xn=(t,e)=>{const n=w(t),r=w(U(t,{x:e.x,z:e.z})),o=w(U(t,{y:e.y,z:e.z}));return{bottomCentre:n,topLeft:r,topRight:o}},Lt=(t,e,n,r,o=1e-5)=>r-o>t&&n<e-o,Ea=(t,e,n,r)=>{const o=Xn(t,e),i=Xn(n,r),s=o.topLeft.x,a=o.topRight.x,l=i.topLeft.x,c=i.topRight.x,u=Lt(s,a,l,c),d=o.topRight.y-o.topRight.x/2,f=o.bottomCentre.y-o.bottomCentre.x/2,p=i.topRight.y-i.topRight.x/2,m=i.bottomCentre.y-i.bottomCentre.x/2,v=Lt(d,f,p,m),A=o.topLeft.y+o.topLeft.x/2,F=o.bottomCentre.y+o.bottomCentre.x/2,$=i.topLeft.y+i.topLeft.x/2,I=i.bottomCentre.y+i.bottomCentre.x/2,P=Lt(A,F,$,I);return u&&v&&P},$a=(t,e)=>{if(t.renders===!1||e.renders===!1||t.fixedZIndex!==void 0||e.fixedZIndex!==void 0)return 0;const n=t.state.position,r=t.renderAabb||t.aabb,o=e.state.position,i=e.renderAabb||e.aabb;if(!Ea(n,r,o,i))return 0;for(const s of bi){const a=t.state.position[s],l=a+r[s],c=e.state.position[s],u=c+i[s];if(l<=c)return 1*(s==="z"?-1:1);if(a>=u)return-1*(s==="z"?-1:1)}return Gn(e)-Gn(t)},Gn=t=>t.state.position.x+t.state.position.y-t.state.position.z;class ut extends Error{constructor(e,n,r){super(`CyclicDependencyError: .cyclicDependency property of this error has nodes as an array. ${e.join(" -> ")}`,r),this.cyclicDependency=e,this.hasClosedCycle=n}}const Na=t=>{const e=Va(t);let n=e.length,r=n;const o=new Array(n),i={},s=ja(e);for(;r--;)i[r]||a(e[r],r,new Set);return o;function a(l,c,u){if(u.has(l))throw new ut([l],!1);if(i[c])return;i[c]=!0;const d=t.get(l)||new Set,f=Array.from(d);if(c=f.length){u.add(l);do{const p=f[--c];try{a(p,s.get(p),u)}catch(m){throw m instanceof ut?m.hasClosedCycle?m:new ut([l,...m.cyclicDependency],m.cyclicDependency.includes(l)):m}}while(c);u.delete(l)}o[--n]=l}};function Va(t){const e=new Set;for(const[n,r]of t.entries()){e.add(n);for(const o of r)e.add(o)}return Array.from(e)}function ja(t){const e=new Map;for(let n=0,r=t.length;n<r;n++)e.set(t[n],n);return e}const qn=(t,e,n)=>{t.has(e)||t.set(e,new Set),t.get(e).add(n)},it=(t,e,n)=>{const r=t.get(e);r!==void 0&&(r?.delete(n),r.size===0&&t.delete(e))},Ha=(t,e=new Set(k(t)),n=new Map)=>{const r=new Map;for(const[o,i]of n)if(!t[o])n.delete(o);else for(const s of i)t[s]||it(n,o,s);for(const o of e)if(o.renders)for(const i of k(t)){if(!i.renders||r.get(i)?.has(o)||o===i)continue;const s=$a(o,i);if(qn(r,o,i),s===0){it(n,o.id,i.id),it(n,i.id,o.id);continue}const a=s>0?o.id:i.id,l=s>0?i.id:o.id;qn(n,a,l),it(n,l,a)}return n},Po=(t,e,n=3)=>{try{return{order:Na(t),impossible:!1}}catch(r){if(r instanceof ut){const o=r.cyclicDependency;return t.get(o[0])?.delete(o[1]),console.warn("cyclc dependency detected: ",o.join(" --front-of--> "),`breaking link ${o[0]} --front-of--> ${o[1]}`),{order:Po(t,e,n-1).order,impossible:!0}}else throw r}};class Xa extends ho{}const Wn=(t,e)=>{e.poly([w({}),w({x:t.x}),w({x:t.x,y:t.y}),w({y:t.y})]).poly([w({}),w({z:t.z}),w({y:t.y,z:t.z}),w({y:t.y})]).poly([w({x:t.x}),w({x:t.x,z:t.z}),w(t),w({x:t.x,y:t.y})]).poly([w({z:t.z}),w({x:t.x,z:t.z}),w({x:t.x,y:t.y,z:t.z}),w({y:t.y,z:t.z})])},Yn=(t,e)=>{const n=new j;return Wn(t,n),n.stroke({width:.5,color:e,alpha:1}),n.eventMode="static",n.on("pointerenter",()=>{n.fill({color:e,alpha:.5})}),n.on("pointerleave",()=>{n.clear(),Wn(t,n),n.stroke({width:.5,color:e,alpha:1})}),n},Ga={head:"rgba(255,184,0)",wall:"rgba(128,200,0)",portal:"rgba(255,0,255)",stopAutowalk:"rgba(255,128,128)"};class qa{#t;constructor(e){const n=Ga[e.type]??"rgba(255,255,255)";if(this.#t=new g({label:`ItemBoundingBoxRenderer ${e.id}`}),X("portal")(e)){const o=w(e.config.relativePoint);this.#t.addChild(new j().circle(o.x,o.y,5).stroke(n)),this.#t.addChild(new j().circle(o.x,o.y,2).fill(n))}this.#t.addChild(new j({label:"objectOrigin"}).circle(0,0,2).fill(n)),this.#t.addChild(Yn(e.aabb,n)),e.renderAabb&&this.#t.addChild(Yn(e.renderAabb,"rgba(184, 184, 255)")),this.#t.eventMode="static";let r;this.#t.on("pointerenter",()=>{if(r!==void 0)return;const o=`${e.id} ${e.type}
@(${e.state.position.x}, ${e.state.position.y}, ${e.state.position.z})}
#(${e.aabb.x}, ${e.aabb.y}, ${e.aabb.z})}`;this.#t.addChild(r=new bs({text:o,style:{fill:n,fontSize:6,fontFamily:"Menlo"}})),r.resolution=4}),this.#t.on("pointerleave",()=>{r!==void 0&&(this.#t.removeChild(r),r=void 0)})}tick(e){}destroy(){this.#t.destroy({children:!0})}get container(){return this.#t}}class Wa{#t;#n;#e;constructor(e,n){this.#n=new g({label:`ItemPositionRenderer ${e.id}`,children:[n.container]}),this.#e=n,this.#t=e,this.#r()}#r(){const e=w(this.#t.state.position);this.#n.x=e.x,this.#n.y=e.y}tick(e){this.#e?.tick(e),e.movedItems.has(this.#t)&&this.#r()}destroy(){this.#n.destroy({children:!0}),this.#e?.destroy()}get container(){return this.#n}}const Ya=(t,e)=>{const n=e.getLocalBounds(),r=an.create({width:n.maxX-n.minX,height:n.maxY-n.minY});return e.x-=n.minX,e.y-=n.minY,t.render({container:e,target:r}),new Te({texture:r,label:"shadowMaskSprite (of renderTexture)",pivot:{x:-n.minX,y:-n.minY}})},Jn=(t,e,n)=>{const r=n&&{x:n.x??1,y:n.y??1},o=h({...typeof e=="string"?{textureId:e}:e,times:r});return o instanceof Te?o:Ya(t,o)};class Ja{constructor(e,n,r){this.item=e,this.room=n,this.pixiRenderer=r;const{userSettings:{displaySettings:{showShadowMasks:o}}}=C.getState();o||(this.#t.filters=new hs({alpha:.5}));const{shadowMask:{spriteOptions:i}}=e;if(i){const{times:s}=e.config,a=Jn(r,i,s);e.shadowMask.relativeTo==="top"&&(a.y-=e.aabb.z),s&&(a.y-=((s.z??1)-1)*L.h),this.#t.addChild(a),o||(this.#t.mask=a)}this.#t.addChild(this.#n)}#t=new g({label:"ItemShadowRenderer"});#n=new g({label:"shadows"});#e={};destroy(){this.#t.destroy(!0)}tick({movedItems:e,progression:n}){const r=e.has(this.item),o=this.item.state.position.z+this.item.aabb.z,i=z(k(this.room.items)).filter(function(c){return c.shadowCastTexture!==void 0}),s={id:this.item.id,state:{position:{...this.item.state.position,z:o}},aabb:{...this.item.aabb,z:Xi}},a=Object.groupBy(i,l=>{const c=this.#e[l.id]!==void 0,u=e.has(l);return!r&&!u?c?"keepUnchanged":"noShadow":tn(s,l)?c?"update":"create":"noShadow"});for(const l of Gt(a.keepUnchanged,a.update))this.#e[l.id].renderedOnProgression=n;if(a.create)for(const l of a.create){const{times:c}=l.config,u=Jn(this.pixiRenderer,l.shadowCastTexture,c);u.label=l.id,this.#n.addChild(u),this.#e[l.id]={sprite:u,renderedOnProgression:n}}for(const l of Gt(a.create,a.update)){const{sprite:c}=this.#e[l.id],u=w({...Xe(l.state.position,this.item.state.position),z:this.item.aabb.z});c.x=u.x,c.y=u.y}for(const[l,{sprite:c,renderedOnProgression:u}]of ht(this.#e))u!==n&&(c.destroy(),delete this.#e[l]);this.#t.visible=(a.keepUnchanged?.length??0)+(a.update?.length??0)+(a.create?.length??0)>0}get container(){return this.#t}}const Za=(t,e,n,r)=>`${t}${r?".dark":""}.wall.${e}.${n}`,Qa=(t,e,n)=>{const o=oe().textures[`door.frame.${t.planet}.${e}.near`]!==void 0?t.planet:"generic",i=t.color.shade==="dimmed"&&oe().textures[`door.frame.${o}.dark.${e}.${n}`]!==void 0;return`door.frame.${o}${i?".dark":""}.${e}.${n}`},st=t=>D(({subject:e})=>Gi(e)?h({...typeof t=="string"?{textureId:t}:t,times:e.config.times}):h(t)),D=t=>({subject:e,currentlyRenderedProps:n,gameState:r,renderContext:o})=>n===void 0?{container:t({subject:e,gameState:r,previousRendering:null,renderContext:o}),renderProps:qe}:"no-update";function*Ka({config:{direction:t,inHiddenWall:e,height:n}},r){const o=xt(t),i=o==="y"?1:16;function*s(a){if(e){if(n!==0){const l=h({textureId:`generic.door.floatingThreshold.${o}`,...lt(a,{y:-12*n})});l.filters=Jt(r,o==="x"?"towards":"right",!0),yield l}}else{yield h({pivot:{x:i,y:9},textureId:"generic.door.legs.base",...lt(a,{})});for(let l=1;l<n;l++)yield h({pivot:{x:i,y:9},textureId:"generic.door.legs.pillar",...lt(a,{y:-l*L.h})})}}yield*s(T({...te,[o]:1})),yield*s(te),e||(yield h({pivot:{x:16,y:L.h*n+13},textureId:`generic.door.legs.threshold.double.${o}`,...T({...te,[o]:1})}))}const Bo=(t,e)=>{const n=xt(t),r=Ge(n),o=8;return t==="towards"||t==="right"?w({[r]:e[r]-o}):te},el=D(({subject:t,renderContext:{room:e}})=>He(Ka(t,e),new g({filters:ee(e),...Bo(t.config.direction,t.aabb)}))),tl=D(({subject:{config:{direction:t,part:e},aabb:n},renderContext:{room:r}})=>{const o=xt(t);return h({textureId:Qa(r,o,e),filter:ee(r),...Bo(t,n)})}),Mt={animationId:"bubbles.cold"},we=({top:t,bottom:e="homingBot",filter:n})=>{const r=new g({filters:n});r.addChild(h(e));const o=h(t);return o.y=-12,r.addChild(o),r},nl=({top:t,bottom:e})=>{const n=new g;return n.addChild(e),t.y=-12,n.addChild(t),n},rl=`#version 300 es
