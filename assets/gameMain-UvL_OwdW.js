const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WebGPURenderer-BQ952Iz1.js","assets/App-BFU-macF.js","assets/index-6ZhtaJ-B.js","assets/index-CGQ8pOyP.css","assets/colorToUniform-KTpA7KSL.js","assets/SharedSystems-B-fLdIWm.js","assets/Graphics-B1AWS3GE.js","assets/swopCharacters-Csjo9LJH.js","assets/WebGLRenderer-BgVIxLrw.js"])))=>i.map(i=>d[i]);
import{aO as pi,a8 as mi,I as gi,L as ge,N as $,t as Ao,J as de,E as C,g as Bt,f as bi,C as b,d as We,v as It,a6 as w,D as en,_ as Ae,T as Ve,U as vi,V as yi,aP as xi,aQ as wi,aR as Ci,q as Si,aS as at,ae as ne,aT as Ti,aU as Q,ai as Mo,aV as ae,aW as Do,ar as Lo,al as y,o as ee,ac as O,aX as ki,aY as Ii,aZ as Oi,ag as F,a_ as Me,a$ as Pi,b0 as zo,b1 as Ro,b2 as _i,b3 as xt,ad as E,b4 as Bi,i as le,b5 as Fi,b6 as Ai,b7 as Mi,b8 as Di,as as Uo,ah as Ft,b9 as An,ba as Li,bb as nt,bc as Eo,bd as be,be as At,p as ot,at as ve,af as tn,an as ie,bf as zi,bg as Ri,bh as Ui,bi as Ei,bj as gn,a9 as $o,bk as Xe,aj as $i,bl as Ni,bm as bn,bn as Vi,bo as Xi,bp as No,bq as ji,br as Hi,bs as Gi,ao as Ot,bt as wt,bu as qi,bv as Wi,bw as Ji,b as Je,bx as je,by as x,bz as Te,bA as Yi,bB as Zi,bC as Qi,bD as Vo,Y as Oe,bE as Ki,av as es,bF as ts,bG as ns,bH as os,bI as rs,au as Mn,bJ as is}from"./App-BFU-macF.js";import{l as nn,j as Pt,g as Dn,k as Ln,h as M,p as T,m as ye,n as vn,q as ss,r as as,t as on,u as Ye,v as Ct,c as yn,w as z,i as G,x as Xo,y as jo,z as Ho,A as fe,B as Mt,C as xn,D as De,E as ls,F as cs,G as us,H as rn,I as ds,J as lt,K as fs,L as hs,M as ps,a as xe,N as Go,O as qo,P as zn,Q as he,R as Wo,S as Jo,f as ms,T as Yo,U as gs,b as Le,V as Et,W as ct,X as bs,Y as ze,Z as Rn,_ as vs,$ as wn,a0 as ys,a1 as rt,a2 as xs,a3 as ws,a4 as Cs,a5 as Ss,a6 as Un,a7 as Zo,e as Qo,o as Ko,a8 as Ts,a9 as En,aa as ks,s as Ze,ab as Is,ac as $t,ad as S,ae as Os,af as Ps,ag as _s,ah as $n,ai as Dt,aj as Bs,ak as Fs,al as Nt,am as Nn}from"./swopCharacters-Csjo9LJH.js";import{S as As,G as H}from"./Graphics-B1AWS3GE.js";import{g as Ms,_ as Vn}from"./index-6ZhtaJ-B.js";var ut={},Xn;function Ds(){if(Xn)return ut;Xn=1;var t=pi(),e=t.mark(i),n=mi(),o=n.wrapWithIterableIterator,r=n.ensureIterable;function i(){var a,l,c,u,d,f,h=arguments;return t.wrap(function(v){for(;;)switch(v.prev=v.next){case 0:for(a=h.length,l=new Array(a),c=0;c<a;c++)l[c]=h[c];u=0,d=l;case 2:if(!(u<d.length)){v.next=8;break}return f=d[u],v.delegateYield(r(f),"t0",5);case 5:u++,v.next=2;break;case 8:case"end":return v.stop()}},e)}ut.__concat=i;var s=o(i);return ut.concat=s,ut}var Vt,jn;function Ls(){return jn||(jn=1,Vt=Ds().concat),Vt}var zs=Ls();const sn=Ms(zs),er=class an extends gi{constructor(e){e={...an.defaultOptions,...e},super(e),this.enabled=!0,this._state=As.for2d(),this.blendMode=e.blendMode,this.padding=e.padding,typeof e.antialias=="boolean"?this.antialias=e.antialias?"on":"off":this.antialias=e.antialias,this.resolution=e.resolution,this.blendRequired=e.blendRequired,this.clipToViewport=e.clipToViewport,this.addResource("uTexture",0,1)}apply(e,n,o,r){e.applyFilter(this,n,o,r)}get blendMode(){return this._state.blendMode}set blendMode(e){this._state.blendMode=e}static from(e){const{gpu:n,gl:o,...r}=e;let i,s;return n&&(i=ge.from(n)),o&&(s=$.from(o)),new an({gpuProgram:i,glProgram:s,...r})}};er.defaultOptions={blendMode:"normal",resolution:1,padding:0,antialias:"off",blendRequired:!1,clipToViewport:!0};let W=er;var Rs=`
...
`;class ia extends W{constructor(){const e=$.from({vertex:it,fragment:ra,name:"halfbrite-filter"});super({glProgram:e,resources:{}})}}const Dr=({basic:t,dimmed:e})=>({replaceLight:t,replaceDark:e}),Lr=t=>Dr(kn[t.color.hue][t.color.shade].main),zr=t=>new we({lightBeige:g.lightGrey,redShadow:g.shadow,pink:g.lightGrey,moss:g.lightGrey,midRed:g.midGrey,highlightBeige:g.lightGrey,...t&&Lr(t)}),sa=new we({midGrey:g.midRed,lightGrey:g.lightBeige,white:g.highlightBeige,metallicBlue:g.redShadow,pink:g.midRed,moss:g.midRed,replaceDark:g.midRed,replaceLight:g.lightBeige}),aa=t=>new we({replaceLight:t,replaceDark:pe(t)}),un=(t,e,n)=>n?new we(Dr(kn[t.color.hue][t.color.shade].edges[e])):new R(In(t.color).edges[e].original),oe=t=>new we(Lr(t)),Jn=new ia,me=Mo,Yn={x:.5,y:1},Zn=t=>typeof t!="string"&&Object.hasOwn(t,"animationId"),p=t=>{if(typeof t=="string")return p({textureId:t});{const{anchor:e,flipX:n,pivot:o,x:r,y:i,filter:s,times:a,label:l}=t;let c;if(Zn(t)?c=la(t):c=new Ae(ae().textures[t.textureId]),a!==void 0){const u={x:1,y:1,z:1,...a},d=new b({label:l??"timesXyz"});for(let{x:f}=u;f>=1;f--)for(let{y:h}=u;h>=1;h--)for(let m=1;m<=u.z;m++){const v=p({...t,times:void 0,label:`(${f},${h},${m})`}),P=T({x:f-1,y:h-1,z:m-1});v.x+=P.x,v.y+=+P.y,d.addChild(v)}return d}if(e===void 0&&o===void 0)if(Zn(t))c.anchor=Yn;else{const u=ae().data.frames[t.textureId].frame;u.pivot!==void 0?c.pivot=u.pivot:c.anchor=Yn}else e!==void 0&&(c.anchor=e),o!==void 0&&(c.pivot=o);return r!==void 0&&(c.x=r),i!==void 0&&(c.y=i),s!==void 0&&(c.filters=s),l!==void 0&&(c.label=l),c.eventMode="static",n===!0&&(c.scale.x=-1),c}};function la({animationId:t,reverse:e,playOnce:n}){const r=ae().animations[t].map(s=>({texture:s,time:Do}));e&&r.reverse();const i=new Qe(r);return i.animationSpeed=Lo.animations[t].animationSpeed,i.play(),n!==void 0&&(i.loop=!1,i.onComplete=()=>{i.stop(),n==="and-destroy"&&(i.visible=!1)}),i}const ca=`#version 300 es
