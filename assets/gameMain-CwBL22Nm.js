const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WebGPURenderer-b5BHyJwM.js","assets/App-D5ZBl2SB.js","assets/index-B11hJYUH.js","assets/index-DbnZwkj2.css","assets/colorToUniform-KTpA7KSL.js","assets/SharedSystems-B2obbPyZ.js","assets/Graphics-Cfqt6GQY.js","assets/swopCharacters-_ZVDjU_x.js","assets/WebGLRenderer-Cv5R3F6-.js"])))=>i.map(i=>d[i]);
import{aM as ti,a7 as ni,H as ri,K as he,L as R,q as br,I as le,E as w,f as St,e as oi,C as b,d as je,v as xt,a5 as y,D as jt,Z as Oe,T as Ee,U as ii,V as si,aN as ai,aO as li,aP as ci,n as ui,aQ as tt,ad as re,aR as di,aS as J,aT as fi,aU as oe,aV as vr,ap as xr,aj as x,o as Z,ab as O,aW as hi,aX as pi,af as B,aY as Pe,aZ as mi,a_ as yr,a$ as an,b0 as gi,b1 as ht,ac as L,b2 as bi,i as ie,b3 as vi,b4 as xi,b5 as yi,b6 as wi,aq as wr,ag as It,b7 as Ci,b8 as Ze,b9 as Cr,ba as pe,bb as kt,p as Ke,ar as Be,ae as qt,bc as xn,al as te,bd as Ti,be as Si,bf as Ii,bg as ki,a8 as Tr,bh as $e,ah as Oi,bi as _i,bj as ln,bk as Pi,bl as Bi,bm as Sr,bn as Ai,bo as Fi,bp as Di,am as yt,bq as pt,br as Mi,bs as zi,bt as Li,a as qe,bu as Ri,bv as Ui,bw as Ei,bx as Ne,by as $i,bz as Ni,bA as Vi,bB as Ir,X as Ce,bC as Hi,at as Xi,bD as ji,bE as yn,bF as wn,bG as qi,as as Cn,bH as Gi}from"./App-D5ZBl2SB.js";import{l as Gt,j as wt,g as Tn,k as Sn,h as M,p as T,m as me,n as cn,q as Wi,r as Ji,t as Wt,u as Ct,v as mt,c as un,w as H,i as X,x as kr,y as Or,z as _r,A as ce,B as Ot,C as dn,D as Yi,E as Ae,F as Zi,G as Ki,H as Qi,I as Jt,J as es,K as nt,L as ts,M as ns,N as rs,a as ge,O as Pr,P as Br,Q as In,R as ue,S as Ar,T as Fr,f as os,U as Dr,V as Mr,W as is,b as Fe,X as Dt,Y as rt,Z as ss,_ as De,$ as kn,a0 as as,a1 as fn,a2 as ls,a3 as cs,a4 as us,a5 as ds,a6 as fs,a7 as On,a8 as zr,e as Lr,o as Rr,a9 as hs,aa as _n,s as Ge,ab as ps,ac as Mt,ad as C,ae as ms,af as gs,ag as bs,ah as Pn,ai as _t,aj as vs}from"./swopCharacters-_ZVDjU_x.js";import{S as xs,G as V}from"./Graphics-Cfqt6GQY.js";import{g as ys,_ as Bn}from"./index-B11hJYUH.js";var ot={},An;function ws(){if(An)return ot;An=1;var t=ti(),e=t.mark(i),n=ni(),r=n.wrapWithIterableIterator,o=n.ensureIterable;function i(){var a,l,c,u,d,f,h=arguments;return t.wrap(function(v){for(;;)switch(v.prev=v.next){case 0:for(a=h.length,l=new Array(a),c=0;c<a;c++)l[c]=h[c];u=0,d=l;case 2:if(!(u<d.length)){v.next=8;break}return f=d[u],v.delegateYield(o(f),"t0",5);case 5:u++,v.next=2;break;case 8:case"end":return v.stop()}},e)}ot.__concat=i;var s=r(i);return ot.concat=s,ot}var zt,Fn;function Cs(){return Fn||(Fn=1,zt=ws().concat),zt}var Ts=Cs();const Yt=ys(Ts),Ur=class Zt extends ri{constructor(e){e={...Zt.defaultOptions,...e},super(e),this.enabled=!0,this._state=xs.for2d(),this.blendMode=e.blendMode,this.padding=e.padding,typeof e.antialias=="boolean"?this.antialias=e.antialias?"on":"off":this.antialias=e.antialias,this.resolution=e.resolution,this.blendRequired=e.blendRequired,this.clipToViewport=e.clipToViewport,this.addResource("uTexture",0,1)}apply(e,n,r,o){e.applyFilter(this,n,r,o)}get blendMode(){return this._state.blendMode}set blendMode(e){this._state.blendMode=e}static from(e){const{gpu:n,gl:r,...o}=e;let i,s;return n&&(i=he.from(n)),r&&(s=R.from(r)),new Zt({gpuProgram:i,glProgram:s,...o})}};Ur.defaultOptions={blendMode:"normal",resolution:1,padding:0,antialias:"off",blendRequired:!1,clipToViewport:!0};let j=Ur;var Ss=`
...
fn mainFragment(
  @location(0) uv: vec2<f32>
   ...
   return out;
}`;class S extends j{constructor(e){const n=e.gpu,r=Dn({source:ks,...n}),o=he.from({vertex:{source:r,entryPoint:"mainVertex"},fragment:{source:r,entryPoint:"mainFragment"}}),i=e.gl,s=Dn({source:Ss,...i}),a=R.from({vertex:Is,fragment:s}),l=new br({uBlend:{value:1,type:"f32"}});super({gpuProgram:o,glProgram:a,blendRequired:!0,resources:{blendUniforms:l,uBackTexture:le.EMPTY}})}}function Dn(t){const{source:e,functions:n,main:r}=t;return e.replace("{FUNCTIONS}",n).replace("{MAIN}",r)}const hn=`
	...
	`;class Er extends S{constructor(){super({gl:{functions:`
            ...
            `},gpu:{functions:`
                ...
                `}})}}io.extension={name:"vivid-light",type:w.BlendMode};const Kt=[];St.handleByNamedList(w.Environment,Kt);async function Os(t){if(!t)for(let e=0;e<Kt.length;e++){const n=Kt[e];if(n.value.test()){await n.value.load();return}}}let Me;function _s(){if(typeof Me=="boolean")return Me;try{Me=new Function("param1","param2","param3","return param1[param2] === param3;")({a:"b"},"a","b")===!0}catch{Me=!1}return Me}var so=(t=>(t[t.NONE=0]="NONE",t[t.COLOR=16384]="COLOR",t[t.STENCIL=1024]="STENCIL",t[t.DEPTH=256]="DEPTH",t[t.COLOR_DEPTH=16640]="COLOR_DEPTH",t[t.COLOR_STENCIL=17408]="COLOR_STENCIL",t[t.DEPTH_STENCIL=1280]="DEPTH_STENCIL",t[t.ALL=17664]="ALL",t))(so||{});class Ps{constructor(e){this.items=[],this._name=e}emit(e,n,r,o,i,s,a,l){const{name:c,items:u}=this;for(let d=0,f=u.length;d<f;d++)u[d][c](e,n,r,o,i,s,a,l);return this}add(e){return e[this._name]&&(this.remove(e),this.items.push(e)),this}remove(e){const n=this.items.indexOf(e);return n!==-1&&this.items.splice(n,1),this}contains(e){return this.items.indexOf(e)!==-1}removeAll(){return this.items.length=0,this}destroy(){this.removeAll(),this.items=null,this._name=null}get empty(){return this.items.length===0}get name(){return this._name}}const Bs=["init","destroy","contextChange","resolutionChange","resetState","renderEnd","renderStart","render","update","postrender","prerender"],ao=class lo extends oi{constructor(e){super(),this.runners=Object.create(null),this.renderPipes=Object.create(null),this._initOptions={},this._systemsHash=Object.create(null),this.type=e.type,this.name=e.name,this.config=e;const n=[...Bs,...this.config.runners??[]];this._addRunners(...n),this._unsafeEvalCheck()}async init(e={}){const n=e.skipExtensionImports===!0?!0:e.manageImports===!1;await Os(n),this._addSystems(this.config.systems),this._addPipes(this.config.renderPipes,this.config.renderPipeAdaptors);for(const r in this._systemsHash)e={...this._systemsHash[r].constructor.defaultOptions,...e};e={...lo.defaultOptions,...e},this._roundPixels=e.roundPixels?1:0;for(let r=0;r<this.runners.init.items.length;r++)await this.runners.init.items[r].init(e);this._initOptions=e}render(e,n){let r=e;if(r instanceof b&&(r={container:r},n&&(je(xt,"passing a second argument is deprecated, please use render options instead"),r.target=n.renderTexture)),r.target||(r.target=this.view.renderTarget),r.target===this.view.renderTarget&&(this._lastObjectRendered=r.container,r.clearColor??(r.clearColor=this.background.colorRgba),r.clear??(r.clear=this.background.clearBeforeRender)),r.clearColor){const o=Array.isArray(r.clearColor)&&r.clearColor.length===4;r.clearColor=o?r.clearColor:y.shared.setValue(r.clearColor).toArray()}r.transform||(r.container.updateLocalTransform(),r.transform=r.container.localTransform),r.container.enableRenderGroup(),this.runners.prerender.emit(r),this.runners.renderStart.emit(r),this.runners.render.emit(r),this.runners.renderEnd.emit(r),this.runners.postrender.emit(r)}resize(e,n,r){const o=this.view.resolution;this.view.resize(e,n,r),this.emit("resize",this.view.screen.width,this.view.screen.height,this.view.resolution),r!==void 0&&r!==o&&this.runners.resolutionChange.emit(r)}clear(e={}){const n=this;e.target||(e.target=n.renderTarget.renderTarget),e.clearColor||(e.clearColor=this.background.colorRgba),e.clear??(e.clear=so.ALL);const{clear:r,clearColor:o,target:i}=e;y.shared.setValue(o??this.background.colorRgba),n.renderTarget.clear(i,r,y.shared.toArray())}get resolution(){return this.view.resolution}set resolution(e){this.view.resolution=e,this.runners.resolutionChange.emit(e)}get width(){return this.view.texture.frame.width}get height(){return this.view.texture.frame.height}get canvas(){return this.view.canvas}get lastObjectRendered(){return this._lastObjectRendered}get renderingToScreen(){return this.renderTarget.renderingToScreen}get screen(){return this.view.screen}_addRunners(...e){e.forEach(n=>{this.runners[n]=new Ps(n)})}_addSystems(e){let n;for(n in e){const r=e[n];this._addSystem(r.value,r.name)}}_addSystem(e,n){const r=new e(this);if(this[n])throw new Error(`Whoops! The name "${n}" is already in use`);this[n]=r,this._systemsHash[n]=r;for(const o in this.runners)this.runners[o].add(r);return this}_addPipes(e,n){const r=n.reduce((o,i)=>(o[i.name]=i.value,o),{});e.forEach(o=>{const i=o.value,s=o.name,a=r[s];this.renderPipes[s]=new i(this,a?new a:null)})}destroy(e=!1){this.runners.destroy.items.reverse(),this.runners.destroy.emit(e),Object.values(this.runners).forEach(n=>{n.destroy()}),this._systemsHash=null,this.renderPipes=null}generateTexture(e){return this.textureGenerator.generateTexture(e)}get roundPixels(){return!!this._roundPixels}_unsafeEvalCheck(){if(!_s())throw new Error("Current environment does not allow unsafe-eval, please use pixi.js/unsafe-eval module to enable support.")}resetState(){this.runners.resetState.emit()}};ao.defaultOptions={resolution:1,failIfMajorPerformanceCaveat:!1,roundPixels:!1};let co=ao,it;function As(t){return it!==void 0||(it=(()=>{const e={stencil:!0,failIfMajorPerformanceCaveat:t??co.defaultOptions.failIfMajorPerformanceCaveat};try{if(!jt.get().getWebGLRenderingContext())return!1;let r=jt.get().createCanvas().getContext("webgl",e);const o=!!r?.getContextAttributes()?.stencil;if(r){const i=r.getExtension("WEBGL_lose_context");i&&i.loseContext()}return r=null,o}catch{return!1}})()),it}let st;async function Fs(t={}){return st!==void 0||(st=await(async()=>{const e=jt.get().getNavigator().gpu;if(!e)return!1;try{return await(await e.requestAdapter(t)).requestDevice(),!0}catch{return!1}})()),st}const Mn=["webgl","webgpu","canvas"];async function Ds(t){let e=[];t.preference?(e.push(t.preference),Mn.forEach(i=>{i!==t.preference&&e.push(i)})):e=Mn.slice();let n,r={};for(let i=0;i<e.length;i++){const s=e[i];if(s==="webgpu"&&await Fs()){const{WebGPURenderer:a}=await Bn(async()=>{const{WebGPURenderer:l}=await import("./WebGPURenderer-b5BHyJwM.js");return{WebGPURenderer:l}},__vite__mapDeps([0,1,2,3,4,5,6,7]));n=a,r={...t,...t.webgpu};break}else if(s==="webgl"&&As(t.failIfMajorPerformanceCaveat??co.defaultOptions.failIfMajorPerformanceCaveat)){const{WebGLRenderer:a}=await Bn(async()=>{const{WebGLRenderer:l}=await import("./WebGLRenderer-Cv5R3F6-.js");return{WebGLRenderer:l}},__vite__mapDeps([8,1,2,3,4,5,6,7]));n=a,r={...t,...t.webgl};break}else if(s==="canvas")throw r={...t},new Error("CanvasRenderer is not yet implemented")}if(delete r.webgpu,delete r.webgl,!n)throw new Error("No available renderer for the current environment");const o=new n;return await o.init(r),o}const uo="8.8.1";class fo{static init(){globalThis.__PIXI_APP_INIT__?.(this,uo)}static destroy(){}}fo.extension=w.Application;class Ms{constructor(e){this._renderer=e}init(){globalThis.__PIXI_RENDERER_INIT__?.(this._renderer,uo)}destroy(){this._renderer=null}}Ms.extension={type:[w.WebGLSystem,w.WebGPUSystem],name:"initHook",priority:-10};const ho=class Qt{constructor(...e){this.stage=new b,e[0]!==void 0&&je(xt,"Application constructor options are deprecated, please use Application.init() instead.")}async init(e){e={...e},this.renderer=await Ds(e),Qt._plugins.forEach(n=>{n.init.call(this,e)})}render(){this.renderer.render({container:this.stage})}get canvas(){return this.renderer.canvas}get view(){return je(xt,"Application.view is deprecated, please use Application.canvas instead."),this.renderer.canvas}get screen(){return this.renderer.screen}destroy(e=!1,n=!1){const r=Qt._plugins.slice(0);r.reverse(),r.forEach(o=>{o.destroy.call(this)}),this.stage.destroy(n),this.stage=null,this.renderer.destroy(e),this.renderer=null}};ho._plugins=[];let po=ho;St.handleByList(w.Application,po._plugins);St.add(fo);var zs=`in vec2 aPosition;
out vec2 vTextureCoord;
...
`;class be extends j{constructor(e){const n=Object.keys(e).length,r=R.from({vertex:Qe,fragment:Hs.replace(/\$\{SWOP_COUNT\}/g,n.toFixed(0)),name:"palette-swop-filter"});super({glProgram:r,resources:{colorReplaceUniforms:{uOriginal:{value:new Float32Array(3*n),type:"vec3<f32>",size:n},uReplacement:{value:new Float32Array(3*n),type:"vec3<f32>",size:n}}}});const o=this.resources.colorReplaceUniforms.uniforms;Object.entries(e).forEach(([i,s],a)=>{g[i].toArray().forEach((l,c)=>{o.uOriginal[a*3+c]=l}),s.toArray().forEach((l,c)=>{o.uReplacement[a*3+c]=l})})}}const Xs=`precision mediump float;
in vec2 vTextureCoord;
out vec4 finalColor;
...
`;class qs extends j{constructor(){const e=R.from({vertex:Qe,fragment:js,name:"halfbrite-filter"});super({glProgram:e,resources:{}})}}const xo=({basic:t,dimmed:e})=>({replaceLight:t,replaceDark:e}),yo=t=>xo(gn[t.color.hue][t.color.shade].main),wo=t=>new be({lightBeige:g.lightGrey,redShadow:g.shadow,pink:g.lightGrey,moss:g.lightGrey,midRed:g.midGrey,highlightBeige:g.lightGrey,...t&&yo(t)}),Gs=new be({midGrey:g.midRed,lightGrey:g.lightBeige,white:g.highlightBeige,metallicBlue:g.redShadow,pink:g.midRed,moss:g.midRed,replaceDark:g.midRed,replaceLight:g.lightBeige}),Ws=t=>new be({replaceLight:t,replaceDark:de(t)}),en=(t,e,n)=>n?new be(xo(gn[t.color.hue][t.color.shade].edges[e])):new z(bn(t.color).edges[e].original),Q=t=>new be(yo(t)),Rn=new qs,fe=fi,Un={x:.5,y:1},En=t=>typeof t!="string"&&Object.hasOwn(t,"animationId"),p=t=>{if(typeof t=="string")return p({textureId:t});{const{anchor:e,flipX:n,pivot:r,x:o,y:i,filter:s,times:a,label:l}=t;let c;if(En(t)?c=Js(t):c=new Oe(oe().textures[t.textureId]),a!==void 0){const u={x:1,y:1,z:1,...a},d=new b({label:l??"timesXyz"});for(let{x:f}=u;f>=1;f--)for(let{y:h}=u;h>=1;h--)for(let m=1;m<=u.z;m++){const v=p({...t,times:void 0,label:`(${f},${h},${m})`}),k=T({x:f-1,y:h-1,z:m-1});v.x+=k.x,v.y+=+k.y,d.addChild(v)}return d}if(e===void 0&&r===void 0)if(En(t))c.anchor=Un;else{const u=oe().data.frames[t.textureId].frame;u.pivot!==void 0?c.pivot=u.pivot:c.anchor=Un}else e!==void 0&&(c.anchor=e),r!==void 0&&(c.pivot=r);return o!==void 0&&(c.x=o),i!==void 0&&(c.y=i),s!==void 0&&(c.filters=s),l!==void 0&&(c.label=l),c.eventMode="static",n===!0&&(c.scale.x=-1),c}};function Js({animationId:t,reverse:e,playOnce:n}){const o=oe().animations[t].map(s=>({texture:s,time:vr}));e&&o.reverse();const i=new We(o);return i.animationSpeed=xr.animations[t].animationSpeed,i.play(),n!==void 0&&(i.loop=!1,i.onComplete=()=>{i.stop(),n==="and-destroy"&&(i.visible=!1)}),i}const Ys=`#version 300 es
...
`;class ke extends j{constructor({outlineColor:e,upscale:n,lowRes:r}){const o=R.from({vertex:Qe,fragment:Ys,name:"outline-filter"});super({glProgram:o,padding:n,resources:{colorReplaceUniforms:{uOutline:{value:new Float32Array(3),type:"vec3<f32>"},uOutlineWidth:{value:new Float32Array(1),type:"f32"}}}});const i=this.resources.colorReplaceUniforms.uniforms,[s,a,l]=e.toArray();i.uOutline[0]=s,i.uOutline[1]=a,i.uOutline[2]=l,i.uOutlineWidth[0]=n,r&&(this.resolution=1/n,this.padding=n,i.uOutlineWidth[0]=1)}}const Y=new ke({outlineColor:g.pureBlack,upscale:x.getState().gameMenus.upscale.gameEngineUpscale,lowRes:!0}),Ve=new z,$n=new z,tn=new z,Nn=new z(g.moss),He=new z,W=[Ve,Y],Zs=[He,Y],Ks=[Y,tn],at={original:[Y,He],colourised:{head:{active:[Y,new z(Te.head)],inactive:[Y,new z(de(Te.head))]},heels:{active:[Y,new z(Te.heels)],inactive:[Y,new z(de(Te.heels))]}}},ve=13,Qs=2;class ea{constructor(e){this.renderContext=e;const{inputDirectionMode:n}=e;this.arrowSprites={away:p({textureId:"hud.char.↗",anchor:{x:.5,y:.5},x:ve,y:-13,filter:W}),right:p({textureId:"hud.char.↘",anchor:{x:.5,y:.5},x:ve,y:ve,filter:W}),towards:p({textureId:"hud.char.↙",anchor:{x:.5,y:.5},x:-13,y:ve,filter:W}),left:p({textureId:"hud.char.↖",anchor:{x:.5,y:.5},x:-13,y:-13,filter:W}),...n!=="4-way"?{awayRight:p({textureId:"hud.char.➡",anchor:{x:.5,y:.5},x:ve*Math.SQRT2,filter:W}),towardsRight:p({textureId:"hud.char.⬇",anchor:{x:.5,y:.5},y:ve*Math.SQRT2,filter:W}),towardsLeft:p({textureId:"hud.char.⬅",anchor:{x:.5,y:.5},x:-13*Math.SQRT2,filter:W}),awayLeft:p({textureId:"hud.char.⬆",anchor:{x:.5,y:.5},y:-13*Math.SQRT2,filter:W})}:{}},this.container.addChild(this.#e),this.container.addChild(new V().circle(0,0,24).fill("#00000000"));for(const r of Z(this.arrowSprites))this.container.addChild(r);this.container.on("pointerenter",this.handlePointerEnter),this.container.on("globalpointermove",this.usePointerLocation),this.container.on("pointerup",this.stopCurrentPointer),this.container.on("pointerupoutside",this.stopCurrentPointer)}container=new b({label:"OnScreenJoystick",eventMode:"static"});arrowSprites;#e=p({textureId:"joystick",anchor:{x:.5,y:.5},y:1});#n;handlePointerEnter=e=>{this.#n!==void 0&&this.stopCurrentPointer(),this.#n=e.pointerId,this.usePointerLocation(e)};stopCurrentPointer=()=>{this.#n=void 0,this.renderContext.inputStateTracker.hudInputState.directionVector=O};usePointerLocation=e=>{if(e.pointerId!==this.#n)return;const n=hi(x.getState()),{x:r,y:o}=this.container,{x:i,y:s}=e,{width:a,height:l}=this.container.getLocalBounds(),c=(i/n-r)/(a/2),u=(s/n-o)/(l/2),d=pi({x:-c,y:-u}),f=B(d,Qs);this.renderContext.inputStateTracker.hudInputState.directionVector=f};tick(){const{renderContext:{inputStateTracker:{directionVector:e},colourise:n}}=this;if(x.getState().gameMenus.openMenus.length>0){this.stopCurrentPointer();return}const o=Pe(e)>mi?yr(e):void 0;for(const[i,s]of an(this.arrowSprites))s.filters=i===o?Zs:W;this.#e.filters=n?fe:Ve}destroy(){this.stopCurrentPointer(),this.container.off("pointerenter",this.handlePointerEnter),this.container.off("globalpointermove",this.usePointerLocation),this.container.off("pointerup",this.stopCurrentPointer),this.container.off("pointerupoutside",this.stopCurrentPointer),this.container.destroy()}}const nn={colourised:{jump:g.pastelBlue,fire:g.highlightBeige,carry:g.moss,carryAndJump:g.midRed,menu:g.lightGrey},zx:{jump:J.zxBlue,fire:J.zxYellow,carry:J.zxGreen,carryAndJump:J.zxRed,menu:J.zxWhite}};function Je(t,e){const n=e||new b;for(const r of t)n.addChild(r);return n}function*Co(t){const e=typeof t=="string"?t==="infinite"?"":t.split(""):t.toString().split(""),n=e.length;for(let r=0;r<n;r++){const o=`hud.char.${e[r]}`;gi(o),yield p({textureId:o,x:(r+.5-n/2)*ht.w})}}function ye(t,e){return t.removeChildren(),Je(Co(e),t),t}function ta(t,e){return t.removeChildren(),Je(Co(e),t),t}const Tt=Symbol(),To=Symbol(),So=Symbol(),lt=({colourise:t,button:{which:e}})=>{const n=new b({label:"depress"}),r=new b({label:"arcadeButton"});r.addChild(n);const o=p("button");t?o.filters=Ws(nn.colourised[e]):r.filters=new z(nn.zx[e]),n.addChild(o);const i=new b({label:"surface"}),s=p({textureId:"button.surfaceMask",label:"surfaceMask"});return n.addChild(s),i.mask=s,n.addChild(i),r[To]=o,r[Tt]=i,r[So]=n,r},ze=(t,...e)=>{t[Tt].removeChildren();for(const n of e)n!==void 0&&t[Tt].addChild(n)},ct=(t,e)=>{t[To].texture=oe().textures[e?"button.pressed":"button"],t[So].y=e?1:0},Vn=(t,e,n)=>{n&&(t[Tt].filters=e?wo():fe)},Hn=({which:t},e,n)=>{const r=ta(new b,n);return r.filters=new be({white:e?de(nn.colourised[t]):g.pureBlack}),r};class Io{constructor(e,n){this.renderContext=e,this.appearance=n,this.#n=new b({label:"AppearanceRenderer"})}#e=void 0;#n;destroy(){this.#n.destroy({children:!0})}tick(e){const n=this.appearance({renderContext:this.renderContext,currentlyRenderedProps:this.#e,previousRendering:this.#n.children.at(0)??null,tickContext:e});n!=="no-update"&&(this.#e=n.renderProps,this.#n.children.at(0)!==n.container&&(this.#n.removeChildren(),n.container!==null&&this.#n.addChild(n.container)))}get container(){return this.#n}}const ko=t=>p(t.type==="spring"?"spring.released":t.type==="sceneryPlayer"?t.config.which==="head"?"head.walking.towards.2":"heels.walking.away.2":t.config.style),na=(t,e,n,r)=>{const o=Math.max(0,Math.min(t.x+e.x,n.x+r.x)-Math.max(t.x,n.x)),i=Math.max(0,Math.min(t.y+e.y,n.y+r.y)-Math.max(t.y,n.y));return o*i},Xn=({state:{position:t},aabb:e},{state:{position:n},aabb:r})=>na(t,e,n,r),vn=(t,e,n=.001)=>{if(!me(e,t)||t.id===e.id)return!1;const{state:{vels:{gravity:{z:r}}}}=t;return r>0?!1:cn({state:{position:L(t.state.position,{x:0,y:0,z:-.001})},aabb:{...t.aabb,z:n+bi},id:t.id},{state:{position:L(e.state.position,{x:0,y:0,z:e.aabb.z})},aabb:{...e.aabb,z:0},id:e.id})},Oo=(t,e)=>{const r=[...ie(e).filter(i=>vn(t,i))];return r.length===0?void 0:r.reduce((i,s)=>{const a=Wi(s,i);return a<0||a===0&&Xn(t,s)>Xn(t,i)?s:i})},Xe=t=>{const{gameTime:e,lastDiedAt:n}=t.type==="headOverHeels"?t.state.head:t.state;return e-n<Ji};function _o({room:{roomTime:t},movingItem:e}){e.state.action!=="death"&&(bo(e)||Xe(e)||(e.state.action="death",e.state.expires=t+Wt))}const ee=(t,e)=>t==="infinite"||e==="infinite"?"infinite":t+e,Ye=t=>t==="infinite"?Number.POSITIVE_INFINITY:t,Po=t=>{const{gameState:e,movingItem:n,touchedItem:r,room:{id:o}}=t,{pickupsCollected:i}=e;if(i[o]?.[r.id]!==!0)switch(i[o]===void 0&&(i[o]={}),i[o][r.id]=!0,r.config.gives){case"hooter":{const s=mt(n);if(s!==void 0){s.hasHooter=!0;break}break}case"doughnuts":{const s=mt(n);s!==void 0&&(s.doughnuts=ee(s.doughnuts,6));break}case"bag":{const s=Ct(n);if(s!==void 0){s.hasBag=!0;break}break}case"shield":{n.type==="headOverHeels"?(n.state.head.shieldCollectedAt=n.state.head.gameTime,n.state.heels.shieldCollectedAt=n.state.heels.gameTime):n.state.shieldCollectedAt=n.state.gameTime;break}case"fast":{const s=mt(n);s!==void 0&&(s.fastStepsStartedAtDistance=s.gameWalkDistance);break}case"jumps":{const s=Ct(n);s!==void 0&&(s.bigJumps+=10);break}case"extra-life":n.type==="headOverHeels"?(n.state.head.lives=ee(n.state.head.lives,2),n.state.heels.lives=ee(n.state.heels.lives,2)):n.state.lives=ee(n.state.lives,2);break;case"scroll":x.dispatch(wi(r.config.page));break;case"reincarnation":{x.dispatch(xi(yi(e,x.getState())));break}case"crown":{x.dispatch(vi(r.config.planet));break}default:r.config}},ra=({gameState:t,movingItem:e,touchedItem:n,movementVector:r})=>{const{config:{toRoom:o,direction:i}}=n;wr(i,r)<=0||e.state.action!=="death"&&un({playableItem:e,gameState:t,toRoomId:o,sourceItem:n,changeType:"portal"})},oa=({movingItem:t,movementVector:e,touchedItem:n})=>{const{config:{direction:r,part:o}}=n,i=It(r);if(o==="top")return;const s=o==="far"?{x:i==="x"?-Math.abs(e.y):Math.abs(e.y)*(r==="left"?-1:1),y:i==="y"?-Math.abs(e.x):Math.abs(e.x)*(r==="away"?-1:1),z:0}:{x:i==="x"?Math.abs(e.y):Math.abs(e.y)*(r==="left"?-1:1),y:i==="y"?Math.abs(e.x):Math.abs(e.x)*(r==="away"?-1:1),z:0};t.state.position=L(t.state.position,s)};function ia({movingItem:t}){t.state.autoWalk=!1}const K=(t,...e)=>X(...e)(t.touchedItem),Le=(t,...e)=>X(...e)(t.movingItem),Bo=t=>H(t.movingItem),sa=t=>H(t.touchedItem),aa=t=>kr(t.touchedItem),jn=t=>{switch(!0){case K(t,"stopAutowalk"):ia(t);break;case aa(t):_o(t);break;case K(t,"portal"):ra(t);break;case K(t,"pickup"):Po(t);break;case K(t,"doorFrame"):oa(t);break}},_e={movementType:"steady"},Ao=150,Fo=t=>t[Math.floor(Math.random()*t.length)],ne=Object.freeze({movementType:"vel",vels:{walking:O}}),Pt=t=>Or(t)?ce[t.config.which]:ce[t.type],qn=M.w/2,la=({state:{position:t,vels:{walking:e}}},n,r,o)=>{const i=ce.homingBot;if(!kt(e,te))return{movementType:"steady"};const{head:s,heels:a}=_r(n.items);for(const l of[s,a]){if(l===void 0)continue;const c=Ze(l.state.position,t);if(Math.abs(c.y)<qn)return{movementType:"vel",vels:{walking:{x:c.x>0?i:-.05,y:0,z:0}}};if(Math.abs(c.x)<qn)return{movementType:"vel",vels:{walking:{x:0,y:c.y>0?i:-.05,z:0}}}}return{movementType:"steady"}},Do=(t,e)=>{const{head:n,heels:r,headOverHeels:o}=_r(e.items);if(o!==void 0)return Xe(o)?void 0:o;const i=n===void 0||Xe(n)||n.state.action==="death"?void 0:xn(n.state.position,t),s=r===void 0||Xe(r)||r.state.action==="death"?void 0:xn(r.state.position,t);return i===void 0?r:s===void 0||i<s?n:r},ca=(t,e,n,r)=>{const{state:{position:o,standingOnItemId:i,timeOfLastDirectionChange:s,facing:a}}=t;if(i===null)return ne;const l=Do(o,e);if(l===void 0||s+Ao>e.roomTime)return _e;const c=Ze(l?.state.position,o),u=Math.abs(c.x)<Math.abs(c.y)?"x":"y",d=Math.abs(c[u])>M.w/4?u:Ke(u),f=Pt(t),h={...O,[d]:c[d]>0?f:-f},m=pe(h),v=!kt(m,a);return{movementType:"vel",vels:{walking:h},stateDelta:{facing:m,...v?{timeOfLastDirectionChange:e.roomTime}:re}}},Gn=(t,e,n,r,o=!1)=>{const{state:{position:i,standingOnItemId:s}}=t;if(s===null)return ne;const a=Do(i,e);if(a===void 0)return ne;const l=a.state.position,c=M.w*3;if(!(i.x>l.x-c&&i.x<l.x+c&&i.y>l.y-c&&i.y<l.y+c))return ne;const d=Ze(a?.state.position,i),f=Pt(t),h=(1+Math.sqrt(2))/2,m=f*h,v=B({...d,z:0},m/Cr(d)*(o?-1:1));return{movementType:"vel",vels:{walking:v},stateDelta:{facing:pe(v)}}},Lt=(t,e,n,r,o)=>{const{state:{vels:{walking:i},standingOnItemId:s}}=t;if(s===null)return ne;if(!(Be(i,O)||Math.random()<r/1e3))return _e;const l=Fo(o);return{movementType:"vel",vels:{walking:B(qt[l],Pt(t))},stateDelta:{facing:qt[l]}}},ua=(t,e,n,r)=>{const{state:{facing:o,vels:{walking:i},standingOnItemId:s}}=t;return s===null?ne:kt(i,te)?{movementType:"vel",vels:{walking:B(o,Pt(t))}}:_e},da=(t,e,n)=>{switch(n){case"opposite":return{x:e.x===0?t.x:-t.x,y:e.y===0?t.y:-t.y,z:0};case"clockwise":return{x:-t.y,y:t.x,z:0};case"perpendicular":{const r=Fo([-1,1]);return{x:e.x===0?r*t.y:0,y:e.y===0?r*t.x:0,z:0}}}},Rt=({movingItem:t,touchedItem:{state:{position:e},aabb:n},deltaMS:r},o)=>{const{state:{position:i,vels:{walking:s},activated:a},aabb:l}=t;if(!a||(t.state.durationOfTouch+=r,t.state.durationOfTouch<Ao))return;const c=Ot(i,l,e,n);if(c.x===0&&c.y===0)return;const u=da(s,c,o);t.state.vels.walking=u,t.state.facing=pe(u),t.state.durationOfTouch=0},fa=({movingItem:t,movementVector:e})=>{e.z<0||(t.state.vels.walking=O)},ha=(t,e,n,r)=>{if(!t.state.activated||Or(t)&&t.state.busyLickingDoughnutsOffFace)return ne;switch(t.config.movement){case"patrol-randomly-diagonal":return Lt(t,e,n,r,Ii);case"patrol-randomly-xy8":return Lt(t,e,n,r,Si);case"patrol-randomly-xy4":return Lt(t,e,n,r,Ti);case"towards-tripped-on-axis-xy4":return la(t,e);case"towards-on-shortest-axis-xy4":return ca(t,e);case"back-forth":case"clockwise":return ua(t);case"unmoving":case"free":return ne;case"towards-when-in-square-xy8":return Gn(t,e);case"towards-when-in-square-xy8-unless-planet-crowns":return Gn(t,e,n,r,Ci(x.getState()));default:throw t.config,new Error("this should be unreachable")}},pa=t=>{const{movingItem:e,touchedItem:n}=t;if(me(n,e))switch(e.config.movement){case"patrol-randomly-xy4":Rt(t,"perpendicular");break;case"back-forth":case"patrol-randomly-diagonal":case"patrol-randomly-xy8":Rt(t,"opposite");break;case"clockwise":Rt(t,"clockwise");break;case"towards-tripped-on-axis-xy4":fa(t);break;case"towards-on-shortest-axis-xy4":case"towards-when-in-square-xy8":case"towards-when-in-square-xy8-unless-planet-crowns":case"unmoving":case"free":return;default:throw e.config,new Error("this should be unreachable")}},ma=({touchedItem:t,gameState:{progression:e},room:n})=>{const{config:{activates:r,store:o},state:{setting:i,touchedOnProgression:s}}=t;if(t.state.touchedOnProgression=e,!(e===s+1||e===s)){if(r){const a=t.state.setting=i==="left"?"right":"left";for(const[l,c]of an(r)){const u=n.items[l];u!==void 0&&(u.state={...u.state,...c[a]})}}o&&x.dispatch(ki(o.path))}},ga=({movingItem:t,touchedItem:e})=>{if(!me(t))return;const{state:{position:n},aabb:r}=e,o=Ot(t.state.position,t.aabb,n,r);if(o.x===0&&o.y===0)return;const i=pe(o),s=B(i,-.05);return e.state.vels.sliding=s,!1},ba=({movingItem:t,touchedItem:e})=>{if(!me(e))return;const n=t.state.vels.sliding;if(Be(n,O))return;const{state:{position:r},aabb:o}=t,i=Ot(e.state.position,e.aabb,r,o);return wr(i,t.state.vels.sliding)>0&&(t.state.vels.sliding=O),!1},va=2*Yi,Mo=(t,e,n)=>{t.state.latentMovement.push({moveAtRoomTime:e.roomTime+va,positionDelta:n})},xa=(t,e,n)=>{for(const r of t){const o=n[r.id];if(o===void 0)continue;const s={...Tr(r.state.position,o),z:0};if(!Be(s,O))for(const a of dn(r.state.stoodOnBy,e))Mo(a,e,s)}},ya=({movingItem:t,room:e,touchedItem:n,deltaMS:r})=>{const{config:{controls:o},state:{position:i},aabb:s}=n,a=Ot(t.state.position,t.aabb,i,s);if(a.x===0&&a.y===0)return;const l=pe(a);for(const c of o){const u=e.items[c],d=B(l,-.025*r);u.state.facing=d,Mo(u,e,d)}},ut=t=>{const n=t/es*vr;return(t+.5*Jt*n**2)/n},wa={head:ut(nt.head),headOnSpring:ut(nt.head+M.h),heels:ut(nt.heels),heelsOnSpring:ut(nt.heels+M.h)},Ca=(t,e)=>{const n=t.type==="headOverHeels"?"head":t.type==="heels"&&t.state.bigJumps>0?(t.state.bigJumps--,"head"):t.type;return wa[`${n}${e?"OnSpring":""}`]},Ta=t=>!(t===null||Ki(t)||Qi(t)&&t.config.gives==="scroll"||H(t)&&t.state.standingOnItemId===null),zo=(t,e,n)=>{const{state:{standingOnItemId:r}}=t,{inputStateTracker:o}=n,i=Ae(r,e);if(!(o.currentActionPress("jump")!=="released"&&Ta(i)))return r!==null?{movementType:"steady",stateDelta:{jumped:!1}}:_e;const a=Zi(i);return{movementType:"vel",vels:{gravity:{x:0,y:0,z:Ca(t,a)}},stateDelta:{action:"moving",jumped:!0}}},Sa=({vel:t,acc:e,unitD:n,maxSpeed:r,deltaMS:o,minSpeed:i=0})=>{const s=Pe(t),a=Math.max(i,Math.min(r,s+e*o)),l=Math.min(a,r);return B(n,l)},Wn={movementType:"vel",vels:{walking:O}},Lo=(t,e,n,r)=>{const o=Ia(t,e,n,r);if(o.movementType==="vel"&&o.vels.walking!==void 0){const i=Pe(o.vels.walking);o.stateDelta={...o.stateDelta,walkDistance:i===0?0:t.state.walkDistance+i*r},t.type==="head"&&t.state.standingOnItemId!==null&&(o.stateDelta={...o.stateDelta,gameWalkDistance:t.state.gameWalkDistance+i*r})}return t.state.action==="idle"&&o.movementType==="vel"&&o.vels.walking!==void 0&&!Be(o.vels.walking,O)&&(o.stateDelta={...o.stateDelta,walkStartFacing:t.state.facing}),o},Ia=(t,e,{inputStateTracker:n,currentCharacterName:r},o)=>{const{type:i,state:{action:s,autoWalk:a,standingOnItemId:l,facing:c,teleporting:u,walkDistance:d,walkStartFacing:f,vels:{walking:h,gravity:m}}}=t,v=r===t.id,k=v?n.currentActionPress("jump"):"released",A=v?n.directionVector:O,F=l===null&&m.z<0,_=i==="head"&&vo(t.state)>0&&l!==null,U=i==="headOverHeels"?F?"head":"heels":_?"heels":i,P=a?c:A,E=ce[U];if(u!==null||s==="death")return Wn;if(i==="heels"){if(l===null)return t.state.jumped?{movementType:"vel",vels:{walking:Tr(h,B(h,ts*o))}}:Wn;if(k!=="released"){const et=pe(kt(P,te)?c:P),ei=X("spring")(Ae(l,e))?1:ns;return{movementType:"vel",vels:{walking:B({...et,z:0},E*ei)},stateDelta:{facing:et}}}}if(Pe(P)!==0)return F?{movementType:"vel",vels:{walking:B({...P,z:0},E)},stateDelta:{facing:P,action:"falling"}}:{movementType:"vel",vels:{walking:Sa({vel:h,acc:rs[U],deltaMS:o,maxSpeed:E,unitD:P,minSpeed:0})},stateDelta:{facing:P,action:"moving"}};if(d>0&&d<1){const et=Be(f,c)?1:0;return{movementType:"position",posDelta:B(c,et-d),stateDelta:{action:F?"falling":"idle",walkDistance:0}}}return{movementType:"vel",vels:{walking:O},stateDelta:{action:F?"falling":"idle"}}},Jn=t=>ge(t.movingItem)&&vn(t.movingItem,t.touchedItem,Math.abs(t.movementVector.z)),Ro=(t,e)=>{let n=O;for(const r of e){if(r.movementType==="position"&&(n=L(n,r.posDelta)),r.movementType==="vel"&&(ge(t)||X("lift")(t)))for(const[i,s]of an(r.vels)){const a={...O,...s};t.state.vels[i]=a}const o=r.stateDelta;o!==void 0&&(t.state={...t.state,...o})}return n},Yn=t=>{if(t.touchedItem.state.disappear==="onTouch"||t.touchedItem.state.disappear==="onTouchByPlayer"&&H(t.movingItem)||t.touchedItem.state.disappear==="onStand"&&Jn(t)){if(Jn(t)&&Bo(t)){Pr({above:t.movingItem,below:t.touchedItem});const n=[zo(t.movingItem,t.room,t.gameState),Lo(t.movingItem,t.room,t.gameState,t.deltaMS)];Ro(t.movingItem,n)}Br(t)}};function ka(t){const e=t.movingItem.type==="monster"?t.movingItem:t.touchedItem;e.config.which!=="emperorsGuardian"&&(e.state.busyLickingDoughnutsOffFace=!0)}const Uo=t=>{Bo(t)&&jn(t),sa(t)&&jn({...t,movingItem:t.touchedItem,touchedItem:t.movingItem}),K(t,...In)&&ga(t),Le(t,...In)&&ba(t),(Le(t,"monster")&&K(t,"firedDoughnut")||Le(t,"firedDoughnut")&&K(t,"monster"))&&ka(t),(Le(t,"monster")||Le(t,"movableBlock"))&&pa(t),K(t,"switch")&&ma(t),K(t,"joystick")&&ya(t),t.touchedItem.state.disappear&&Yn(t),t.movingItem.state.disappear&&me(t.touchedItem,t.movingItem)&&Yn({...t,movingItem:t.touchedItem,touchedItem:t.movingItem})},Oa=(t,e,n,r)=>{const{inputStateTracker:o}=n,i=t.type==="heels"?t.state:t.state.heels,{carrying:s,hasBag:a}=i,{state:{position:l}}=t;if(!a)return;const c=ue(e.items).filter(Ar),u=s===null?Eo(t,e):void 0;for(const d of c)d.state.wouldPickUpNext=!1;if(u!==void 0&&(u.state.wouldPickUpNext=!0),o.currentActionPress("carry")==="tap")if(s===null){if(u===void 0){console.warn("nothing to pick up");return}_a(e,i,u)}else{if(t.state.standingOnItemId===null||!$o(t,Fr(e.items)))return;const d=os({gameState:n,room:e,itemType:s.type,config:s.config,position:l});Dr({subjectItem:t,gameState:n,room:e,posDelta:{x:0,y:0,z:d.aabb.z},pusher:t,forceful:!0,deltaMS:r,onTouch:Uo}),i.carrying=null}},_a=(t,e,n)=>{const r={type:n.type,config:n.config};e.carrying=r,Mr({room:t,item:n})},Eo=(t,e)=>Oo(t,ue(e.items).filter(Ar)),$o=(t,e)=>{const n={position:L(t.state.position,{z:M.h})},r=is({id:t.id,aabb:t.aabb,state:n},e);for(const o of r)if(me(o,t)){if(!ge(o))return console.log("carrying: cannot put down due to collision: item:",t,"can't move up because it would collide with non-free",o),!1;if(!$o(o,e))return console.log("carrying: cannot put down due to collision: item:",t,"can't move up because it would collide with free that has nowhere to go:",o),!1}return!0},Ut=-11,Pa={jump({renderContext:{button:t,inputStateTracker:e,colourise:n},currentlyRenderedProps:r,previousRendering:o,tickContext:{room:i,currentPlayable:s}}){const a=s?.state.standingOnItemId??null,l=a===null||i===void 0?null:i.items[a],c=l===null?!1:l.type==="teleporter",u=t.actions.every(f=>e.currentActionPress(f)!=="released"),d=o===null?lt({colourise:n,button:t}):o;if(r?.pressed!==u&&ct(d,u),c!==r?.standingOnTeleporter)if(c)ze(d,p({textureId:"teleporter",y:5}),p({animationId:"teleporter.flashing",y:5}));else{const f=Hn(t,n,"JUMP");f.y=Ut,ze(d,f)}return{container:d,renderProps:{pressed:u,standingOnTeleporter:c,colourise:n}}},carry({renderContext:{button:t,inputStateTracker:e,colourise:n},currentlyRenderedProps:r,previousRendering:o,tickContext:{currentPlayable:i,room:s}}){const a=i&&Ct(i),l=a?.hasBag??!1,c=a?.carrying??null,u=c===null&&s!==void 0&&Eo(i,s)!==void 0,d=t.actions.every(v=>e.currentActionPress(v)!=="released"),f=l&&!u&&c===null,h=o===null?lt({colourise:n,button:t}):o;if(h.visible=l,l&&(f!==r?.disabled&&Vn(h,f,n),h.visible=!0,r?.pressed!==d&&ct(h,d),l!==r?.hasBag||c!==r?.carrying)){let v;c!==null?v=ko(c):l&&(v=p({textureId:"bag",y:-2})),ze(h,v)}return{container:h,renderProps:{pressed:d,hasBag:l,colourise:n,carrying:c,disabled:f}}},fire({renderContext:{button:t,inputStateTracker:e,colourise:n},currentlyRenderedProps:r,previousRendering:o,tickContext:{currentPlayable:i}}){const s=i&&mt(i),a=s?.hasHooter??!1,l=s?.doughnuts??0,c=t.actions.every(f=>e.currentActionPress(f)!=="released"),u=o===null?lt({colourise:n,button:t}):o,d=a||Ye(l)>0;if(u.visible=d,d&&(r?.pressed!==c&&ct(u,c),a!==r?.hasHooter||l!==r?.doughnuts)){let f;a?f=p({textureId:"hooter",y:-3}):Ye(l)>0&&(f=p({textureId:"doughnuts",y:-2}));const h=ye(new b,l);h.y=Ut,h.filters=Y,ze(u,f,h),Vn(u,l===0,n)}return{container:u,renderProps:{pressed:c,colourise:n,doughnuts:l,hasHooter:a}}},carryAndJump({renderContext:{button:t,inputStateTracker:e,colourise:n},currentlyRenderedProps:r,previousRendering:o,tickContext:{currentPlayable:i}}){const a=(i&&Ct(i))?.hasBag??!1,l=t.actions.every(d=>e.currentActionPress(d)!=="released");if(!(r===void 0||l!==r.pressed||n!==r.colourise||a!==r.hasBag))return"no-update";let u;if(o===null){u=lt({colourise:n,button:t});const d=Hn(t,n,"C+J");d.y=Ut,ze(u,d)}else u=o;return a?(u.visible=!0,r?.pressed!==l&&ct(u,l)):u.visible=!1,{container:u,renderProps:{pressed:l,hasBag:a,colourise:n}}},menu({previousRendering:t}){if(t!==null)return"no-update";const e=p("hud.char.Menu");return e.scale=2,e.filters=W,{container:e,renderProps:re}}};class Re extends Io{constructor(e){const n=Pa[e.button.which];super(e,n)}}const Ba=26,Aa=13;class Fa{constructor(e){this.renderContext=e;const{gameState:{inputStateTracker:n},inputDirectionMode:r,colourise:o}=e;this.#n={mainButtonNest:new b({label:"mainButtonNest"}),buttons:{jump:new Re({button:{which:"jump",actions:["jump"],id:"jump"},colourise:o,inputStateTracker:n}),fire:new Re({button:{which:"fire",actions:["fire"],id:"fire"},colourise:o,inputStateTracker:n}),carry:new Re({button:{which:"carry",actions:["carry"],id:"carry"},colourise:o,inputStateTracker:n}),carryAndJump:new Re({button:{which:"carryAndJump",actions:["carry","jump"],id:"carryAndJump"},colourise:o,inputStateTracker:n}),menu:new Re({button:{which:"menu",actions:["menu_openOrExit"],id:"menu"},colourise:o,inputStateTracker:n})},joystick:new ea({inputStateTracker:n,inputDirectionMode:r,colourise:o})};const{buttons:i}=this.#n,{mainButtonNest:s,joystick:a}=this.#n;for(const l of Z(i))l.renderContext.button.which==="menu"?this.#e.addChild(i.menu.container):s.addChild(l.container);i.jump.container.y=Aa,i.carry.container.x=-26,i.carryAndJump.container.y=-13,i.fire.container.x=Ba,i.menu.container.x=24,i.menu.container.y=24,this.#e.addChild(s),this.#e.addChild(a.container),this.#t()}#e=new b({label:"OnScreenControls"});#n;#t(){const{renderContext:{gameState:{inputStateTracker:e}}}=this;for(const n of Z(this.#n.buttons)){const{renderContext:{button:{actions:r}}}=n;n.container.eventMode="static",n.container.on("pointerdown",()=>{for(const o of r)e.hudInputState[o]=!0}),n.container.on("pointerup",()=>{for(const o of r)e.hudInputState[o]=!1}),n.container.on("pointerleave",()=>{for(const o of r)e.hudInputState[o]=!1})}}#o(e){this.#n.mainButtonNest.x=e.x-40,this.#n.mainButtonNest.y=e.y-14,this.#n.joystick.container.x=32,this.#n.joystick.container.y=e.y-28}tick(e){const{screenSize:n}=e,{gameState:r}=this.renderContext;this.#o(n);for(const o of Z(this.#n.buttons))o.tick({...e,currentPlayable:Fe(r)});this.#n.joystick.tick()}get container(){return this.#e}destroy(){this.#e.destroy(),this.#n.joystick.destroy()}}xr.frames.button.frame;const Da=250,Ma=t=>t?12:24,za=t=>t?32:56,La=t=>t?40:80,Ra=t=>t?18:24,Zn=112,Ue=t=>t==="heels"?1:-1;class Ua{constructor(e){this.renderContext=e;const{onScreenControls:n}=e;for(const r of Dt)this.#e.addChild(this.#t[r].livesText),this.#e.addChild(this.#t[r].sprite),this.#e.addChild(this.#t[r].shield.container),this.#e.addChild(this.#t[r].extraSkill.container);n||(this.#e.addChild(this.#t.head.doughnuts.container),this.#e.addChild(this.#t.head.hooter.container),this.#e.addChild(this.#t.heels.bag.container),this.#e.addChild(this.#t.heels.carrying.container)),this.#e.addChild(this.#t.fps),this.#t.fps.filters=[Nn],this.#t.fps.y=ht.h,this.#o(),n&&(this.#n=new Fa({...e}),this.#e.addChild(this.#n.container))}#e=new b({label:"HudRenderer"});#n=void 0;#t={head:{sprite:this.#r("head"),livesText:this.#i({label:"headLives",doubleHeight:!0,outline:!0}),shield:this.#s({label:"headShield",textureId:"hud.shield",outline:!0}),extraSkill:this.#s({label:"headFastSteps",textureId:"hud.fastSteps",outline:!0}),doughnuts:this.#s({label:"headDoughnuts",textureId:"doughnuts",textOnTop:!0,outline:"text-only"}),hooter:this.#s({label:"headHooter",textureId:"hooter",textOnTop:!0,noText:!0})},heels:{sprite:this.#r("heels"),livesText:this.#i({label:"heelsLives",doubleHeight:!0,outline:!0}),shield:this.#s({label:"heelsShield",textureId:"hud.shield",outline:!0}),extraSkill:this.#s({label:"heelsBigJumps",textureId:"hud.bigJumps",outline:!0}),bag:this.#s({label:"heelsBag",textureId:"bag",textOnTop:!0,noText:!0}),carrying:{container:new b({label:"heelsCarrying"})}},fps:this.#i({label:"fps",outline:!0})};#o(){const{renderContext:{gameState:{inputStateTracker:{hudInputState:e}}}}=this;for(const n of Dt){const{sprite:r}=this.#t[n];r.eventMode="static",r.on("pointerdown",()=>{e[`swop.${n}`]=!0}),r.on("pointerup",()=>{e[`swop.${n}`]=!1}),r.on("pointerleave",()=>{e[`swop.${n}`]=!1})}}#s({textureId:e,textOnTop:n=!1,noText:r=!1,outline:o=!1,label:i}){const s=new b({label:i});s.pivot={x:4,y:16};const a=new Oe({texture:oe().textures[e],anchor:n?{x:.5,y:0}:{x:.5,y:1},filters:$n,y:n?0:8});s.addChild(a);const l=this.#i({outline:o==="text-only"});return l.y=n?0:16,l.x=a.x=ht.w/2,s.addChild(l),r&&(l.visible=!1),o===!0&&(s.filters=Y),{text:l,icon:a,container:s}}#r(e){const n=new Oe(oe().textures[`${e}.walking.${e==="head"?"right":"towards"}.2`]);return n.anchor={x:.5,y:0},n}#i({doubleHeight:e=!1,outline:n=!1,label:r="text"}={}){return new b({label:r,filters:n?Ks:tn,scale:{x:1,y:e?2:1}})}#l({screenSize:e}){this.#t.head.hooter.container.x=this.#t.head.doughnuts.container.x=(e.x>>1)+Ue("head")*Zn,this.#t.head.doughnuts.container.y=e.y-$e.h-8,this.#t.heels.carrying.container.y=e.y-$e.h,this.#t.heels.carrying.container.x=this.#t.heels.bag.container.x=(e.x>>1)+Ue("heels")*Zn,this.#t.heels.bag.container.y=this.#t.head.hooter.container.y=e.y-8,this.#t.fps.x=e.x-ht.w*2}#a(e,n){return e?n?fe:He:n?Rn:Ve}#d(e){const{renderContext:{gameState:n}}=this,r=rt(n,"heels"),o=r?.hasBag??!1,i=r?.carrying??null,{renderContext:{colourise:s}}=this,{container:a}=this.#t.heels.carrying,l=a.children.length>0;if(i===null&&l)for(const c of a.children)c.destroy();i!==null&&!l&&a.addChild(ko(i)),a.filters=this.#a(!0,s),this.#t.heels.bag.icon.filters=this.#a(o,s)}#f(e){const{renderContext:{gameState:n}}=this,r=rt(n,"head"),o=r?.hasHooter??!1,i=r?.doughnuts??0,{renderContext:{colourise:s}}=this;this.#t.head.hooter.icon.filters=this.#a(o,s),this.#t.head.doughnuts.icon.filters=this.#a(i!==0,s),ye(this.#t.head.doughnuts.text,i)}#h(e,{screenSize:n}){const{renderContext:{onScreenControls:r,gameState:o}}=this,i=rt(o,e),{text:s,container:a}=this.#t[e].shield,{text:l,container:c}=this.#t[e].extraSkill,u=gt(i),d=u>0||!r;a.visible=d,d&&(ye(s,u),a.y=n.y),c.x=a.x=(n.x>>1)+Ue(e)*La(r);const f=i===void 0?0:e==="head"?vo(i):i.bigJumps,h=f>0||!r;c.visible=h,h&&(ye(l,f),c.y=n.y-Ra(r))}#c(e,n){const{currentCharacterName:r}=e;return r===n||r==="headOverHeels"}#p(e,{screenSize:n}){const{renderContext:{onScreenControls:r,gameState:o}}=this,i=this.#c(o,e),s=this.#t[e].sprite,{renderContext:{colourise:a}}=this;i?s.filters=a?fe:He:s.filters=a?Rn:Ve,s.x=(n.x>>1)+Ue(e)*za(r),s.y=n.y-$e.h}#m(e,{screenSize:n}){const{renderContext:{onScreenControls:r,gameState:o}}=this,s=rt(o,e)?.lives??0,a=this.#t[e].livesText;a.x=(n.x>>1)+Ue(e)*Ma(r),a.y=n.y,ye(a,s??0)}#g(e){const{room:n}=e;if(n===void 0)return;const r=bn(n.color),{colourise:o,gameState:i}=this.renderContext;Ve.targetColor=r.hud.dimmed[o?"dimmed":"original"],tn.targetColor=r.hud.dimmed[o?"basic":"original"],$n.targetColor=r.hud.icons[o?"basic":"original"],He.targetColor=r.hud.lives.original,this.#t.head.livesText.filters=o?at.colourised.head[this.#c(i,"head")?"active":"inactive"]:at.original,this.#t.heels.livesText.filters=o?at.colourised.heels[this.#c(i,"heels")?"active":"inactive"]:at.original}#u=Oi;#b(){if(_i(x.getState())){if(performance.now()>this.#u+Da){const e=Ee.shared.FPS;ye(this.#t.fps,Math.round(e)),Nn.targetColor=e>100?g.white:e>58?g.moss:e>55?g.pastelBlue:e>50?g.metallicBlue:e>40?g.pink:g.midRed,this.#u=performance.now()}this.#t.fps.visible=!0}else this.#t.fps.visible=!1}tick(e){this.#g(e);for(const n of Dt)this.#m(n,e),this.#p(n,e),this.#h(n,e);this.#l(e),this.#f(e),this.#d(e),this.#b(),this.#n?.tick(e)}get container(){return this.#e}destroy(){this.#e.destroy(),this.#n?.destroy()}}const Kn={movementType:"vel",vels:{gravity:O}},Ea=(t,e,n,r)=>{if(!me(t))return Kn;const{type:o,state:{vels:{gravity:{z:i}},standingOnItemId:s}}=t,l=ss[(o==="headOverHeels"?"head":o)==="head"?"head":"others"];if(s!==null){const c=Ae(s,e);return X("lift")(c)&&c.state.vels.lift.z<0?{movementType:"vel",vels:{gravity:{z:Math.max(i-Jt*r,-l)}}}:Kn}else return{movementType:"vel",vels:{gravity:{z:Math.max(i-Jt*r,-l)}}}},Qn=M.h,er=.001,$a=({totalDistance:t,currentAltitude:e,direction:n})=>{const r=kn**2/(2*De);if(n==="up"){if(e<=r)return Math.max(er,Math.sqrt(2*De*Math.max(e,0)));if(e>=t-r){const o=Math.max(0,t-e);return Math.max(er,Math.sqrt(2*De*o))}else return kn}else if(e>=t-r){const o=Math.max(0,t-e);return Math.min(-.001,-Math.sqrt(2*De*o))}else return e<=r?Math.min(-.001,-Math.sqrt(2*De*Math.max(e,0))):-.036};function Na({config:{bottom:t,top:e},state:{direction:n,position:{z:r}}}){const o=t*Qn,i=e*Qn,s=$a({currentAltitude:r-o,direction:n,totalDistance:i-o});if(Number.isNaN(s))throw new Error("velocity is NaN");const a=r<=o?"up":r>=i?"down":n;return{movementType:"vel",vels:{lift:{x:0,y:0,z:s}},stateDelta:{direction:a}}}function Va(t,e,n,r){const{state:{teleporting:o,standingOnItemId:i}}=t,{inputStateTracker:s}=n,a=s.currentActionPress("jump"),l=i===null?null:e.items[i],c=l!==null&&X("teleporter")(l);if(o===null)return a!=="released"&&c?{movementType:"steady",stateDelta:{teleporting:{phase:"out",toRoom:l.config.toRoom,timeRemaining:Wt}}}:_e;const u=Math.max(o.timeRemaining-r,0);switch(o.phase){case"out":if(!c)return{movementType:"steady",stateDelta:{teleporting:null}};if(u===0)return un({changeType:"teleport",sourceItem:l,playableItem:t,gameState:n,toRoomId:o.toRoom}),{movementType:"steady",stateDelta:{teleporting:{phase:"in",timeRemaining:Wt}}};break;case"in":if(u===0)return{movementType:"steady",stateDelta:{teleporting:null}};break}return{movementType:"steady",stateDelta:{teleporting:{...o,timeRemaining:u}}}}const tr={movementType:"vel",vels:{movingFloor:O}},Ha=(t,e,n,r)=>{if(H(t)&&t.state.teleporting!==null)return tr;const{state:{standingOnItemId:o}}=t,i=Ae(o,e);if(i===null||!X("conveyor")(i))return tr;const{config:{direction:s}}=i,l=X("heels")(t)&&t.state.action==="moving"&&ln(t.state.facing)===Pi(s)?ce.heels:as;return{movementType:"vel",vels:{movingFloor:B(qt[s],l)}}};function*Xa(t,e,n,r){for(;(t.state.latentMovement.at(0)?.moveAtRoomTime??Number.POSITIVE_INFINITY)<e.roomTime;){const{positionDelta:o}=t.state.latentMovement.shift();yield{movementType:"position",posDelta:o}}}const ja=M.w*Math.sqrt(2)+1,qa=(t,e,n,r)=>{const{inputStateTracker:o}=n,i=t.type==="head"?t.state:t.state.head,{doughnuts:s,hasHooter:a,doughnutLastFireTime:l,gameTime:c}=i,{state:{position:u,facing:d}}=t,f=500,h=pe(d);if(o.currentActionPress("fire")==="tap"&&a&&Ye(s)>0&&l+f<c){const m={type:"firedDoughnut",...ls,config:re,id:`firedDoughnut/${n.progression}`,shadowCastTexture:"shadow.smallRound",state:{position:L(u,B(h,ja),t.type==="headOverHeels"?{z:M.h}:O),vels:{fired:B(h,ce.firedDoughnut)},disappear:"onTouch",expires:null,stoodOnBy:{}}};fn({room:e,item:m}),i.doughnuts=ee(i.doughnuts,-1),i.doughnutLastFireTime=i.gameTime}},Ga=2;function*Wa(t,e,n,r){ge(t)&&(yield Ea(t,e,n,r),yield Ha(t,e),yield*Xa(t,e)),H(t)&&(yield Lo(t,e,n,r),t.id===n.currentCharacterName&&(yield Va(t,e,n,r),yield zo(t,e,n),cs(t)&&Oa(t,e,n,r),us(t)&&qa(t,e,n))),ds(t)&&(yield Na(t)),fs(t)&&(yield ha(t,e,n,r))}const Ja=(t,e,n,r)=>{if(!ge(t)||t.state.standingOnItemId===null)return;const o=Ae(t.state.standingOnItemId,e);H(t)&&(o.type==="movableBlock"&&o.config.movement!=="free"&&o.config.activated==="onStand"&&(o.state.activated=!0),o.type==="pickup"&&Po({gameState:n,movingItem:t,touchedItem:o,room:e})),(o.state.disappear==="onStand"||o.state.disappear==="onTouch"||H(t)&&o.state.disappear==="onTouchByPlayer")&&Br({touchedItem:o,gameState:n,room:e})},Ya=(t,e,n,r)=>{if(H(t)&&t.state.standingOnItemId!==null){const l=Ae(t.state.standingOnItemId,e);kr(l)&&_o({room:e,movingItem:t})}const o=[...Wa(t,e,n,r)];Ja(t,e,n);let i=Ro(t,o);(ge(t)||X("lift")(t)||X("firedDoughnut")(t))&&(i=L(i,...ie(Z(t.state.vels)).map(l=>B(l,r))));const s=Math.ceil(Pe(i)/Ga),a=B(i,1/s);for(let l=0;l<s;l++)Dr({subjectItem:t,posDelta:a,gameState:n,room:e,deltaMS:r,onTouch:Uo})},Za=(t,e)=>{const n=t.characterRooms.headOverHeels;if(e.state.head.lives=ee(e.state.head.lives,-1),e.state.heels.lives=ee(e.state.heels.lives,-1),e.state.head.lastDiedAt=e.state.head.gameTime,e.state.heels.lastDiedAt=e.state.heels.gameTime,ee(e.state.head.lives,e.state.heels.lives)===0){t.events.emit("gameOver");return}const o=Ye(e.state.head.lives)>0,i=Ye(e.state.heels.lives)>0;if(e.state.heels.carrying=null,o&&!i||!o&&i){const c=o?"head":"heels";t.currentCharacterName=c,ae(t,e);const u=On(e)[c],d=Se({gameState:t,playableItems:[u],roomId:n.id});t.characterRooms={[c]:d},t.entryState={[c]:wt(u)};return}if(t.entryState.headOverHeels!==void 0){ae(t,e);const c=Se({gameState:t,playableItems:[e],roomId:n.id});t.characterRooms={headOverHeels:c};return}else{const{head:c,heels:u}=On(e);if(ae(t,c),ae(t,u),cn(c,u)){const d=zr({head:c,heels:u});ae(t,d,"heels");const f=Se({gameState:t,playableItems:[d],roomId:n.id});t.characterRooms={headOverHeels:f},t.entryState={headOverHeels:wt(d)};return}else{const d=Se({gameState:t,playableItems:[c,u],roomId:n.id});t.characterRooms={head:d,heels:d};return}}},Se=({gameState:t,playableItems:e,roomId:n})=>{const{campaign:r}=t,o=Gt({roomJson:r.rooms[n],roomPickupsCollected:t.pickupsCollected[n]??re});for(const i of e)fn({room:o,item:i}),(i.type==="head"||i.type==="headOverHeels")&&hs(o,t);return o},ae=(t,e,n=e.id)=>{const r=t.entryState[n];e.state={...e.state,...r,expires:null,standingOnItemId:null}},Ka=(t,e)=>{const n=Lr(t,Rr(e.type));if(e.state.lives!=="infinite"&&e.state.lives--,e.state.lastDiedAt=e.state.gameTime,e.type==="heels"&&(e.state.carrying=null),e.state.lives===0)if(delete t.characterRooms[e.id],n!==void 0){t.currentCharacterName=n.type;return}else{t.events.emit("gameOver");return}else{const r=t.characterRooms[e.type];ae(t,e);const o=n===void 0?void 0:t.characterRooms[n.type];if(r===o){if(t.entryState.headOverHeels!==void 0){const a=zr({head:e.id==="head"?e:r.items.head,heels:e.id==="heels"?e:r.items.heels});ae(t,a);const l=Se({gameState:t,playableItems:[a],roomId:r.id});t.characterRooms={headOverHeels:l},t.currentCharacterName="headOverHeels";return}fn({room:r,item:e});return}else{const s=Se({gameState:t,playableItems:[e],roomId:r.id});t.characterRooms[e.id]=s;return}}},Qa=(t,e)=>{e.type==="headOverHeels"?Za(t,e):Ka(t,e),Fe(t)===void 0&&x.dispatch(Bi({offerReincarnation:!0}))},el=t=>{for(const e of ue(t.items))for(const n of dn(e.state.stoodOnBy,t)){if(!t.items[n.id]){_n(n,t);continue}if(!vn(n,e)){_n(n,t);const r=Oo(n,Fr(t.items));r!==void 0&&Pr({above:n,below:r})}}},tl=(t,e)=>t.state.expires!==null&&t.state.expires<e.roomTime,nl=(t,e,n)=>{for(const r of ue(t.items))!ge(r)||t.roomTime===r.state.actedOnAt||Ai(r.state.position)||(console.log(`snapping item ${r.id} to pixel grid (not acted on in tick)`),r.state.position=Fi(r.state.position),n.add(r))},rl=(t,e)=>{const n={lift:-4,head:-3,heels:-3,monster:-2,block:1,deadlyBlock:1},r=n[t.type]??0,o=n[e.type]??0;return r-o},ol=re,il=(t,e)=>{if(t.gameSpeed>1){let n=new Set;for(let r=0;r<t.gameSpeed;r++){const o=nr(t,e),i=Ge(t)?.items??ol;n=new Set(ie(Yt(n,o)).filter(({id:s})=>i[s]!==void 0))}return n}return nr(t,e*t.gameSpeed)},nr=(t,e)=>{const{inputStateTracker:n}=t,r=Ge(t);if(r===void 0)return Sr;const o=Object.fromEntries(ps(r.items).map(([a,l])=>[a,l.state.position]));n.currentActionPress("swop")==="tap"&&Mt(t),n.currentActionPress("swop.head")==="tap"&&Mt(t,"head"),n.currentActionPress("swop.heels")==="tap"&&Mt(t,"heels");for(const a of Z(r.items))tl(a,r)&&(Mr({room:r,item:a}),H(a)&&Qa(t,a));const i=Object.values(r.items).sort(rl);for(const a of i){const l=Fe(t);if(l===void 0||l.state.action==="death")break;r.items[a.id]!==void 0&&Ya(a,r,t,e)}el(r);const s=new Set(ie(Z(r.items)).filter(a=>o[a.id]===void 0||!Be(a.state.position,o[a.id])));return xa(s,r,o),nl(r,o,s),sl(t,r,e),s},sl=(t,e,n)=>{t.progression++,t.gameTime+=n,e.roomTime+=n;const r=Fe(t);if(r!==void 0){if(r.type==="headOverHeels")r.state.head.gameTime+=n,r.state.heels.gameTime+=n;else if(r.state.gameTime+=n,t.characterRooms.head===t.characterRooms.heels){const i=Lr(t,Rr(r.type));i!==void 0&&(i.state.gameTime+=n)}}},rr=(t,e)=>{const n=C(t),r=C(L(t,{x:e.x,z:e.z})),o=C(L(t,{y:e.y,z:e.z}));return{bottomCentre:n,topLeft:r,topRight:o}},Et=(t,e,n,r,o=1e-5)=>r-o>t&&n<e-o,al=(t,e,n,r)=>{const o=rr(t,e),i=rr(n,r),s=o.topLeft.x,a=o.topRight.x,l=i.topLeft.x,c=i.topRight.x,u=Et(s,a,l,c),d=o.topRight.y-o.topRight.x/2,f=o.bottomCentre.y-o.bottomCentre.x/2,h=i.topRight.y-i.topRight.x/2,m=i.bottomCentre.y-i.bottomCentre.x/2,v=Et(d,f,h,m),k=o.topLeft.y+o.topLeft.x/2,A=o.bottomCentre.y+o.bottomCentre.x/2,F=i.topLeft.y+i.topLeft.x/2,_=i.bottomCentre.y+i.bottomCentre.x/2,U=Et(k,A,F,_);return u&&v&&U},ll=(t,e)=>{if(t.renders===!1||e.renders===!1||t.fixedZIndex!==void 0||e.fixedZIndex!==void 0)return 0;const n=t.state.position,r=t.renderAabb||t.aabb,o=e.state.position,i=e.renderAabb||e.aabb;if(!al(n,r,o,i))return 0;for(const s of Di){const a=t.state.position[s],l=a+r[s],c=e.state.position[s],u=c+i[s];if(l<=c)return 1*(s==="z"?-1:1);if(a>=u)return-1*(s==="z"?-1:1)}return or(e)-or(t)},or=t=>t.state.position.x+t.state.position.y-t.state.position.z;class bt extends Error{constructor(e,n,r){super(`CyclicDependencyError: .cyclicDependency property of this error has nodes as an array. ${e.join(" -> ")}`,r),this.cyclicDependency=e,this.hasClosedCycle=n}}const cl=t=>{const e=ul(t);let n=e.length,r=n;const o=new Array(n),i={},s=dl(e);for(;r--;)i[r]||a(e[r],r,new Set);return o;function a(l,c,u){if(u.has(l))throw new bt([l],!1);if(i[c])return;i[c]=!0;const d=t.get(l)||new Set,f=Array.from(d);if(c=f.length){u.add(l);do{const h=f[--c];try{a(h,s.get(h),u)}catch(m){throw m instanceof bt?m.hasClosedCycle?m:new bt([l,...m.cyclicDependency],m.cyclicDependency.includes(l)):m}}while(c);u.delete(l)}o[--n]=l}};function ul(t){const e=new Set;for(const[n,r]of t.entries()){e.add(n);for(const o of r)e.add(o)}return Array.from(e)}function dl(t){const e=new Map;for(let n=0,r=t.length;n<r;n++)e.set(t[n],n);return e}const ir=(t,e,n)=>{t.has(e)||t.set(e,new Set),t.get(e).add(n)},dt=(t,e,n)=>{const r=t.get(e);r!==void 0&&(r?.delete(n),r.size===0&&t.delete(e))},fl=(t,e=new Set(Z(t)),n=new Map)=>{const r=new Map;for(const[o,i]of n)if(!t[o])n.delete(o);else for(const s of i)t[s]||dt(n,o,s);for(const o of e)if(o.renders)for(const i of Z(t)){if(!i.renders||r.get(i)?.has(o)||o===i)continue;const s=ll(o,i);if(ir(r,o,i),s===0){dt(n,o.id,i.id),dt(n,i.id,o.id);continue}const a=s>0?o.id:i.id,l=s>0?i.id:o.id;ir(n,a,l),dt(n,l,a)}return n},No=(t,e,n=3)=>{try{return{order:cl(t),impossible:!1}}catch(r){if(r instanceof bt){const o=r.cyclicDependency;return t.get(o[0])?.delete(o[1]),console.warn("cyclc dependency detected: ",o.join(" --front-of--> "),`breaking link ${o[0]} --front-of--> ${o[1]}`),{order:No(t,e,n-1).order,impossible:!0}}else throw r}};class hl extends Io{}const sr=(t,e)=>{e.poly([C({}),C({x:t.x}),C({x:t.x,y:t.y}),C({y:t.y})]).poly([C({}),C({z:t.z}),C({y:t.y,z:t.z}),C({y:t.y})]).poly([C({x:t.x}),C({x:t.x,z:t.z}),C(t),C({x:t.x,y:t.y})]).poly([C({z:t.z}),C({x:t.x,z:t.z}),C({x:t.x,y:t.y,z:t.z}),C({y:t.y,z:t.z})])},ar=(t,e)=>{const n=new V;return sr(t,n),n.stroke({width:.5,color:e,alpha:1}),n.eventMode="static",n.on("pointerenter",()=>{n.fill({color:e,alpha:.5})}),n.on("pointerleave",()=>{n.clear(),sr(t,n),n.stroke({width:.5,color:e,alpha:1})}),n},pl={head:"rgba(255,184,0)",wall:"rgba(128,200,0)",portal:"rgba(255,0,255)",stopAutowalk:"rgba(255,128,128)"};class ml{constructor(e){this.renderContext=e;const{item:n}=e,r=pl[n.type]??"rgba(255,255,255)";if(this.#e=new b({label:`ItemBoundingBoxRenderer ${n.id}`}),X("portal")(n)){const i=C(n.config.relativePoint);this.#e.addChild(new V().circle(i.x,i.y,5).stroke(r)),this.#e.addChild(new V().circle(i.x,i.y,2).fill(r))}this.#e.addChild(new V({label:"objectOrigin"}).circle(0,0,2).fill(r)),this.#e.addChild(ar(n.aabb,r)),n.renderAabb&&this.#e.addChild(ar(n.renderAabb,"rgba(184, 184, 255)")),this.#e.eventMode="static";let o;this.#e.on("pointerenter",()=>{if(o!==void 0)return;const i=`${n.id} ${n.type}
@(${n.state.position.x}, ${n.state.position.y}, ${n.state.position.z})}
#(${n.aabb.x}, ${n.aabb.y}, ${n.aabb.z})}`;this.#e.addChild(o=new $s({text:i,style:{fill:r,fontSize:6,fontFamily:"Menlo"}})),o.resolution=4}),this.#e.on("pointerleave",()=>{o!==void 0&&(this.#e.removeChild(o),o=void 0)})}#e;tick(){}destroy(){this.#e.destroy({children:!0})}get container(){return this.#e}}class gl{constructor(e,n){this.renderContext=e,this.wrappedRenderer=n,this.#e=new b({label:`ItemPositionRenderer ${e.item.id}`,children:[n.container]}),this.#n()}#e;#n(){const e=C(this.renderContext.item.state.position);this.#e.x=e.x,this.#e.y=e.y}tick(e){this.wrappedRenderer?.tick(e),e.movedItems.has(this.renderContext.item)&&this.#n()}destroy(){this.#e.destroy({children:!0}),this.wrappedRenderer?.destroy()}get container(){return this.#e}}const bl=(t,e)=>{const n=e.getLocalBounds(),r=mn.create({width:n.maxX-n.minX,height:n.maxY-n.minY});return e.x-=n.minX,e.y-=n.minY,t.render({container:e,target:r}),new Oe({texture:r,label:"shadowMaskSprite (of renderTexture)",pivot:{x:-n.minX,y:-n.minY}})},lr=(t,e,n)=>{const r=n&&{x:n.x??1,y:n.y??1},o=p({...typeof e=="string"?{textureId:e}:e,times:r});return o instanceof Oe?o:bl(t,o)};class vl{constructor(e){this.renderContext=e;const{gameMenus:{userSettings:{displaySettings:{showShadowMasks:n}}}}=x.getState();n||(this.#e.filters=new Rs({alpha:.5}));const{item:r,pixiRenderer:o}=e,{shadowMask:{spriteOptions:i}}=r;if(i){const{times:s}=r.config,a=lr(o,i,s);r.shadowMask.relativeTo==="top"&&(a.y-=r.aabb.z),s&&(a.y-=((s.z??1)-1)*M.h),this.#e.addChild(a),n||(this.#e.mask=a)}this.#e.addChild(this.#n)}#e=new b({label:"ItemShadowRenderer"});#n=new b({label:"shadows"});#t={};destroy(){this.#e.destroy(!0)}tick({movedItems:e,progression:n}){const{item:r,pixiRenderer:o,room:i}=this.renderContext,s=e.has(r),a=r.state.position.z+r.aabb.z,l=ue(i.items).filter(function(f){return f.shadowCastTexture!==void 0}),c={id:r.id,state:{position:{...r.state.position,z:a}},aabb:{...r.aabb,z:ms}},u=Object.groupBy(l,d=>{const f=this.#t[d.id]!==void 0,h=e.has(d);return!s&&!h?f?"keepUnchanged":"noShadow":cn(c,d)?f?"update":"create":"noShadow"});for(const d of Yt(u.keepUnchanged,u.update))this.#t[d.id].renderedOnProgression=n;if(u.create)for(const d of u.create){const{times:f}=d.config,h=lr(o,d.shadowCastTexture,f);h.label=d.id,this.#n.addChild(h),this.#t[d.id]={sprite:h,renderedOnProgression:n}}for(const d of Yt(u.create,u.update)){const{sprite:f}=this.#t[d.id],h=C({...Ze(d.state.position,r.state.position),z:r.aabb.z});f.x=h.x,f.y=h.y}for(const[d,{sprite:f,renderedOnProgression:h}]of yt(this.#t))h!==n&&(f.destroy(),delete this.#t[d]);this.#e.visible=(u.keepUnchanged?.length??0)+(u.update?.length??0)+(u.create?.length??0)>0}get container(){return this.#e}}const xl=(t,e,n,r)=>`${t}${r?".dark":""}.wall.${e}.${n}`,yl=(t,e,n)=>{const o=oe().textures[`door.frame.${t.planet}.${e}.near`]!==void 0?t.planet:"generic",i=t.color.shade==="dimmed"&&oe().textures[`door.frame.${o}.dark.${e}.${n}`]!==void 0;return`door.frame.${o}${i?".dark":""}.${e}.${n}`},ft=t=>D(({renderContext:{item:e}})=>gs(e)?p({...typeof t=="string"?{textureId:t}:t,times:e.config.times}):p(t)),D=t=>({renderContext:e,currentlyRenderedProps:n,tickContext:r})=>n===void 0?{container:t({renderContext:e,previousRendering:null,tickContext:r}),renderProps:re}:"no-update";function*wl({config:{direction:t,inHiddenWall:e,height:n}},r){const o=It(t),i=o==="y"?1:16;function*s(a){if(e){if(n!==0){const l=p({textureId:`generic.door.floatingThreshold.${o}`,...pt(a,{y:-12*n})});l.filters=en(r,o==="x"?"towards":"right",!0),yield l}}else{yield p({pivot:{x:i,y:9},textureId:"generic.door.legs.base",...pt(a,{})});for(let l=1;l<n;l++)yield p({pivot:{x:i,y:9},textureId:"generic.door.legs.pillar",...pt(a,{y:-l*M.h})})}}yield*s(T({...te,[o]:1})),yield*s(te),e||(yield p({pivot:{x:16,y:M.h*n+13},textureId:`generic.door.legs.threshold.double.${o}`,...T({...te,[o]:1})}))}const Vo=(t,e)=>{const n=It(t),r=Ke(n),o=8;return t==="towards"||t==="right"?C({[r]:e[r]-o}):te},Cl=D(({renderContext:{item:t,room:e}})=>Je(wl(t,e),new b({filters:Q(e),...Vo(t.config.direction,t.aabb)}))),Tl=D(({renderContext:{item:{config:{direction:t,part:e},aabb:n},room:r}})=>{const o=It(t);return p({textureId:yl(r,o,e),filter:Q(r),...Vo(t,n)})}),$t={animationId:"bubbles.cold"},Ie=({top:t,bottom:e="homingBot",filter:n})=>{const r=new b({filters:n});r.addChild(p(e));const o=p(t);return o.y=-12,r.addChild(o),r},Ho=Symbol(),Xo=Symbol(),Sl=({top:t,bottom:e})=>{const n=new b;return n.addChild(e),t.y=-12,n.addChild(t),n[Ho]=t,n[Xo]=e,n},Il=`#version 300 es
...
`,fc=Object.defineProperty,hc=(t,e,n)=>e in t?fc(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n,Jo=(t,e,n)=>(hc(t,typeof e!="symbol"?e+"":e,n),n);const Yo=class Zo extends j{constructor(e){e={...Zo.DEFAULT_OPTIONS,...e};const n=he.from({vertex:{source:At,entryPoint:"mainVertex"},fragment:{source:dc,entryPoint:"mainFragment"}}),r=R.from({vertex:Bt,fragment:uc,name:"extract-brightness-filter"});super({gpuProgram:n,glProgram:r,resources:{extractBrightnessUniforms:{uThreshold:{value:e.threshold,type:"f32"}}}}),Jo(this,"uniforms"),this.uniforms=this.resources.extractBrightnessUniforms.uniforms}get threshold(){return this.uniforms.uThreshold}set threshold(e){this.uniforms.uThreshold=e}};Jo(Yo,"DEFAULT_OPTIONS",{threshold:.5});let pc=Yo;var mc=Object.defineProperty,gc=(t,e,n)=>e in t?mc(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n,we=(t,e,n)=>(gc(t,typeof e!="symbol"?e+"":e,n),n);const Ko=class Qo extends j{constructor(e){e={...Qo.DEFAULT_OPTIONS,...e};const n=he.from({vertex:{source:At,entryPoint:"mainVertex"},fragment:{source:cc,entryPoint:"mainFragment"}}),r=R.from({vertex:Bt,fragment:lc,name:"advanced-bloom-filter"});super({gpuProgram:n,glProgram:r,resources:{advancedBloomUniforms:{uBloomScale:{value:e.bloomScale,type:"f32"},uBrightness:{value:e.brightness,type:"f32"}},uMapTexture:le.WHITE}}),we(this,"uniforms"),we(this,"bloomScale",1),we(this,"brightness",1),we(this,"_extractFilter"),we(this,"_blurFilter"),this.uniforms=this.resources.advancedBloomUniforms.uniforms,this._extractFilter=new pc({threshold:e.threshold}),this._blurFilter=new ac({strength:e.kernels??e.blur,quality:e.kernels?void 0:e.quality}),Object.assign(this,e)}apply(e,n,r,o){const i=Ce.getSameSizeTexture(n);this._extractFilter.apply(e,n,i,!0);const s=Ce.getSameSizeTexture(n);this._blurFilter.apply(e,i,s,!0),this.uniforms.uBloomScale=this.bloomScale,this.uniforms.uBrightness=this.brightness,this.resources.uMapTexture=s.source,e.applyFilter(this,n,r,o),Ce.returnTexture(s),Ce.returnTexture(i)}get threshold(){return this._extractFilter.threshold}set threshold(e){this._extractFilter.threshold=e}get kernels(){return this._blurFilter.kernels}set kernels(e){this._blurFilter.kernels=e}get blur(){return this._blurFilter.strength}set blur(e){this._blurFilter.strength=e}get quality(){return this._blurFilter.quality}set quality(e){this._blurFilter.quality=e}get pixelSize(){return this._blurFilter.pixelSize}set pixelSize(e){typeof e=="number"&&(e={x:e,y:e}),Array.isArray(e)&&(e={x:e[0],y:e[1]}),this._blurFilter.pixelSize=e}get pixelSizeX(){return this._blurFilter.pixelSizeX}set pixelSizeX(e){this._blurFilter.pixelSizeX=e}get pixelSizeY(){return this._blurFilter.pixelSizeY}set pixelSizeY(e){this._blurFilter.pixelSizeY=e}};we(Ko,"DEFAULT_OPTIONS",{threshold:.5,bloomScale:1,brightness:1,blur:8,quality:4,pixelSize:{x:1,y:1}});let bc=Ko;const mr=({crtFilter:t},e)=>[t?new ec({lineContrast:e?.3:0,vignetting:e?.4:.2}):void 0,t?new bc({threshold:.7,brightness:.9,bloomScale:.6,blur:10}):void 0].filter(n=>n!==void 0);class vc{constructor(e,n){this.app=e,this.#r=e,this.#i=n;try{const r=x.getState(),{gameMenus:{upscale:{gameEngineUpscale:o}}}=r;if(e.stage.addChild(this.#s),e.stage.scale=o,Ge(n)===void 0)throw new Error("main loop with no starting room");this.#a()}catch(r){this.#l(r);return}}#e;#n;#t;#o;#s=new b({label:"MainLoop/world"});#r;#i;#l(e){console.error(e),x.dispatch(Hi(Xi(e,"message","stack")))}#a(){const{gameMenus:{userSettings:{displaySettings:e}}}=x.getState();this.#e=mr(e,!0),this.#n=mr(e,!1)}tickAndCatch=e=>{try{this.tick(e)}catch(n){this.#l(n)}};tick=({deltaMS:e})=>{const n=x.getState(),r=ji(n),{gameMenus:{userSettings:{displaySettings:o},upscale:i}}=x.getState(),s=Ge(this.#i),a=!r&&!(o?.uncolourised??Ir.displaySettings.uncolourised);(this.#t?.renderContext.colourise!==a||this.#t?.renderContext.onScreenControls!==yn(n)||this.#t?.renderContext.inputDirectionMode!==wn(n))&&(this.#t?.destroy(),this.#t=new Ua({colourise:a,gameState:this.#i,inputDirectionMode:wn(n),onScreenControls:yn(n)}),this.#r.stage.addChild(this.#t.container)),this.#t.tick({screenSize:i.gameEngineScreenSize,room:s});const l=r?Sr:il(this.#i,e);(this.#o?.renderContext.room!==s||this.#o?.renderContext.upscale!==i||this.#o?.renderContext.displaySettings!==o||this.#o?.renderContext.paused!==r)&&(this.#o?.destroy(),s?(this.#o=new Jl({gameState:this.#i,room:s,paused:r,pixiRenderer:this.#r.renderer,displaySettings:o,colourised:a,upscale:i}),this.#s.addChild(this.#o.container),this.#i.events.emit("roomChange",s.id)):this.#o=void 0,this.#r.stage.scale=i.gameEngineUpscale,this.#a()),this.#o?.tick({progression:this.#i.progression,movedItems:l,deltaMS:e}),r?this.#r.stage.filters=this.#e:this.#r.stage.filters=this.#n};start(){return this.#r.ticker.add(this.tickAndCatch),this}stop(){this.#r.stage.removeChild(this.#s),this.#o?.destroy(),this.#t?.destroy(),this.#r.ticker.remove(this.tickAndCatch)}}St.add(Er,$r,Nr,Vr,Hr,Xr,jr,qr,Gr,Wr,Jr,Zr,Yr,Kr,Qr,eo,to,no,ro,oo,io);Gi.defaultOptions.scaleMode="nearest";const gr=async(t,e)=>{const n=new po;await n.init({background:"#000000",sharedTicker:!0,eventFeatures:{move:!0,globalMove:!0,click:!0,wheel:!1}});const r=x.getState().gameMenus.currentGame,o=Ln({campaign:t,inputStateTracker:e,savedGame:r});r!==void 0?x.dispatch(qi(r.store.gameMenus)):(x.dispatch(Cn(o.characterRooms.head.id)),x.dispatch(Cn(o.characterRooms.heels.id)));const i=new vc(n,o).start();return{campaign:t,events:o.events,renderIn(s){s.appendChild(n.canvas)},resizeTo(s){console.log("explicitly setting app renderer size to",s),n.renderer?.resize(s.x,s.y)},changeRoom(s){const a=Fe(o);a!==void 0&&un({playableItem:a,gameState:o,toRoomId:s,changeType:"level-select"})},get currentRoom(){return Ge(o)},get gameState(){return o},reincarnateFrom(s){Ln({campaign:t,inputStateTracker:e,savedGame:s,writeInto:o})},stop(){console.warn("tearing down game"),n.canvas.parentNode?.removeChild(n.canvas),i.stop(),n.destroy()}}},Sc=Object.freeze(Object.defineProperty({__proto__:null,default:gr,gameMain:gr},Symbol.toStringTag,{value:"Module"}));export{co as A,so as C,j as F,mn as R,Ps as S,uo as V,Ms as a,Sc as g,_s as u};
