const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WebGPURenderer-B_yu1adx.js","assets/App-8S34q8FY.js","assets/index-Sc3VlKkY.js","assets/index-hMn1TeXU.css","assets/colorToUniform-KTpA7KSL.js","assets/SharedSystems-BxQVqbc4.js","assets/Graphics-BIB0l6N3.js","assets/changeCharacterRoom-DWF_VWJf.js","assets/WebGLRenderer-Byqef6Db.js"])))=>i.map(i=>d[i]);
import{b1 as Oi,b2 as jo,b3 as Bi,ak as _i,ao as we,ap as N,ac as qo,al as be,X as C,a0 as zt,_ as Pi,a1 as g,d as Ze,v as Pt,aE as v,a4 as an,aw as Re,Y as Xe,Z as Fi,V as Ai,b4 as Di,b5 as Mi,b6 as zi,ab as Li,b7 as j,b8 as $n,I as O,b9 as Wo,ba as re,bb as k,bc as Jo,s as Yo,K as w,o as q,c as B,bd as Ri,be as Ei,bf as Ui,g as A,bg as rt,bh as $i,bi as wn,bj as Zo,bk as Ni,bl as Gi,bm as Hi,bn as Tt,i as ie,t as Ce,p as Cn,l as E,bo as Vi,bp as Xi,bq as ji,br as qi,bs as Wi,bt as Ji,F as Qe,bu as kt,e as Yi,bv as it,bw as Qo,bx as Ko,k as er,by as Lt,bz as $,j as J,bA as tr,bB as Sn,bC as Nn,bD as nr,bE as Zi,bF as st,bG as Tn,bH as Se,bI as Rt,bJ as ce,P as at,E as de,bK as fe,x as Te,bL as ln,bM as Qi,bN as Ki,bO as es,bP as ts,bQ as kn,y as Ee,bR as ns,bS as os,bT as rs,bU as cn,bV as is,bW as ss,bX as ft,f as In,bY as as,bZ as ls,b_ as cs,m as ke,A as or,b$ as Gn,h as he,c0 as rr,r as ir,b as us,a as sr,n as ds,aZ as Ue,c1 as Vt,c2 as qe,c3 as ht,c4 as fs,c5 as hs,c6 as ps,c7 as $e,c8 as Hn,c9 as On,ca as ms,cb as gs,cc as lt,cd as bs,ce as vs,cf as ys,cg as xs,ch as ws,ci as Cs,cj as Ss,ck as Ts,cl as Vn,J as Xn,cm as ar,b0 as lr,C as cr,D as ks,z as jn,cn as Is,co as Os,cp as Bs,aY as ve,cq as ur,cr as _s,cs as Ps,ct as S,cu as Fs,cv as Ft,cw as As,cx as It,cy as Ds,cz as Ms,cA as qn,cB as zs,cC as Ls,cD as Rs,Q as Ke,cE as Et,cF as Es,cG as Ae,cH as x,cI as un,cJ as dr,q as Us,cK as et,cL as Xt,H as Wn,cM as $s,cN as Ns,cO as Gs,cP as Hs,au as De,cQ as Vs,cR as Xs,cS as js,cT as qs,cU as Ws,cV as Js,cW as Ys,cX as Zs,cY as Jn,cZ as Qs,L as Yn,c_ as Ks}from"./App-8S34q8FY.js";import{a as ea,f as dn,c as Bn,m as Ut,b as _n,d as fr,r as ta,o as na}from"./changeCharacterRoom-DWF_VWJf.js";import{S as oa,G as W}from"./Graphics-BIB0l6N3.js";import{g as hr,_ as Zn}from"./index-Sc3VlKkY.js";var pt={},Qn;function ra(){if(Qn)return pt;Qn=1;var t=Oi(),e=t.mark(i),n=jo(),o=n.wrapWithIterableIterator,r=n.ensureIterable;function i(){var a,l,c,u,d,f,h=arguments;return t.wrap(function(y){for(;;)switch(y.prev=y.next){case 0:for(a=h.length,l=new Array(a),c=0;c<a;c++)l[c]=h[c];u=0,d=l;case 2:if(!(u<d.length)){y.next=8;break}return f=d[u],y.delegateYield(r(f),"t0",5);case 5:u++,y.next=2;break;case 8:case"end":return y.stop()}},e)}pt.__concat=i;var s=o(i);return pt.concat=s,pt}var mt={},Kn;function ia(){if(Kn)return mt;Kn=1;var t=jo(),e=t.iterableCurry,n=Bi(),o=n.__firstOr,r=Symbol("none");function i(a){return o(a,r)===r}mt.__isEmpty=i;var s=e(i,{reduces:!0});return mt.isEmpty=s,mt}var jt,eo;function sa(){return eo||(eo=1,jt=ra().concat),jt}var aa=sa();const to=hr(aa);var qt,no;function la(){return no||(no=1,qt=ia().isEmpty),qt}var ca=la();const ua=hr(ca),pr=class fn extends _i{constructor(e){e={...fn.defaultOptions,...e},super(e),this.enabled=!0,this._state=oa.for2d(),this.blendMode=e.blendMode,this.padding=e.padding,typeof e.antialias=="boolean"?this.antialias=e.antialias?"on":"off":this.antialias=e.antialias,this.resolution=e.resolution,this.blendRequired=e.blendRequired,this.clipToViewport=e.clipToViewport,this.addResource("uTexture",0,1)}apply(e,n,o,r){e.applyFilter(this,n,o,r)}get blendMode(){return this._state.blendMode}set blendMode(e){this._state.blendMode=e}static from(e){const{gpu:n,gl:o,...r}=e;let i,s;return n&&(i=we.from(n)),o&&(s=N.from(o)),new fn({gpuProgram:i,glProgram:s,...r})}};pr.defaultOptions={blendMode:"normal",resolution:1,padding:0,antialias:"off",blendRequired:!1,clipToViewport:!0};let Z=pr;var da=`
...
fn mainFragment(
  @location(0) uv: vec2<f32>
   ...
   return out;
}`;class I extends Z{constructor(e){const n=e.gpu,o=oo({source:ha,...n}),r=we.from({vertex:{source:o,entryPoint:"mainVertex"},fragment:{source:o,entryPoint:"mainFragment"}}),i=e.gl,s=oo({source:da,...i}),a=N.from({vertex:fa,fragment:s}),l=new qo({uBlend:{value:1,type:"f32"}});super({gpuProgram:r,glProgram:a,blendRequired:!0,resources:{blendUniforms:l,uBackTexture:be.EMPTY}})}}function oo(t){const{source:e,functions:n,main:o}=t;return e.replace("{FUNCTIONS}",n).replace("{MAIN}",o)}const Pn=`
