...
fn mainFragment(
  @location(0) uv: vec2<f32>
   ...
   return out;
}`;class I extends Y{constructor(e){const n=e.gpu,o=Yn({source:Qs,...n}),r=ve.from({vertex:{source:o,entryPoint:"mainVertex"},fragment:{source:o,entryPoint:"mainFragment"}}),i=e.gl,s=Yn({source:Zs,...i}),l=$.from({vertex:Ks,fragment:s}),a=new $o({uBlend:{value:1,type:"f32"}});super({gpuProgram:r,glProgram:l,blendRequired:!0,resources:{blendUniforms:a,uBackTexture:he.EMPTY}})}}function Yn(t){const{source:e,functions:n,main:o}=t;return e.replace("{FUNCTIONS}",n).replace("{MAIN}",o)}const kn=`
