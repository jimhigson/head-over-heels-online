...
/**
 * like {@link resolveCameraRelativeIndexXy4} but also mirrors the sprite in
 * the screen y axis (flipX) for world-relative lighting
 */
...
/**
 * like {@link resolveCameraRelativeIndexXy8} but also mirrors the sprite in
 * the screen y axis (flipX) for world-relative lighting
 */
...
/**
 * whether a world x/y axis, rotated by the given camera angle, projects in the
 * opposite screen direction to the base-angle projection.
 * Art tiling from its anchor in the rendered axis can use this to tile in the
 * opposite order, since they need to be furthest-first
 */
