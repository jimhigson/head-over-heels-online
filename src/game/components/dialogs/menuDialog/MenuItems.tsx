...
const findScrollableAncestor = (element: Element): Element | null => {
...
const getMenuItemTop = (
  ...
  if (stickyAncestor !== null) {
    console.log(
      "found sticky ancestor of",
      element.getAttribute("data-menuitem_id"),
    );
...
const moveFocus = (
  ...
  console.log("moveFocus", direction, by);
  ...
  switch (by) {
    ...
    case "page": {
      ...
      console.log(
        "from",
        currentElement.getAttribute("data-menuitem_id"),
        "at",
        currentTop,
        "looking for cloest to ",
        targetTop,
      );
      ...
      console.log("closest is", closestIndex);
