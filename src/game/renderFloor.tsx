...
import { RenderWorldOptions, xyzBlockPosition, paletteSwapFilters } from "./renderWorld";
import { spriteAtBlock } from "./spriteAtBlock";

export function* renderFloor(room: AnyRoom, options: RenderWorldOptions): Generator<Container, undefined, undefined> {
