    ...
    this.#hudElements = {
      head: {
        ...
        livesText: new TextContainer({
          ...
          resolution: general.spritesheets.bakedUpscaleFactor,
          label: "headLives",
          doubleHeight: true,
          outline: true,
        }),
  ...
  #iconWithNumber({
    ...
    const icon =
      ...
      : new TextContainer({
          ...
          resolution:
            this.renderContext.general.spritesheets.bakedUpscaleFactor,
    ...
    const text = new TextContainer({
      pixiRenderer: this.renderContext.general.pixiRenderer,
      resolution: this.renderContext.general.spritesheets.bakedUpscaleFactor,
