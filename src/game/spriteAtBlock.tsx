...
import { type TextureId, pixiSpriteSheet, blockSizePx } from "../sprites/pixiSpriteSheet";
import { SpriteAtBlockOptions, projectToScreen } from "./renderWorld";

export const spriteAtBlock = ({ x, y, z = 0 }: { x: number; y: number; z?: number; }, textureId: TextureId, { anchor, flipX, pivot, giveZIndex }: SpriteAtBlockOptions): Sprite => {
