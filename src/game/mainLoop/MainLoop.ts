...
import { selectBakedUpscaleFactor } from "../render/filters/upscale/selectBakedUpscaleFactor";
...
export class MainLoop<RoomId extends string> {
  ...
  #tick = ({ elapsedMS }: AppTicker): void => {
    ...
    const tickBakedUpscaleFactor = selectBakedUpscaleFactor(tickState);
    ...
    const spritesheetVariantsStale =
      (roomChanged ||
        ...
        this.#spritesheets.bakedUpscaleFactor !== tickBakedUpscaleFactor ||
    ...
    try {
      ...
      if (import.meta.env.MODE === "visual-regression") {
        ...
        E2EEventBus.emit("frameRendered", {
          ...
          cameraAngle,
          bakedUpscaleFactor: this.#spritesheets.bakedUpscaleFactor,
        });
      }
    } catch (e) {
