...
export const resolutions = {
  ...
  amigaHiResPal: { name: "Amiga Hi-Res PAL", x: 640, y: 512 },
  // didn't have a HoH port, but is nicely between Amiga hires and low res
  classicMac: { name: "Classic Mac", x: 512, y: 384 },
  amigaLowResPal: { name: "Amiga Lo-Res PAL", x: 320, y: 256 },
  zxSpectrum: { name: "ZX Spectrum", x: 256, y: 192 },
  ...
  handheld: { name: "Handheld", x: 256, y: 135 },
};
