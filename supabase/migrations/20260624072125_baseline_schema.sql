-- Baseline schema for the hohjs Supabase project, captured from production
-- (db/schema.sql) as the first migration in the canonical history. Applies to a
-- fresh local stack via `supabase db reset`.
