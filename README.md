...
See the [DEVELOPING](./DEVELOPING.md) guide.
...
- Recolourised 16 colour sprites are built from rips [by Toppy on Spriters Resource](https://www.spriters-resource.com/zx_spectrum/headoverheels/) based on original artwork by Bernie Drummand (sadly [no longer with us](https://www.theregister.com/2021/11/17/rip_bernie_drummond/)).
- **Toppy** also contributing redrawn artwork in the form of his spritesheet (go to Options -> Display -> Sprites)
...
Sprite Pixel art work contributed by Toppy is released under [Creative Commons BY NC SA](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.en).
